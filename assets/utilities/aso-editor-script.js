...
function handleMiseAEchelle(rW, rH) {
    ...
    var signWPx = convertToPx(rW, 'cm')
    var signHPx = convertToPx(rH, 'cm')
...
function getTextValueToUnit(container, objWidht, objHeight, objLeft, objTop){
    ...
    if(ratioScale == 2){
        if(container.height == 370){
            ...
            var right = currentSize.width - (convertFromPx(left, 'cm') + convertFromPx(newWidth, 'cm'))
            ...
            // textRight.textContent = parseInt(convertFromPx(right, 'cm'))
    ...
    return {
        width: parseInt(convertFromPx(newWidth, 'cm')),
        height: parseInt(convertFromPx(newHeight, 'cm')),
        left: parseInt(convertFromPx(left, 'cm')),
        right: parseInt(right),
        // right: parseInt(convertFromPx(right, 'cm')),
        top: parseInt(convertFromPx(top, 'cm')),
        bottom: bottom
    }
}
//function for get added text value
...
function handleGetAddedTextValues(transform) {
    ...
    // console.log('container-left',parseInt(container.left*canvas.getZoom()), 'object-left',parseInt((obj.left-(objWidht/2))*canvas.getZoom()))
    // console.log('container-width',parseInt(container.width*canvas.getZoom()), 'object-widht',parseInt((objWidht)*canvas.getZoom()))
    // console.log('container-height',parseInt(container.height*canvas.getZoom()), 'object-height',parseInt((objHeight)*canvas.getZoom()))
...
function handleGetAddedImageValues(object){
    ...
    getTextValueToUnit(container, objWidht, objHeight, objLeftInContainer, objTopInContainer)
    console.log(getTextValueToUnit(container, objWidht, objHeight, objLeftInContainer, objTopInContainer))
