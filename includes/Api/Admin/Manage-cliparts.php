...
class ASO_Api_Configs_Manage_cliparts_ extends WP_REST_Controller {
    ...
    public function __construct() {
        ...
        $this->rest_base = 'Manage_cliparts_configs';
    }
    ...
    public function create_manage_cliparts_config_post ( $request ) {
        ...
        if($post_id != 0 && !is_wp_error($post_id)){
            if(isset($params["data"]) && !empty($params["data"])){
                ...
                update_post_meta($post_id,'aso-manages-cliparts-meta',$data);
