...
class ASOWP_Api_Required_Options_Components extends ASOWP_Api_Required_Options_Base
{
    public function register_routes()
    {
        ...
        register_rest_route(
            $this->namespace,
            $config_route . '/components/update',
            array(
                array(
        ...
        register_rest_route(
            $this->namespace,
            $config_route . '/components/(?P<component_id>\d+)',
            array(
                array(
                    'methods' => WP_REST_Server::READABLE,
        ...
        register_rest_route(
            $this->namespace,
            $config_route . '/components/(?P<component_id>\d+)/options',
            array(
                array(
                    'methods' => WP_REST_Server::READABLE,
        ...
        register_rest_route(
            $this->namespace,
            $config_route . '/components/(?P<component_id>\d+)/options/(?P<option_id>\d+)',
            array(
                array(
                    'methods' => WP_REST_Server::READABLE,
