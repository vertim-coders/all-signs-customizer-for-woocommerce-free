...
class ASCWO_Api_Required_Options_Sizes extends ASCWO_Api_Required_Options_Base
{
    ...
    public function get_size_item($request)
    {
        ...
        if ($item_index === null) {
            return rest_ensure_response(array('success' => false, 'message' => __('Size not found', 'all-signs-customizer-for-woocommerce')));
        }
    ...
    public function add_size_item($request)
    {
        ...
        return rest_ensure_response($saved === true
            ? array(
                'success' => true,
                'message' => __('Size successfully added', 'all-signs-customizer-for-woocommerce'),
                'data' => array('size' => end($sizes)),
            )
            : array('success' => false, 'message' => __('Size has not been added', 'all-signs-customizer-for-woocommerce')));
    }
    ...
    public function update_size_item($request)
    {
        ...
        return rest_ensure_response($saved === true
            ? array(
                'success' => true,
                'message' => __('Size successfully edited', 'all-signs-customizer-for-woocommerce'),
                'data' => array('size' => $sizes[$item_index]),
            )
            : array('success' => false, 'message' => __('Size has not been edited', 'all-signs-customizer-for-woocommerce')));
    }
    ...
    public function delete_size_item($request)
    {
        ...
        return rest_ensure_response($saved === true
            ? array(
                'success' => true,
                'message' => __('Size successfully deleted', 'all-signs-customizer-for-woocommerce'),
                'data' => array('items' => array_values($sizes)),
            )
            : array('success' => false, 'message' => __('Size has not been deleted', 'all-signs-customizer-for-woocommerce')));
    }
    ...
    public function set_default_size_item($request)
    {
        ...
        return rest_ensure_response($saved === true
            ? array(
                'success' => true,
                'message' => __('Default size successfully updated', 'all-signs-customizer-for-woocommerce'),
                'data' => array('size' => $sizes[$item_index]),
            )
            : array('success' => false, 'message' => __('Size has not been edited', 'all-signs-customizer-for-woocommerce')));
    }
