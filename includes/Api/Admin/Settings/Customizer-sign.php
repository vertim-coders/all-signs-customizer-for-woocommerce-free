	...
	public function get_customizer_sign_settings( $request ) {
		...
		if ( false === $post ) {
			return rest_ensure_response(
				array(
					'success' => false,
					'message' => __( 'Customizer ID invalid', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'No Customizer Sign Settings found', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_customizer_options_customizer_sign_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in customizer options in customizer sign settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Customizer in customizer sign settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update customizer in customizer sign settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_config_options_customizer_sign_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in config options in customizer sign settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Config options in customizer sign settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update config options in customizer sign settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_sign_part_customizer_sign_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in sign part in customizer sign settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Sign part in customizer sign settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update sign part in customizer sign settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_text_option_customizer_sign_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in text in customizer sign settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Text in customizer sign settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update text in customizer sign settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function updates_image_customizer_sign_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in image in customizer sign settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Image in customizer sign settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update image in customizer sign settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
