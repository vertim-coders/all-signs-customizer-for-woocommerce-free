...
class ASCWO_Api_Language_Images_Settings extends WP_REST_Controller {
	...
	public function get_language_images_settings( $request ) {
		...
		return rest_ensure_response(
			array(
				'message' => __( 'No language Images Settings found', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_main_options_language_images_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in main options in language images settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Main options in language images settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update main options in language images settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_upload_design_options_language_images_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in customizer design options in language images settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Customizer design options in language images settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update customizer design options in language images settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_visualizer_options_language_images_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in visualizer options in language images', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Visualizer options in language images settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update visualizer options in language images settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
	...
	public function update_image_language_images_settings( $request ) {
		...
		if ( 'same' === $response ) {
			return rest_ensure_response(
				array(
					'success' => 'same',
					'message' => __( 'No change observed in images options in language images settings', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		if ( $response ) {
			return rest_ensure_response(
				array(
					'success' => true,
					'message' => __( 'Images options in language images settings updated successfully', 'all-signs-customizer-for-woocommerce-pro' ),
				)
			);
		}
		...
		return rest_ensure_response(
			array(
				'success' => false,
				'message' => __( 'Update images options in language images settings failed', 'all-signs-customizer-for-woocommerce-pro' ),
			)
		);
	}
