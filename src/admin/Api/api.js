...
const api = {
  ...
  updateMarerial: async (configId, materialId, material) => {
    const edit = await axios.put(
      aso_api_url + "/configs/" + configId + "/materials/" + materialId,
      material
    );
    return edit.data;
  },
  getMaterials: async (configId) => {
    const material = await axios.get(
      aso_api_url + "/configs/" + configId + "/materials"
    );
  ...
  updateManagefont: async (fontId, font) => {
    const state = await axios.post(
      aso_api_url + "/manage-fonts/" + fontId,
      font
    );
    return state.data;
  },
  ...
  updateManageSize: async (sizeId, size) => {
    const state = await axios.post(
      aso_api_url + "/manage-sizes/" + sizeId,
      size
    );
    return state.data;
  },
  ...
  UpdateManageClipart: async (manageclipartId, manageclipart) => {
    const clipartgroup = await axios.post(
      aso_api_url + "/manage-cliparts/" + manageclipartId,
      manageclipart
    );
  ...
  getManageClipartItems: async (manageclipartId) => {
    const clipartitem = await axios.get(
      aso_api_url + "/manage-cliparts/" + manageclipartId + "/items"
    );
  ...
  updateShapeInGlobalShapes: async (shapeId, shape) => {
    const shapes = await axios.put(
      aso_api_url + "/globals-settings/shapes/" + shapeId,
      shape
    );
    return shapes.data;
  },
  ...
  updateBorderInGlobalBorders: async (borderId, border) => {
    const borders = await axios.put(
      aso_api_url + "/globals-settings/borders/" + borderId,
      border
    );
    return borders.data;
  },
  ...
  getGlobalFixingMethods: async () => {
    const FixingMethods = await axios.get(
      aso_api_url + "/globals-settings/fixing-methods"
    );
  ...
  updateFixingMethodInGlobalFixingMethods: async (
    ...
    const FixingMethods = await axios.put(
      aso_api_url + "/globals-settings/fixing-methods/" + FixingMethodId,
      FixingMethod
    );
    return FixingMethods.data;
  },
  ...
  getGeneralSettings: async (config) => {
    const generals = await axios.get(
      aso_api_url + "/configs/" + config + "/settings/generals"
    );
    return generals.data;
  } /* 
    updateGeneralCustomizer: async (config, data) => {
        const customizer = await axios.post(aso_api_url + '/configs/' + config + '/settings/generals/customizer', data);
        return customizer.data;
    }, */,
  updateGeneralMobile: async (config, data) => {
    const mobile = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/generals/mobile",
      data
    );
    return mobile.data;
  },
  updateGeneralProduct: async (config, data) => {
    const product = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/generals/product",
      data
    );
    return product.data;
  },
  updateGeneralOutput: async (config, data) => {
    const output = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/generals/output",
      data
    );
    return output.data;
  },
  ...
  getCustomizerSignsSettings: async (config) => {
    const customizerSigns = await axios.get(
      aso_api_url + "/configs/" + config + "/settings/customizer-signs"
    );
  ...
  updateCustomizerSignsImage: async (config, data) => {
    const Image = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/customizer-signs/images",
      data
    );
    return Image.data;
  },
  updateCustomizerSignsText: async (config, data) => {
    const Text = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/customizer-signs/text",
      data
    );
    return Text.data;
  },
  ...
  getLanguageImagesSettings: async (config) => {
    const languageImages = await axios.get(
      aso_api_url + "/configs/" + config + "/settings/language-images"
    );
    return languageImages.data;
  },
  updateLanguageImagesMain: async (config, data) => {
    const main = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/language-images/main",
      data
    );
    return main.data;
  },
  ...
  updateLanguageImagesProduct: async (config, data) => {
    const product = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/language-images/product",
      data
    );
    return product.data;
  },
  ...
  updateLanguageImagesImgs: async (config, data) => {
    const images = await axios.post(
      aso_api_url + "/configs/" + config + "/settings/language-images/images",
      data
    );
    return images.data;
  },
  ...
  getThemesSettings: async (config) => {
    const themes = await axios.get(
      aso_api_url + "/configs/" + config + "/settings/theme-colors"
    );
    return themes.data;
  },
