...
const ascwo_api_url = ascwo_data.rest_url;
if (ascwo_data?.rest_nonce) {
  axios.defaults.headers.common["X-WP-Nonce"] = ascwo_data.rest_nonce;
}
const api = {
  //function related to configuration
  getConfigs: async (url = "") => {
    const configs = await axios.get(ascwo_api_url + "/configs/" + url);
    return {
  ...
  getConfig: async (id) => {
    const config = await axios.get(ascwo_api_url + "/configs/" + id);
    return config.data?.data ?? config.data;
  },
  getPreviewConfig: async (id) => {
    const config = await axios.get(
      ascwo_api_url + "/configs/" + id + "/preview",
    );
    return config.data;
  },
  updateConfig: async (config) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + config.id,
      config,
    );
    return edit.data;
  },
  deleteConfig: async (id) => {
    const del = await axios.delete(ascwo_api_url + "/configs/" + id);
    return del.data;
  },
  addConfig: async (data) => {
    const post = await axios.post(ascwo_api_url + "/configs", data);
    return post.data;
  },
  ...
  getHomeStats: async (params = {}) => {
    const query = new URLSearchParams(params).toString();
    const url = ascwo_api_url + "/stats/home" + (query ? `?${query}` : "");
    const res = await axios.get(url);
  ...
  getRequestQuotes: async () => {
    const quotes = await axios.get(ascwo_api_url + "/request-quotes");
    return quotes.data;
  },
  getRequestQuote: async (quoteId) => {
    const quote = await axios.get(ascwo_api_url + "/request-quotes/" + quoteId);
    return quote.data;
  },
  updateRequestQuote: async (quoteId, data) => {
    const quote = await axios.put(
      ascwo_api_url + "/request-quotes/" + quoteId,
      data,
    );
    return quote.data;
  },
  ...
  // function related to required materials
  ...
  getMaterials: async (configId) => {
    const material = await axios.get(
      ascwo_api_url + "/configs/" + configId + "/additional-options/materials",
    );
  ...
  getAdditionalOptions: async (configId) => {
    const additionalOptions = await axios.get(
      ascwo_api_url + "/configs/" + configId + "/additional-options/components",
    );
  ...
  getAdditionalOptionItems: async (configId, additionalOptionId) => {
  ...
  deleteAdditionalOption: async (configId, additionalOptionId) => {
    const del = await axios.delete(
      ascwo_api_url +
        "/configs/" +
        configId +
  ...
  getGoogleFonts: async () => {
    const fonts = await axios.get(ascwo_api_url + "/google-fonts");
    return fonts.data;
  },
  getManagefonts: async () => {
    const Managefonts = await axios.get(ascwo_api_url + "/manage-fonts");
    return Managefonts.data;
  },
  addManagefont: async (font) => {
    const state = await axios.post(ascwo_api_url + "/manage-fonts", font);
    return state.data;
  },
  updateManagefont: async (fontId, font) => {
    const state = await axios.post(
      ascwo_api_url + "/manage-fonts/" + fontId,
      font,
    );
    return state.data;
  },
  ...
  getManageSizes: async () => {
    const Managesizes = await axios.get(ascwo_api_url + "/manage-sizes");
    return Managesizes.data;
  },
  addManageSize: async (size) => {
    const state = await axios.post(ascwo_api_url + "/manage-sizes", size);
    return state.data;
  },
  updateManageSize: async (sizeId, size) => {
    const state = await axios.post(
      ascwo_api_url + "/manage-sizes/" + sizeId,
      size,
    );
    return state.data;
  },
  ...
  getManageCliparts: async () => {
    const Managecliparts = await axios.get(ascwo_api_url + "/manage-cliparts");
    return Managecliparts.data?.data ?? Managecliparts.data;
  },
  addManageClipart: async (manageclipart) => {
    const state = await axios.post(
      ascwo_api_url + "/manage-cliparts",
      manageclipart,
    );
    return state.data;
  },
  UpdateManageClipart: async (manageclipartId, manageclipart) => {
    const clipartgroup = await axios.post(
      ascwo_api_url + "/manage-cliparts/" + manageclipartId,
      manageclipart,
    );
  ...
  getManageClipartItems: async (manageclipartId) => {
    const clipartitem = await axios.get(
      ascwo_api_url + "/manage-cliparts/" + manageclipartId + "/items",
    );
  ...
  updateRequiredOptionShapes: async (configId, shapes) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + configId + "/required-options/shapes",
      shapes,
    );
    return edit.data;
  },
  ...
  addRequiredOptionShapeItem: async (configId, shape) => {
    const add = await axios.post(
      ascwo_api_url + "/configs/" + configId + "/required-options/shapes/items",
      shape,
    );
    return add.data;
  },
  ...
  updateRequiredOptionSizes: async (configId, sizes) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + configId + "/required-options/sizes",
      sizes,
    );
    return edit.data;
  },
  ...
  addRequiredOptionSizeItem: async (configId, size) => {
    const add = await axios.post(
      ascwo_api_url + "/configs/" + configId + "/required-options/sizes/items",
      size,
    );
    return add.data;
  },
  ...
  setRequiredOptionDefault: async (configId, section, itemId) => {
    const edit = await axios.put(
      ascwo_api_url +
        "/configs/" +
        configId +
  ...
  updateRequiredOptionFonts: async (configId, fonts) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + configId + "/required-options/fonts",
      fonts,
    );
    return edit.data;
  },
  ...
  addRequiredOptionFontItem: async (configId, fontId) => {
    const add = await axios.post(
      ascwo_api_url + "/configs/" + configId + "/required-options/fonts/items",
      { font_id: fontId },
    );
    return add.data;
  },
  updateRequiredOptionFontItem: async (configId, itemId, position) => {
    const edit = await axios.put(
      ascwo_api_url +
        "/configs/" +
        configId +
  ...
  setRequiredOptionFontDefault: async (configId, itemId) => {
    const edit = await axios.put(
      ascwo_api_url +
        "/configs/" +
        configId +
  ...
  deleteRequiredOptionFontItem: async (configId, itemId) => {
    const del = await axios.delete(
      ascwo_api_url +
        "/configs/" +
        configId +
  ...
  updateRequiredOptionColors: async (configId, colors) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + configId + "/required-options/colors",
      colors,
    );
    return edit.data;
  },
  ...
  addRequiredOptionColorItem: async (configId, color) => {
    const add = await axios.post(
      ascwo_api_url + "/configs/" + configId + "/required-options/colors/items",
      color,
    );
    return add.data;
  },
  ...
  updateRequiredOptionBorders: async (configId, borders) => {
    const edit = await axios.put(
      ascwo_api_url + "/configs/" + configId + "/required-options/borders",
      borders,
    );
    return edit.data;
  },
  ...
  addRequiredOptionComponent: async (configId, component) => {
    const post = await axios.post(
      ascwo_api_url + "/configs/" + configId + "/required-options/components",
      component,
    );
    return post.data;
  },
  ...
  getGlobalShapes: async () => {
    const shapes = await axios.get(ascwo_api_url + "/globals-settings/shapes");
    return shapes.data;
  },
  updateShapeInGlobalShapes: async (shapeId, shape) => {
    const shapes = await axios.put(
      ascwo_api_url + "/globals-settings/shapes/" + shapeId,
      shape,
    );
    return shapes.data;
  },
  ...
  getGlobalBorders: async () => {
    const borders = await axios.get(
      ascwo_api_url + "/globals-settings/borders",
    );
    return borders.data;
  },
  updateBorderInGlobalBorders: async (borderId, border) => {
    const borders = await axios.put(
      ascwo_api_url + "/globals-settings/borders/" + borderId,
      border,
    );
    return borders.data;
  },
  ...
  getGlobalFixingMethods: async () => {
    const FixingMethods = await axios.get(
      ascwo_api_url + "/globals-settings/fixing-methods",
    );
  ...
  updateFixingMethodInGlobalFixingMethods: async (
    ...
    const FixingMethods = await axios.put(
      ascwo_api_url + "/globals-settings/fixing-methods/" + FixingMethodId,
      FixingMethod,
    );
    return FixingMethods.data;
  },
  ...
  getGeneralSettings: async (config) => {
    const generals = await axios.get(
      ascwo_api_url + "/configs/" + config + "/settings/generals",
    );
    return generals.data;
  } /*
    updateGeneralCustomizer: async (config, data) => {
        const customizer = await axios.post(ascwo_api_url + '/configs/' + config + '/settings/generals/customizer', data);
        return customizer.data;
    }, */,
  updateGeneralMobile: async (config, data) => {
    const mobile = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/generals/mobile",
      data,
    );
    return mobile.data;
  },
  updateGeneralProduct: async (config, data) => {
    const product = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/generals/product",
      data,
    );
    return product.data;
  },
  updateGeneralOutput: async (config, data) => {
    const output = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/generals/output",
      data,
    );
    return output.data;
  },
  updateGeneralSection: async (config, section, data) => {
    const generalSection = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/generals/" + section,
      data,
    );
  ...
  updateCustomizerSignsText: async (config, data) => {
    const Text = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/customizer-signs/text",
      data,
    );
    return Text.data;
  },
  ...
  getLanguageImagesSettings: async (config) => {
    const languageImages = await axios.get(
      ascwo_api_url + "/configs/" + config + "/settings/language-images",
    );
    return languageImages.data;
  },
  updateLanguageImagesMain: async (config, data) => {
    const main = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/language-images/main",
      data,
    );
    return main.data;
  },
  ...
  updateLanguageImagesImgs: async (config, data) => {
    const images = await axios.post(
      ascwo_api_url + "/configs/" + config + "/settings/language-images/images",
      data,
    );
    return images.data;
  },
  ...
  getThemesSettings: async (config) => {
    const themes = await axios.get(
      ascwo_api_url + "/configs/" + config + "/settings/theme-colors",
    );
    return themes.data;
  },
  ...
  saveGlobalSettingsProduct: async (data) => {
    const product = await axios.post(
      ascwo_api_url + "/globals-settings/product/",
      data,
    );
    return product.data;
  },
  getProductHealth: async () => {
    const product = await axios.get(
      ascwo_api_url + "/globals-settings/product/checking",
    );
    return product.data;
  },
  ...
  saveGlobalSettingsConfigPage: async (data) => {
    const configPage = await axios.post(
      ascwo_api_url + "/globals-settings/config-page",
      data,
    );
  ...
  getGlobalSettingsPages: async () => {
    const pages = await axios.get(ascwo_api_url + "/globals-settings/pages");
    return pages.data;
  },
  addPageInGlobalSettings: async (data) => {
    const page = await axios.post(
      ascwo_api_url + "/globals-settings/pages",
      data,
    );
    return page.data;
  },
  getGlobalSettingsOutput: async () => {
    const outputSetting = await axios.get(
      ascwo_api_url + "/globals-settings/output",
    );
  ...
  getCustomAdditionals: async (config) => {
    const CustomAdditionals = await axios.get(
      ascwo_api_url + "/configs/" + config + "/additional-options/inputs",
    );
  ...
  getAllCategories: async () => {
    const categories = await axios.get(ascwo_api_url + "/categories");
    return categories.data;
  },
  createCategory: async (category) => {
    const categories = await axios.post(
      ascwo_api_url + "/categories",
      category,
    );
    return categories.data;
  },
  updateCategory: async (category_id, category) => {
    const categories = await axios.put(
      ascwo_api_url + "/categories/" + category_id,
      category,
    );
    return categories.data;
  },
  ...
  getAllTemplates: async (url = "") => {
    const templates = await axios.get(ascwo_api_url + "/templates/" + url);
    return templates.data;
  },
  createTemplate: async (template) => {
    const templates = await axios.post(
      ascwo_api_url + "/templates/" + template.configId,
      template,
    );
    return templates.data;
  },
  getTemplate: async (config_id, template_id) => {
    const templates = await axios.get(
      ascwo_api_url + "/templates/" + config_id + "/" + template_id,
    );
    return templates.data;
  },
  updateTemplate: async (template_id, template) => {
    const templates = await axios.put(
      ascwo_api_url + "/templates/" + template.configId + "/" + template_id,
      template,
    );
    return templates.data;
  },
