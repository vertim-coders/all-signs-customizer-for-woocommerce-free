<template>
    <div class="aso-fixed aso-z-[9999] aso-top-[32px] aso-w-full aso-h-[50px] aso-px-2 aso-bg-white aso-flex aso-justify-center aso-items-center aso-shadow">
        <div class="aso-absolute aso-z-[9999] aso-top-0 aso-h-[50px] aso-left-[10px]">
            <span>
        ...
        <div class=" aso-flex px-2 aso-justify-center aso-items-center aso-w-full">
            <div class="aso-w-full aso-justify-evenly aso-flex aso-items-center">
                <div class="aso-flex aso-items-center aso-justify-center aso-space-x-2">
                    <span class="aso-p-2 aso-border-2 aso-text-[#466801] aso-bg-[#FFFFFF] aso-rounded aso-border-[#466801] aso-border aso-border-solid" v-if="$route.path.includes('configs') &&( $route.path.includes('materials') ||  $route.path.includes('settings'))">{{ $router.currentRoute.value.params.configId }}ID</span>
                    <button @click="()=>$router.push('/configs/'+$router.currentRoute.value.params.configId+'/settings/generals')" v-if="$route.path.includes('configs') && $route.path.includes('materials')" class="aso-p-2 aso-border-2 aso-border-solid aso-border-[#016464] aso-text-[#016464] aso-rounded aso-cursor-pointer">
                    ...
                    <button @click="()=>$router.push('/configs/'+$router.currentRoute.value.params.configId+'/materials')" v-if="$route.path.includes('configs') && $route.path.includes('settings')" class="aso-p-2 aso-border-2 aso-border-solid aso-border-[#EF5A35] aso-text-[#EF5A35] aso-rounded aso-bg-[#F8E7E7] aso-cursor-pointer">
        ...
        <div class="aso-absolute aso-flex aso-justify-center aso-items-center aso-z-[9999] aso-top-0 aso-h-full  aso-right-[15%]">
