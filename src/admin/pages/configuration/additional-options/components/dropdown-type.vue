<template>
    <div class="asowp-space-y-1">
        ...
        <div class="asowp-bg-white asowp-shadow-md asowp-justify-center asowp-items-center asowp-p-4">
            ...
            <div class="asowp-relative asowp-border-solid asowp-border-[1px] asowp-border-[#e5e7eb] asowp-rounded-lg asowp-p-2" v-for="(option,key) in dropdownType.options" :key="key">
                    ...
                    <div>
                        ...
                        <div class="asowp-flex asowp-items-center asowp-justify-between asowp-w-full asowp-max-w-[574px] asowp-h-[54px] asowp-border asowp-border-solid asowp-border-[#9ca3af] asowp-rounded-[5px] asowp-bg-white asowp-overflow-hidden asowp-p-1">
                            ...
                            <div class="asowp-relative asowp-w-[50px] asowp-h-[48px] asowp-rounded-[8px] asowp-border asowp-border-solid asowp-border-[#e5e7eb] asowp-bg-white asowp-overflow-hidden">
                                <img v-if="dropdownType.options[key].popImg != ''" :src="dropdownType.options[key].popImg" alt="" class="asowp-absolute asowp-inset-0 asowp-w-full asowp-h-full asowp-object-cover">
                                <button v-if="dropdownType.options[key].popImg != ''" type="button" @click="()=>{dropdownType.options[key].popImg = ''}" :class="`asowp-bg-[#007a73] asowp-absolute asowp-bottom-0 asowp-right-0 asowp-text-white asowp-p-1 asowp-rounded-tl-lg asowp-border-none asowp-cursor-pointer`">
                        ...
                        <div v-show="dropdownType.options[key].price.type!='none'">
                            <div class="asowp-flex asowp-flex-col asowp-space-y-1 asowp-w-10/12 asowp-pt-4 asowp-pb-8 asowp-px-8">
                                ...
                                <p class="text-[11px] w-2/3">{{dropdownType.options[key].price.type == 'base'? __('Additional cost when selected by customer (e.g. $10.00).', 'all-signs-options-pro') : __('Multiply the final price of the sign when selected (e.g. 2 x 100).', 'all-signs-options-pro')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
