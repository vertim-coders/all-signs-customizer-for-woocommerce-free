<template>
    <div class="aso-space-y-1">
        <div class="aso-bg-white aso-shadow-md aso-justify-center aso-items-center aso-px-4 aso-py-6">
            ...
            <div class="aso-flex aso-justify-between aso-space-x-12">
                <div class="aso-w-2/5 aso-space-y-2">
                    <label>Label</label>
                    <input v-model="inputTypeImage.label" type="text" :class="`aso-w-full ${emptyLabel?'aso-field-required':''}`" value="Remote control (Dimmer)"/>
                </div>
                <div class="aso-w-2/5 aso-space-y-2">
        ...
        <div class="aso-bg-white aso-shadow-md aso-justify-center aso-items-center aso-px-4 aso-py-6 aso-space-y-2">
            <div>
            ...
            <div class="aso-relative aso-border-solid aso-border-[1px] aso-border-[#e5e7eb] aso-rounded-lg aso-p-8" v-for="(option,key) in inputTypeImage.options">
                ...
                <div v-if="dropOptions[key]">
                    <div class="aso-flex aso-justify-between aso-space-x-12">
                        <div class="aso-w-2/5 aso-space-y-2">
                            <label>Label</label>
                            <input v-model="inputTypeImage.options[key].label" type="text" :class="`aso-w-full`" value="Remote control (Dimmer)"/>
                        </div>
                        <div class="aso-w-2/5 aso-space-y-2">
                            <label>Value(Required)</label>
                            <input v-model="inputTypeImage.options[key].value" type="text" :class="`aso-w-full ${emptyValueArray[key]?'aso-field-required':''}`" value="A remote control is included free with every sign"/>
                        </div>
                    </div>
                        ...
                        <div class="aso-flex">
                            <div class="aso-flex aso-w-full aso-space-x-2">
                                ...
                                <div :class="`aso-relative aso-w-[82px] aso-h-[49px] aso-rounded-md aso-overflow-hidden`">
                                    <img v-if="inputTypeImage.options[key].popImg != ''" :src="inputTypeImage.options[key].popImg" alt="" class="aso-absolute aso-w-full aso-h-full">
                                    <button v-if="inputTypeImage.options[key].popImg != ''" @click="()=>{inputTypeImage.options[key].popImg = ''}" :class="`aso-bg-[#016464] aso-absolute aso-bottom-0 aso-right-0 aso-text-white aso-p-1 aso-rounded-tl-lg aso-border-none aso-cursor-pointer`">
                            ...
                            <div class="aso-flex aso-w-full aso-space-x-2">
                                <button @click="e=>selectChangePreviewImage(e,key)" class="aso-bg-[#016464] aso-border-none aso-w-fit aso-h-fit aso-p-4 aso-rounded aso-px-4 aso-text-white aso-opacity-90 hover:aso-opacity-100 aso-text-[12px] aso-cursor-pointer">choose a picture</button>
                                <div :class="`aso-relative aso-w-[82px] aso-h-[49px] aso-rounded-md aso-overflow-hidden`">
                                    <img v-if="inputTypeImage.options[key].prevImg != ''" :src="inputTypeImage.options[key].prevImg" alt="" class="aso-absolute aso-w-full aso-h-full">
                                    <button v-if="inputTypeImage.options[key].prevImg != ''" @click="()=>{inputTypeImage.options[key].prevImg = ''}" :class="`aso-bg-[#016464] aso-absolute aso-bottom-0 aso-right-0 aso-text-white aso-p-1 aso-rounded-tl-lg aso-border-none aso-cursor-pointer`">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-4 aso-h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                        </svg>
                                    </button>
                        ...
                        <div class="aso-flex aso-space-x-4">
                            <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                                ...
                                <label :for="'none'+key" class="aso-relative aso-inline-flex aso-items-center aso-cursor-pointer aso-border-[1px] aso-border-solid aso-border-black aso-rounded-full">
                                    <input :id="'none'+key" type="radio" :name="'price'+key" class="aso-sr-only aso-peer" value="none" v-model="inputTypeImage.options[key].price.type">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                                ...
                                <input :id="'base'+key" type="radio" :name="'price'+key" class="aso-sr-only aso-peer" value="base" v-model="inputTypeImage.options[key].price.type">
                                <div class="peer-checked:after:aso-border-[#016464] peer-checked:after:aso-border-solid peer-checked:after:aso-border-[5px] peer-checked:after:aso-top-[-2px] peer-checked:after:aso-translate-y-[-15%] aso-w-10 aso-h-3 aso-border aso-border-[5px] aso-border-[#016464] aso-bg-zinc-300 aso-rounded-full aso-peer peer-checked:after:aso-translate-x-[112%] after:aso-content-[''] after:aso-absolute after:aso-top-[-3px] after:aso-left-[-5px] after:aso-bg-zinc-300 after:aso-border-white after:aso-border-solid after:aso-translate-y-[-15%] after:aso-border-[#FFFFFF] after:aso-border-[5px] after:aso-rounded-full after:aso-h-3 after:aso-w-3 after:aso-transition-all after:aso-shadow-lg"></div>
                                </label>
                            </div>
                            <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                                ...
                                <input :id="'multiplier'+key" type="radio" :name="'price'+key" class="aso-sr-only aso-peer" value="multiplier" v-model="inputTypeImage.options[key].price.type">
                                <div class="peer-checked:after:aso-border-[#016464] peer-checked:after:aso-border-solid peer-checked:after:aso-border-[5px] peer-checked:after:aso-top-[-2px] peer-checked:after:aso-translate-y-[-15%] aso-w-10 aso-h-3 aso-border aso-border-[5px] aso-border-[#016464] aso-bg-zinc-300 aso-rounded-full aso-peer peer-checked:after:aso-translate-x-[112%] after:aso-content-[''] after:aso-absolute after:aso-top-[-3px] after:aso-left-[-5px] after:aso-bg-zinc-300 after:aso-border-white after:aso-border-solid after:aso-translate-y-[-15%] after:aso-border-[#FFFFFF] after:aso-border-[5px] after:aso-rounded-full after:aso-h-3 after:aso-w-3 after:aso-transition-all after:aso-shadow-lg"></div>
                                </label>
                            </div>
                        </div>
            ...
            <div class="aso-pt-4 aso-felx aso-justify-start aso-items-center">
