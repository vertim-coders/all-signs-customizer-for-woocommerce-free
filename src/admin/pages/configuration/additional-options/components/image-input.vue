            ...
            <div class="asowp-relative asowp-border-solid asowp-border-[1px] asowp-border-[#e5e7eb] asowp-rounded-lg asowp-p-8" v-for="(option,key) in inputTypeImage.options">
                ...
                <div v-if="dropOptions[key]">
                    ...
                    <div class="asowp-flex asowp-flex-col asowp-w-2/5 asowp-space-y-2 asowp-py-4">
                        <label class="so-text-[12px] asowp-text-[#444444]">Color</label>
                    ...
                    <div>
                        ...
                        <div class="asowp-flex">
                            ...
                            <div class="asowp-flex asowp-w-full asowp-space-x-2">
                                <button @click="e=>selectChangePreviewImage(e,key)" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[12px] asowp-cursor-pointer">choose a picture</button>
                                <div :class="`asowp-relative asowp-w-[82px] asowp-h-[49px] asowp-rounded-md asowp-overflow-hidden`">
