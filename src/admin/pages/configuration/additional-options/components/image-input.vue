                    ...
                    <div>
                        ...
                        <div class="asowp-flex">
                            <div class="asowp-flex asowp-w-full asowp-space-x-2">
                                <button @click="e=>selectPopupImage(e,key)" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[12px] asowp-cursor-pointer">{{ __('choose a picture', 'all-signs-options-pro') }}</button>
                                <div :class="`asowp-relative asowp-w-[82px] asowp-h-[49px] asowp-rounded-md asowp-overflow-hidden`">
                                    <img v-if="inputTypeImage.options[key].popImg != ''" :src="inputTypeImage.options[key].popImg" alt="" class="asowp-absolute asowp-w-full asowp-h-full">
                                    <button v-if="inputTypeImage.options[key].popImg != ''" @click="()=>{inputTypeImage.options[key].popImg = ''}" :class="`asowp-bg-[#016464] asowp-absolute asowp-bottom-0 asowp-right-0 asowp-text-white asowp-p-1 asowp-rounded-tl-lg asowp-border-none asowp-cursor-pointer`">
                            ...
                            <div class="asowp-flex asowp-w-full asowp-space-x-2">
                                <button @click="e=>selectChangePreviewImage(e,key)" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[12px] asowp-cursor-pointer">{{ __('choose a picture', 'all-signs-options-pro') }}</button>
                                <div :class="`asowp-relative asowp-w-[82px] asowp-h-[49px] asowp-rounded-md asowp-overflow-hidden`">
                                    <img v-if="inputTypeImage.options[key].prevImg != ''" :src="inputTypeImage.options[key].prevImg" alt="" class="asowp-absolute asowp-w-full asowp-h-full">
                                    <button v-if="inputTypeImage.options[key].prevImg != ''" @click="()=>{inputTypeImage.options[key].prevImg = ''}" :class="`asowp-bg-[#016464] asowp-absolute asowp-bottom-0 asowp-right-0 asowp-text-white asowp-p-1 asowp-rounded-tl-lg asowp-border-none asowp-cursor-pointer`">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="asowp-w-4 asowp-h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                        </svg>
                                    </button>
