        ...
        <div class="aso-bg-white aso-shadow-md aso-justify-center aso-items-center aso-px-4 aso-py-6">
            ...
            <div class="aso-flex aso-justify-between aso-space-x-12">
                <div class="aso-w-2/5 aso-space-y-2">
                    <label>Label</label>
                    <input v-model="includedOption.label" type="text" :class="`aso-w-full ${emptyLabel?'aso-field-required':''}`" value="Remote control (Dimmer)"/>
                </div>
                <div class="aso-w-2/5 aso-space-y-2">
                    <label>Description</label>
                    <input v-model="includedOption.description" type="text" class="aso-w-full" value="A remote control is included free with every sign"/>
                </div>
            </div>
        </div>
        <div class="aso-bg-white aso-shadow-md aso-justify-center aso-items-center aso-px-4 aso-py-6">
            ...
            <div class="aso-flex aso-w-full aso-space-x-2">
                ...
                <div :class="`aso-relative aso-w-[82px] aso-h-[49px] aso-rounded-md aso-overflow-hidden`">
                    <img v-if="includedOption.popImg != ''" :src="includedOption.popImg" alt="" class="aso-absolute aso-w-full aso-h-full">
                    <button v-if="includedOption.popImg != ''" @click="()=>{includedOption.popImg = ''}" :class="`aso-bg-[#016464] aso-absolute aso-bottom-0 aso-right-0 aso-text-white aso-p-1 aso-rounded-tl-lg aso-border-none aso-cursor-pointer`">
        ...
        <div class="aso-bg-white aso-shadow-md aso-justify-center aso-items-center aso-px-4 aso-py-6">
            ...
            <div class="aso-flex aso-space-x-4">
                <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                    ...
                    <label for="none" class="aso-relative aso-inline-flex aso-items-center aso-cursor-pointer aso-border-[1px] aso-border-solid aso-border-black aso-rounded-full">
                        <input id="none" type="radio" name="none" class="aso-sr-only aso-peer" value="none" v-model="includedOption.price.type">
                ...
                <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                    ...
                    <input id="base" type="radio" name="base" class="aso-sr-only aso-peer" value="base" v-model="includedOption.price.type">
                    <div class="peer-checked:after:aso-border-[#016464] peer-checked:after:aso-border-solid peer-checked:after:aso-border-[5px] peer-checked:after:aso-top-[-2px] peer-checked:after:aso-translate-y-[-15%] aso-w-10 aso-h-3 aso-border aso-border-[5px] aso-border-[#016464] aso-bg-zinc-300 aso-rounded-full aso-peer peer-checked:after:aso-translate-x-[112%] after:aso-content-[''] after:aso-absolute after:aso-top-[-3px] after:aso-left-[-5px] after:aso-bg-zinc-300 after:aso-border-white after:aso-border-solid after:aso-translate-y-[-15%] after:aso-border-[#FFFFFF] after:aso-border-[5px] after:aso-rounded-full after:aso-h-3 after:aso-w-3 after:aso-transition-all after:aso-shadow-lg"></div>
                    </label>
                </div>
                <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                    ...
                    <input id="multiplier" type="radio" name="multiplier" class="aso-sr-only aso-peer" value="multiplier" v-model="includedOption.price.type">
                    <div class="peer-checked:after:aso-border-[#016464] peer-checked:after:aso-border-solid peer-checked:after:aso-border-[5px] peer-checked:after:aso-top-[-2px] peer-checked:after:aso-translate-y-[-15%] aso-w-10 aso-h-3 aso-border aso-border-[5px] aso-border-[#016464] aso-bg-zinc-300 aso-rounded-full aso-peer peer-checked:after:aso-translate-x-[112%] after:aso-content-[''] after:aso-absolute after:aso-top-[-3px] after:aso-left-[-5px] after:aso-bg-zinc-300 after:aso-border-white after:aso-border-solid after:aso-translate-y-[-15%] after:aso-border-[#FFFFFF] after:aso-border-[5px] after:aso-rounded-full after:aso-h-3 after:aso-w-3 after:aso-transition-all after:aso-shadow-lg"></div>
                    </label>
                </div>
            </div>
            <div v-if="includedOption.price.type!='none'">
                <div class="flex flex-col space-y-1 w-10/12 pt-4 pb-8 px-8">
                    ...
                    <p class="text-[11px] w-2/3">{{includedOption.price.type == 'base'? 'Additional cost when selected by customer (e.g. $10.00).' : "Multiply the final price of the sign when selected (e.g. 2 x 100)."}}</p>
                </div>
            </div>
        </div>
    </div>
