    ...
    <div class="asowp-space-y-1">
        ...
        <div class="asowp-bg-white asowp-shadow-md asowp-justify-center asowp-items-center asowp-px-4 asowp-py-4">
            ...
            <div class="asowp-flex asowp-w-full asowp-space-x-2">
                <button @click="selectChangeImage" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[12px] asowp-cursor-pointer">{{ __("choose a picture", "all-signs-options-pro") }}</button>
