...
<template>
    <div class="asowp-space-y-1">
        ...
        <div class="asowp-bg-white asowp-shadow-md asowp-justify-center asowp-items-center asowp-px-4 asowp-py-4">
            <p class="asowp-text-[14px] asowp-font-bold">3- Yes/No Input</p>
            <p class="asowp-text-[12px]">Displays as two buttons side by side.</p>
            <div class="asowp-flex asowp-justify-between asowp-space-x-12">
                <div class="asowp-w-2/5 asowp-space-y-2">
            ...
            <p class="asowp-text-[14px] asowp-font-bold asowp-pt-4">DEFAULT SELECTED VALUE</p>
            <p class="asowp-text-[12px]">Choose which value is highlighted by default when the product customiser initally displays.</p>
            <div class="asowp-flex asowp-space-x-4">
                <div class="asowp-flex asowp-justify-center asowp-items-center asowp-space-x-4">
                    <p class="asowp-text-md asowp-font-medium asowp-text-black">Selected</p>
                ...
                <div class="asowp-flex asowp-justify-center asowp-items-center asowp-space-x-4">
                    <p class="asowp-text-md asowp-font-medium asowp-text-black">Unselected</p>
        ...
        <div class="asowp-bg-white asowp-shadow-md asowp-justify-center asowp-items-center asowp-px-4 asowp-py-4">
            ...
            <div class="asowp-flex asowp-w-full asowp-space-x-2">
                <button @click="selectChangeImage" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[12px] asowp-cursor-pointer">choose a picture</button>
                <div :class="`asowp-relative asowp-w-[82px] asowp-h-[49px] asowp-rounded-md asowp-overflow-hidden`">
                    <img v-if="yesOrNo.popImg != ''" :src="yesOrNo.popImg" alt="" class="asowp-absolute asowp-w-full asowp-h-full">
                    <button v-if="yesOrNo.popImg != ''" @click="()=>{yesOrNo.popImg = ''}" :class="`asowp-bg-[#016464] asowp-absolute asowp-bottom-0 asowp-right-0 asowp-text-white asowp-p-1 asowp-rounded-tl-lg asowp-border-none asowp-cursor-pointer`">
        ...
        <div class="asowp-bg-white asowp-shadow-md asowp-justify-center asowp-items-center asowp-px-4 asowp-py-4">
            <p class="asowp-text-[14px] asowp-font-bold">5- Pricing (optional) </p>
            <div class="asowp-flex asowp-space-x-4">
                <div class="asowp-flex asowp-justify-center asowp-items-center asowp-space-x-4">
