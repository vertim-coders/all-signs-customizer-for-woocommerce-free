        ...
        <div class="ascwo-bg-white ascwo-shadow-md ascwo-justify-center ascwo-items-center ascwo-p-4">
            ...
            <div class="ascwo-relative ascwo-border-solid ascwo-border-[1px] ascwo-border-[#e5e7eb] ascwo-rounded-lg ascwo-p-2" v-for="(option,key) in dropdownType.options" :key="key">
                ...
                <div class="ascwo-absolute ascwo-flex ascwo-jsutify-center ascwo-items-center ascwo-space-x-2 ascwo-right-0 ascwo-top-0 ">
                    ...
                    <button v-if="dropdownType.options.length > 1" :disabled="isLoading" @click="handleClickRemoveAdditional(key)" class="ascwo-flex ascwo-jsutify-center ascwo-items-center ascwo-bg-red-500 ascwo-rounded ascwo-w-fit ascwo-space-x-2 ascwo-h-fit ascwo-text-white ascwo-p-[5px] ascwo-rounded ascwo-border-none hover:ascwo-opacity-100 hover:ascwo-border-none hover:ascwo-text-white hover:ascwo-bg-red-400 ascwo-cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-4 ascwo-h-4">
            ...
            <div>
                <button :disabled="isLoading" @click="handleClickAddAdditional" class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-bg-[#016464] ascwo-rounded ascwo-w-fit ascwo-space-x-2 ascwo-h-fit ascwo-text-white ascwo-px-8 ascwo-p-2.5 ascwo-rounded ascwo-border-none hover:ascwo-opacity-100 hover:ascwo-border-none hover:ascwo-text-white hover:ascwo-bg-[#016464] ascwo-cursor-pointer">
