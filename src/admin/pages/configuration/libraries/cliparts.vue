  ...
  <div class="ascwo-space-y-3">
    <template v-if="!isAddingGroup">
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4 ascwo-flex ascwo-items-center ascwo-justify-between ascwo-gap-4">
        <div>
          ...
          <p class="ascwo-m-0 ascwo-mt-1 ascwo-text-[13px] ascwo-leading-4 ascwo-text-[#616161]">
            {{ __('Select existing clipart groups for this config or create a new group and save it into Manage cliparts.', 'all-signs-customizer-for-woocommerce-pro') }}
          </p>
        </div>
        <div class="ascwo-flex ascwo-items-center ascwo-gap-3 ascwo-shrink-0">
          <button type="button" @click="goToManageCliparts" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#202223] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">
            {{ __('Manage cliparts', 'all-signs-customizer-for-woocommerce-pro') }}
          </button>
          <button type="button" @click="openAddGroup" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white ascwo-inline-flex ascwo-items-center ascwo-gap-2">
            ...
            {{ __('Add clipart group', 'all-signs-customizer-for-woocommerce-pro') }}
          </button>
        </div>
      </section>
      ...
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
        <h2 class="ascwo-m-0 ascwo-mb-3 ascwo-text-[14px] ascwo-leading-5 ascwo-font-[900] ascwo-text-[#303030]">{{ __('Selected groups', 'all-signs-customizer-for-woocommerce-pro') }}</h2>
        <table class="ascwo-cliparts-table ascwo-w-full ascwo-border-collapse ascwo-text-left">
          <thead class="ascwo-bg-[#f6f6f7]">
            <tr>
              <th class="ascwo-px-3 ascwo-py-2.5 ascwo-text-[12px] ascwo-font-[800] ascwo-text-[#616161]">{{ __('Preview', 'all-signs-customizer-for-woocommerce-pro') }}</th>
              ...
              <th class="ascwo-px-3 ascwo-py-2.5 ascwo-text-[12px] ascwo-font-[800] ascwo-text-[#616161]">{{ __('Cliparts', 'all-signs-customizer-for-woocommerce-pro') }}</th>
          ...
          <tbody>
            ...
            <tr v-else-if="selectedGroups.length === 0" class="ascwo-border-b ascwo-border-solid ascwo-border-[#e5e7eb]">
              ...
              <td class="ascwo-px-3 ascwo-py-3">
                <div class="ascwo-flex ascwo-items-center ascwo-gap-2">
                  <button type="button" disabled class="ascwo-h-7 ascwo-px-2.5 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[13px] ascwo-font-[700] ascwo-opacity-60">{{ __('Manage', 'all-signs-customizer-for-woocommerce-pro') }}</button>
            ...
            <tr v-for="group in selectedGroups" :key="group.id" class="ascwo-border-b ascwo-border-solid ascwo-border-[#e5e7eb]">
              ...
              <td class="ascwo-px-3 ascwo-py-3">
                <div class="ascwo-flex ascwo-items-center ascwo-gap-2">
                  <button type="button" @click="manageGroup(group)" class="ascwo-h-7 ascwo-px-2.5 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">{{ __('Manage', 'all-signs-customizer-for-woocommerce-pro') }}</button>
      ...
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
        <div class="ascwo-flex ascwo-items-start ascwo-justify-between ascwo-gap-4">
          <div>
            <h2 class="ascwo-m-0 ascwo-text-[14px] ascwo-leading-5 ascwo-font-[900] ascwo-text-[#303030]">{{ __('Clipart settings', 'all-signs-customizer-for-woocommerce-pro') }}</h2>
            <p class="ascwo-m-0 ascwo-mt-1 ascwo-text-[13px] ascwo-leading-4 ascwo-text-[#616161]">{{ __('Enable or disable cliparts for this config.', 'all-signs-customizer-for-woocommerce-pro') }}</p>
          </div>
        ...
        <div class="ascwo-mt-5 ascwo-flex ascwo-justify-end">
          <button type="button" @click="saveSettings" :disabled="isSaving" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white disabled:ascwo-bg-[#d1d1d1] disabled:ascwo-border-[#d1d1d1]">
            {{ isSaving ? __('Saving...', 'all-signs-customizer-for-woocommerce-pro') : __('Save settings', 'all-signs-customizer-for-woocommerce-pro') }}
          </button>
        </div>
      </section>
    </template>
    ...
    <section v-else class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
      <h1 class="ascwo-m-0 ascwo-mb-4 ascwo-text-[14px] ascwo-leading-5 ascwo-font-[900] ascwo-text-[#303030]">{{ __('Add clipart group', 'all-signs-customizer-for-woocommerce-pro') }}</h1>

      <div class="ascwo-flex ascwo-items-center ascwo-gap-3 ascwo-mb-5">
        <span class="ascwo-text-[13px] ascwo-text-[#616161]">{{ __('Existing', 'all-signs-customizer-for-woocommerce-pro') }}</span>
        <button type="button" @click="setCreateNew(false)" :class="toggleClass(!createNewGroup)" aria-label="Existing"></button>
        <span class="ascwo-text-[13px] ascwo-text-[#616161]">{{ __('Create new', 'all-signs-customizer-for-woocommerce-pro') }}</span>
      ...
      <template v-if="!createNewGroup">
        <label class="ascwo-block ascwo-text-[13px] ascwo-text-[#303030]">
          {{ __('Clipart group', 'all-signs-customizer-for-woocommerce-pro') }}
        ...
        <p class="ascwo-m-0 ascwo-mt-4 ascwo-text-[13px] ascwo-text-[#616161]">{{ __('Reuse an existing group from Manage cliparts.', 'all-signs-customizer-for-woocommerce-pro') }}</p>
      </template>

      <template v-else>
        <div class="ascwo-grid md:ascwo-grid-cols-2 ascwo-gap-4 ascwo-mb-5">
          <label class="ascwo-block ascwo-text-[13px] ascwo-text-[#303030]">
            {{ __('Group title', 'all-signs-customizer-for-woocommerce-pro') }}
        ...
        <h2 class="ascwo-m-0 ascwo-mb-3 ascwo-text-[14px] ascwo-font-[900] ascwo-text-[#303030]">{{ __('Cliparts', 'all-signs-customizer-for-woocommerce-pro') }}</h2>
        <div v-if="!useApiSource" class="ascwo-space-y-3">
          <div v-for="(clipart, index) in newCliparts" :key="index" class="ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-p-4">
            <h3 class="ascwo-m-0 ascwo-mb-3 ascwo-text-[14px] ascwo-font-[900] ascwo-text-[#303030]">{{ __('Clipart', 'all-signs-customizer-for-woocommerce-pro') }} {{ index + 1 }}</h3>
            ...
            <p class="ascwo-m-0 ascwo-mt-2 ascwo-text-[13px] ascwo-text-[#616161]">{{ __('This image will be saved into the new clipart group.', 'all-signs-customizer-for-woocommerce-pro') }}</p>
          </div>
        ...
        <p v-else class="ascwo-m-0 ascwo-text-[13px] ascwo-text-[#616161]">{{ __('API clipart creation will use the managed clipart library.', 'all-signs-customizer-for-woocommerce-pro') }}</p>
      </template>

      <div class="ascwo-mt-6 ascwo-flex ascwo-justify-end ascwo-gap-3">
        <button type="button" @click="backToCliparts" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#202223] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">{{ __('Back to cliparts', 'all-signs-customizer-for-woocommerce-pro') }}</button>
        <button type="button" @click="submitGroup" :disabled="isSaving || !canSubmitGroup" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white disabled:ascwo-bg-[#d1d1d1] disabled:ascwo-border-[#d1d1d1] disabled:ascwo-cursor-not-allowed">
          {{ isSaving ? __('Saving...', 'all-signs-customizer-for-woocommerce-pro') : createNewGroup ? __('Create group and add', 'all-signs-customizer-for-woocommerce-pro') : __('Add group', 'all-signs-customizer-for-woocommerce-pro') }}
        </button>
      </div>
    </section>
  </div>
...
const saveSettings = async () => {
  ...
  try {
    ...
    if (result?.success === false) {
      toastMessage(result.message || __('Unable to save clipart settings', 'all-signs-customizer-for-woocommerce-pro'), 'error');
      return false;
    }
    toastMessage(result?.message || __('Clipart settings saved', 'all-signs-customizer-for-woocommerce-pro'));
...
const submitGroup = async () => {
  ...
  try {
    ...
    if (!result?.success) {
      toastMessage(result?.message || __('Unable to create clipart group', 'all-signs-customizer-for-woocommerce-pro'), 'error');
      return;
    }
