<template>
    <div>
        ...
        <div class="aso-space-y-1" v-show="contentOption">
            ...
            <div class="aso-bg-[#F8F9FB] aso-px-4 aso-py-4 aso-space-y-8 aso-pb-20">
                <div class="aso-flex">
                ...
                <div class="aso-flex aso-py-8">
                    ...
                    <div class="aso-w-1/2 aso-space-y-2">
                        <label for="" class="">Size</label>
                        <div class="aso-flex aso-space-x-4">
                            <input type="text" placeholder="width" class="aso-w-[36%]">
                            <span class="aso-font-bold">x</span>
                            <input type="text" placeholder="height" class="aso-w-[36%]">
                        </div>
                    </div>
                </div>
                <div class="aso-flex">
                ...
                <div class="aso-w-1/2 aso-space-y-8 aso-flex aso-flex-col aso-text-[14px]">
                    <label for="" class="aso-font-normal">Color</label>
                    <input type="color" class="aso-rounded aso-w-[78%] aso-h-[30px] aso-absolute">
