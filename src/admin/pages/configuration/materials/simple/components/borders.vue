    ...
    <div class="aso-space-y-4 aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="listBorder">
            ...
            <div class="aso-flex aso-justify-end aso-bg-[#F8F9FB] aso-px-4 aso-py-4 aso-pb-2">
                <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-cursor-pointer" @click="newBorder">
                ...
                <table class="aso-w-full aso-text-left aso-px-4 aso-border aso-border-collapse aso-border-0">
                    ...
                    <tbody class="aso-bg-white aso-text-[14px]">
                        ...
                        <tr class="aso-border-t-0 aso-border-l-0 aso-border-r-0 aso-border-b-2 aso-border-solid aso-border-[#f0f0f1]">
                            <td class="aso-w-[30%] aso-px-8 aso-p-4">
                                   None
                            </td>
                            <td class="aso-px-8 aso-py-3 aso-flex aso-space-x-2">
                        ...
                        <tr class="aso-border-t-0 aso-border-l-0 aso-border-r-0 aso-border-b-2 aso-border-solid aso-border-[#f0f0f1]">
                            ...
                            <td class="aso-px-6 aso-flex aso-space-x-2">
        ...
        <div class="aso-space-y-2" v-show="selectBorder">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                <div class="">
                    <button class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-border-[1px] aso-rounded aso-px-8 aso-p-2.5 aso-border-black aso-border-solid hover:aso-border-none hover:aso-text-white hover:aso-bg-[#016464] aso-cursor-pointer" @click="back">
