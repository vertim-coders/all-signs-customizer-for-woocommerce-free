...
>>>>>>> 5550fb22cb3f0a2454b4bdd690703964730bfc18
                ...
                <div v-if="!isEdit">
                    ...
                    <div v-if="!discounts || !Array.isArray(discounts) || discounts.length === 0" 
                        ...
                        <h4 class="asowp-text-lg asowp-font-medium asowp-text-[#444444] asowp-mb-2">Discount is empty</h4>
                        <p class="asowp-text-sm asowp-text-[#666666] asowp-mb-6">No discounts have been configured yet. Add your first discount to get started.</p>
                        ...
                        <button @click="handleAddMaterialDiscount" 
                            ...
                            <span class="asowp-font-medium">Add First Discount</span>
                        </button>
                    </div>
...
>>>>>>> 5550fb22cb3f0a2454b4bdd690703964730bfc18
                            ...
                            <div v-if="discounts[key].quantity > 0 && discounts[key].discountPercentage > 0" 
                                ...
                                <p class="asowp-text-sm asowp-text-[#0369A1] asowp-m-0">
                                    <span class="asowp-font-medium">Preview:</span> 
                                    Customers buying {{ discounts[key].quantity }}+ items will get {{ discounts[key].discountPercentage }}% off
                                </p>
                            </div>
                        </div>
...
>>>>>>> 5550fb22cb3f0a2454b4bdd690703964730bfc18
                                ...
                                <span class="asowp-font-medium asowp-text-sm">Add Another Discount</span>
                            </button>
                        </div>
                    </div>
                </div>
