    ...
    <div class="aso-space-y-4 aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="listFixing">
            ...
            <div class="aso-flex aso-justify-end aso-bg-[#F8F9FB] aso-px-4 aso-py-4 aso-pb-2">
                <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-cursor-pointer" @click="newFixing">
        ...
        <div class="aso-space-y-2" v-show="selectFixing">
...
<script setup>
    import { ref } from "vue";
    const selectFixing = ref(false);
    const listFixing = ref(true);
    const newFixing = () => {
        listFixing.value = false;
        selectFixing.value = true;
    }
    const back = () => {
        listFixing.value = true;
        selectFixing.value = false;
    }
