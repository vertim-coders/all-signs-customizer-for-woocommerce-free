<template>
    <div class="aso-space-y-4 aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="listShape">
            ...
            <div class="aso-flex aso-justify-end aso-bg-[#F8F9FB] aso-px-4 aso-py-4 aso-pb-2">
                <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-cursor-pointer" @click="newShape">
                    ...
                    <tbody class="aso-bg-white aso-text-[14px]">
                        ...
                        <tr class="aso-border-t-0 aso-border-l-0 aso-border-r-0 aso-border-b-2 aso-border-solid aso-border-[#f0f0f1]">
                            ...
                            <td class="aso-text-[12px] aso-px-6 aso-py-3 aso-space-x-2">
                                <div class="aso-w-fit aso-rounded-lg aso-px-2 aso-p-1 aso-bg-[#9ACD321F] aso-text-[#466801] aso-border-none">
                                    250$
                                </div>
                            </td>
        ...
        <div class="aso-space-y-2" v-show="selectShape">
...
<script setup>
    import { ref } from "vue";
    const selectShape = ref(false);
    const listShape = ref(true);
    const newShape = () => {
        listShape.value = false;
        selectShape.value = true;
    }
    const back = () => {
        listShape.value = true;
        selectShape.value = false;
    }
