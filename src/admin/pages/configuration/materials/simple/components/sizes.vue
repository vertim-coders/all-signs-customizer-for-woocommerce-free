    ...
    <div class="aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="listSize">
            ...
            <div class="aso-flex aso-justify-end aso-space-x-2 aso-w-4/4 aso-bg-[#F8F9FB] aso-text-[12px] aso-px-4 aso-py-4 aso-pb-2">
                ...
                <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-opacity-90 hover:aso-opacity-100 aso-cursor-pointer" @click="newSize">
        ...
        <div class="aso-space-y-2" v-show="listSize">
            <div class="aso-bg-[#F8F9FB] aso-text-[16px] aso-font-medium aso-px-8 aso-py-8 ">
                ...
                <div class="aso-space-y-6 aso-pt-12">
            ...
            <div class="aso-bg-[#F8F9FB] aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
            ...
            <div class="aso-bg-[#F8F9FB] aso-space-y-6 aso-px-4 aso-py-8">
                ...
                <div class="aso-flex aso-justify-between">
                    <div class="aso-w-2/5 aso-space-y-2 aso-text-[12px] aso-flex aso-flex-col">
                        ...
                        <div class="">
                            <input type="text" placeholder="0" class="aso-rounded aso-w-full aso-h-[30px]">
                        </div>
                ...
                <div class="aso-flex aso-justify-between">
                    <div class="aso-w-2/5 aso-space-y-2 aso-text-[12px] aso-flex aso-flex-col">
                        ...
                        <div class="aso-relative">
                            <input type="text" placeholder="$ 25" class="aso-rounded aso-w-full aso-h-[30px]">
                        </div>
