<template>
    <div class="aso-space-y-4 aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="listSize">
            ...
            <div class="aso-flex aso-space-x-2 aso-w-4/4 aso-bg-[#F8F9FB] aso-text-[12px] aso-px-4 aso-py-4 aso-pb-2">
                <div class="aso-w-1/4 aso-relative">
                    <input type="type" name="" id="" class="aso-w-[95%] aso-p-2 aso-text-[12px] aso-h-[30px] aso-absolute" placeholder="Search component">
                ...
                <div class="aso-w-1/4">
                    <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-cursor-pointer" @click="newSize">
            ...
            <div class="aso-relative" id="monTableau">
                <table class="aso-w-full aso-text-left aso-px-4 aso-border aso-border-collapse aso-border-0">
        ...
        <div class="aso-space-y-2" v-show="listSize">
            <div class="aso-bg-[#F8F9FB] aso-text-[16px] aso-font-medium aso-px-8 aso-py-8 ">
                <div class="aso-flex ">
                    ...
                    <div class="aso-flex aso-items-center aso-translate-x-5 aso-translate-y-0.5">
                        ...
                        <div :class="{'aso-translate-x-[100%]': isCheckbox, 'aso-bg-active': isChecked }" class="aso-toggle-dot aso-w-3 aso-h-3 -aso-translate-y-[8px] -aso-translate-x-2 aso-border-[4px] aso-border-solid aso-border-[#008000] aso-bg-white aso-rounded-full aso-shadow-md aso-transform"></div>
                        </label>
                    </div>
                </div>
                <div class="aso-py-10">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                <div class="">
                    <button class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-border-[1px] aso-rounded aso-px-12 aso-p-2.5 aso-border-black aso-border-solid hover:aso-border-none hover:aso-text-white hover:aso-bg-[#016464] aso-cursor-pointer">
                        <div class="aso-font-semibold aso-text-[16px]">Save</div>
                    </button>
                </div>
            </div>
        </div>
        <div class="aso-space-y-2" v-show="selectSize">
            <div class="aso-py-12 aso-bg-[#F8F9FB] aso-space-x-4 aso-px-4 aso-py-8">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                <div class="">
                    <button class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-border-[1px] aso-rounded aso-px-6 aso-p-1.5 aso-border-black aso-border-solid hover:aso-border-none hover:aso-text-white hover:aso-bg-[#016464] aso-cursor-pointer" @click="back">
                ...
                <div class="">
                    <button class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-border-[1px] aso-rounded aso-px-10 aso-p-2 aso-border-black aso-border-solid hover:aso-border-none hover:aso-text-white hover:aso-bg-[#016464] aso-cursor-pointer">
                        <div class="aso-font-semibold aso-text-[16px]">Save</div>
                    </button>
                </div>
            </div>
