<template>
    <div class="">
<<<<<<< HEAD
        <div class="asowp-space-y-1 asowp-translate-y-2 asowp-bg-[#fff] asowp-p-4 asowp-rounded-[10px] asowp-border-[2px] asowp-border-solid asowp-border-[#d9d9d9]" v-if="!isNewSize">
=======
                    ...
                    <div class="asowp-space-y-6 asowp-pt-8" v-if="sizes.customSize.active">
                        ...
                        <div class="asowp-space-y-2">
                            <div class="asowp-space-x-8 asowp-flex asowp-relative asowp-pe-8 asowp-items-center">
                                ...
                                <div v-if="showPricingModal" class="asowp-absolute -asowp-top-20 asowp-left-20  asowp-justify-center asowp-items-center asowp-w-full">
                            ...
                            <div v-if="sizes.customSize.pricings.type == 'range'">
                                    ...
                                    <div>
                                        <div class="asowp-py-2 asowp-grid asowp-grid-cols-4 asowp-gap-4 asowp-text-[12px]">   
                                            ...
                                            <div class="asowp-space-y-2 asowp-text-[12px] asowp-flex asowp-flex-col">
                                                ...
                                                <div class="asowp-relative">
                                                    <input min="0" type="number" v-model="sizes.customSize.pricings.range[key].basePrice" class="asowp-rounded asowp-w-full asowp-h-[35px]" style="border-radius: 10px !important;" @blur="isNaN(sizes.customSize.pricings.range[key].basePrice) ? sizes.customSize.pricings.range[key].basePrice=0 : ''">
                                                </div>
                                            </div>
                                            <div class="asowp-space-y-2 asowp-text-[12px] asowp-flex asowp-flex-col">
                                ...
                                <div v-if="canAddNewPricing" class="asowp-pt-4">
                            ...
                            <div v-if="sizes.customSize.pricings.type == 'unit'">
                                <div class="asowp-relative asowp-space-y-2 asowp-py-2 asowp-flex asowp-flex-col asowp-text-[12px]" >
                                    <div>
                                        <div class="asowp-py-2 asowp-grid asowp-grid-cols-4 asowp-gap-4 asowp-text-[12px]">   
                                            <div class="asowp-space-y-2 asowp-text-[12px] asowp-flex asowp-flex-col">
...
=======
            ...
            <div class="asowp-bg-[#F8F9FB] asowp-text-[16px] asowp-font-medium asowp-px-8 asowp-py-8 ">
                ...
                <div class="asowp-space-y-6 asowp-pt-12" v-if="sizes.customSize.active">
                    ...
                    <div class="asowp-space-y-2">
                        <div class="asowp-space-x-8 asowp-flex asowp-relative asowp-justify-between asowp-pe-8  asowp-items-center">
                            <div class="asowp-space-x-8 asowp-flex  asowp-items-center">
                                <label>Pricings</label>
                                <div @click="showPricingModal = true" class="asowp-cursor-pointer asowp-w-7 asowp-h-7 asowp-rounded-full asowp-bg-blue-500 asowp-text-white asowp-flex asowp-items-center asowp-justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="asowp-w-6 asowp-h-6">
...
<<<<<<< HEAD
        <div class="asowp-space-y-2 asowp-translate-y-2" v-if="isNewSize">
                ...
                <div class="asowp-space-y-4">
                    <div class="asowp-flex asowp-flex-col asowp-justify-between">
                        ...
                        <input v-model.trim="size.label" 
                            ...
                            :class="size.label?.trim() ? 'asowp-border-[#e5e7eb]' : 'asowp-border-red-400'">
...
const handleAddNewPricing = ()=>{
    sizes.value.customSize.pricings.range.push({
        basePrice:0,
        charPrice:0,
        surface:0
    });
