<template>
        ...
        <div :class="['asowp-w-full asowp-flex asowp-items-center asowp-gap-3 asowp-bg-white asowp-py-2 asowp-text-sm asowp-text-gray-700 asowp-fixed asowp-z-[15000] asowp-rounded-[10px] asowp-border-[2px] asowp-border-[rgba(0,0,0,.15)] asowp-border-solid asowp-px-2 asowp-shadow-lg', materialsBarTopClass]" style="width: 84.5% !important;">
            ...
            <div class="asowp-overflow-x-auto asowp-overflow-y-visible asowp-flex asowp-space-x-2 asowp-flex-nowrap asowp-w-full asowp-py-1 asowp-materials-scroll asowp-pr-[280px] asowp-items-center asowp-relative">
                ...
                >
                    ...
                    >
                        <div
                        class="asowp-overflow-hidden asowp-flex asowp-whitespace-nowrap asowp-space-x-4"
                        >
                            <span :class="[
                                'asowp-flex asowp-justify-center asowp-items-center',
                                key === activeMaterialIndex ? 'asowp-text-white' : ''
                            ]">
                                {{ material.name }}
                            </span>
                        ...
                        <div class="asowp-relative" @click.stop>
                            ...
                            >
                                <button
                                    class="asowp-bg-transparent asowp-border-none asowp-text-[#2DD05B] asowp-cursor-pointer asowp-flex asowp-items-center asowp-gap-2 asowp-py-1 asowp-px-2 hover:asowp-bg-gray-100 asowp-rounded"
    ...
    <div class="">
        <div class="asowp-flex asowp-space-x-2" v-if="contentComponent">
            <div v-if="!isAdvanceRoute" class="asowp-bg-white asowp-flex asowp-h-full asowp-flex-col asowp-rounded-[10px] asowp-border-[2px] asowp-border-[rgba(0,0,0,.15)] asowp-border-solid  asowp-justify-center asowp-items-center asowp-mt-[115px] asowp-p-3">
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/sizes')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Sizes' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/colors')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Colors' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/shapes')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Shapes' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="mdi:shape">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/borders')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Borders' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/fixing-methods')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-FixingMethods' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 40" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="uil:screw">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/text-images')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-TextImages' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/discounts')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Discounts' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="mdi:shape">
                            <path id="Vector" d="M18.3333 23.0625V36.7292H5V23.0625H18.3333ZM20 3.41666L29.1667 18.7917H10.8333L20 3.41666ZM29.1667 22.2083C33.3333 22.2083 36.6667 25.625 36.6667 29.8958C36.6667 34.1667 33.3333 37.5833 29.1667 37.5833C25 37.5833 21.6667 34.1667 21.6667 29.8958C21.6667 25.625 25 22.2083 29.1667 22.2083Z" fill="currentColor"/>
                            </g>
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+configSlug+'/'+configID+'/materials/'+materialSlug+'/'+materialId+'/simple/others-components')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-OthersComponents' || route.name == 'Simple-OthersComponents-Options' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
            ...
            <div class="asowp-w-full asowp-mt-[115px]">
                <div v-if="activeName" class="asowp-pl-3 asowp-pr-3 asowp-py-2 asowp-rounded-[10px] asowp-border-[2px] asowp-border-[rgba(0,0,0,.15)] asowp-border-solid asowp-bg-white asowp-flex asowp-flex-col">
                ...
                <div class="asowp-flex asowp-justify-between">
                    ...
                    <div class="asowp-space-y-2 asowp-pt-2 asowp-flex asowp-flex-col asowp-w-2/5">
                        ...
                        <input
                            ...
                            class="asowp-w-full asowp-h-[30px] asowp-font-normal asowp-bg-gray-100"
                        />
                    </div>
                </div>
...
const unslugify = (value) => String(value ?? '').replace(/-/g, ' ')

const configID = ref(route.params.configId)
const materialId = ref(route.params.materialId)
const config = ref(unslugify(route.params.config))
const material = ref(unslugify(route.params.material))

watch(() => route.params.configId, (v) => (configID.value = v))
watch(() => route.params.materialId, (v) => (materialId.value = v))
watch(() => route.params.config, (v) => (config.value = unslugify(v)))
watch(() => route.params.material, (v) => (material.value = unslugify(v)))

const configSlug = computed(() => String(route.params.config ?? slugify(config.value)))
const materialSlug = computed(() => String(route.params.material ?? slugify(material.value)))
...
onMounted(async() => {
    ...
    syncActiveIndexFromRoute();
	    ...
	    if (route.name === 'materials' && materials.value.length > 0) {
	      ...
	      redirectToMaterial(0, first.name, first.type)
	    }
...
const redirectToMaterial = (key, name, type) => {
  ...
  router.push({
    name: enforcedMaterialType.value === 'advance' ? 'Material-Advance' : 'Simple-Sizes',
    params: {
      config: configSlug.value,
      configId: configID.value,
      materialId: key,
      material: slugify(name),
    },
  })
}
</script>
