<template>
    <div>
        ...
        <div class="aso-bg-white  aso-px-6 aso-justify-between aso-items-center aso-flex">
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/sizes')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Sizes' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/borders')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Borders' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 40" fill="black" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/colors')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Colors' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/fixing-methods')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-FixingMethods' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 40" fill="black" xmlns="http://www.w3.org/2000/svg">
                        <g id="uil:screw">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/shapes')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Shapes' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                        <g id="mdi:shape">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/text-images')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-TextImages' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 46 47" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+configID+'/materials/'+materialId+'/simple/additional-options')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-AdditionalOptions' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
        ...
        <div>
            ...
            <AdditionalOptions v-if="route.name == 'Simple-AdditionalOptions'"/>
        </div>
    </div>
</template>
<script setup>
