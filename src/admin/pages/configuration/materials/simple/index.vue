    ...
    <div>
        <div class="aso-sticky aso-top-[80px] aso-z-[999]">
            <div class="aso-bg-[#F8F9FB] aso-space-x-1 aso-px-4 aso-py-4 aso-flex">
                ...
                <div v-if="config.trim() != ''" class="aso-text-[16px] aso-cursor-pointer" @click="goToMaterial">
                    Material
                </div>
        ...
        <div class="aso-bg-white aso-sticky aso-top-[130px] aso-z-[999] aso-shadow-md aso-justify-center aso-items-center aso-flex">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/colors')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Colors' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/shapes')" :class="`aso-flex aso-w-fit aso-h-fit aso-px-6 aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Shapes' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                        <g id="mdi:shape">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/borders')" :class="`aso-flex aso-w-fit aso-h-fit aso-px-6 aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-Borders' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/fixing-methods')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-FixingMethods' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
                    <svg class="aso-w-5 aso-h-5" viewBox="0 0 40 40" fill="black" xmlns="http://www.w3.org/2000/svg">
                        <g id="uil:screw">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/text-images')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-TextImages' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
            ...
            <div class="">
                <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/others-components')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'Simple-OthersComponents' || route.name == 'Simple-OthersComponents-Options' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[3px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
...
const goToMaterial = ()=>{
    router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials').then(() => {
