<template>
    ...
    <div class="">
        <div class="asowp-flex asowp-space-x-2" v-if="contentComponent">
            <div class="asowp-bg-white asowp-flex asowp-h-full asowp-flex-col asowp-rounded-[10px] asowp-border-[2px] asowp-border-[rgba(0,0,0,.15)] asowp-border-solid  asowp-justify-center asowp-items-center asowp-mt-[115px] asowp-p-3">
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/sizes')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Sizes' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/colors')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Colors' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/shapes')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Shapes' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="mdi:shape">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/borders')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Borders' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/fixing-methods')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-FixingMethods' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 40" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="uil:screw">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/text-images')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-TextImages' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/discounts')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-Discounts' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
                        <svg class="asowp-w-5 asowp-h-5" viewBox="0 0 40 41" fill="black" xmlns="http://www.w3.org/2000/svg">
                            <g id="mdi:shape">
                            <path id="Vector" d="M18.3333 23.0625V36.7292H5V23.0625H18.3333ZM20 3.41666L29.1667 18.7917H10.8333L20 3.41666ZM29.1667 22.2083C33.3333 22.2083 36.6667 25.625 36.6667 29.8958C36.6667 34.1667 33.3333 37.5833 29.1667 37.5833C25 37.5833 21.6667 34.1667 21.6667 29.8958C21.6667 25.625 25 22.2083 29.1667 22.2083Z" fill="currentColor"/>
                            </g>
                ...
                <div class="asowp-w-full">
                    <button @click="()=>router.push('/configs/'+config.replace(/ /,'-')+'/'+configID+'/materials/'+material.replace(/ /,'-')+'/'+materialId+'/simple/others-components')" :class="`asowp-flex asowp-w-full asowp-items-center asowp-justify-start asowp-h-fit asowp-p-2 asowp-space-x-2 asowp-text-black ${route.name == 'Simple-OthersComponents' || route.name == 'Simple-OthersComponents-Options' ? 'asowp-text-[#000] asowp-bg-[#e8e8e8] asowp-border-none asowp-rounded-[7px]' : 'asowp-border-none asowp-bg-transparent'} hover:asowp-text-[#000] asowp-cursor-pointer`">
