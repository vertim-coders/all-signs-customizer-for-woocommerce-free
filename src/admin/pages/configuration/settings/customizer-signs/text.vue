            ...
            <div class="aso-bg-[#F8F9FB] aso-px-8 aso-py-8 aso-space-y-6 aso-translate-y-8">
                ...
                <div class="aso-flex aso-justify-between aso-space-x-6" v-if="text.enableFontSize.active">
                    <div class="aso-flex aso-flex-col aso-w-2/5 aso-space-y-2">
                        ...
                        <input type="number" v-model="text.enableFontSize.minimumFontSize" @blur="()=>{ if(isNaN(text.enableFontSize.minimumFontSize)) {text.enableFontSize.minimumFontSize=12}}" class="aso-w-full"/>
                    </div>
                    <div class="aso-flex aso-flex-col aso-w-2/5 aso-space-y-2">
                        <label class="aso-text-[12px]">Maximum font size</label>
                        <input type="number" v-model="text.enableFontSize.maximumFontSize" @blur="()=>{ if(isNaN(text.enableFontSize.maximumFontSize)) {text.enableFontSize.maximumFontSize=30}}" class="aso-w-full"/>
                    </div>
                    <div class="aso-flex aso-flex-col aso-w-2/5 aso-space-y-2">
                        <label class="aso-text-[12px]">Default size</label>
                        <input type="number" v-model="text.enableFontSize.defaultFontSize" @blur="()=>{ if(isNaN(text.enableFontSize.defaultFontSize)) {text.enableFontSize.defaultFontSize=16}}" class="aso-w-full"/>
                    </div>
                </div>
