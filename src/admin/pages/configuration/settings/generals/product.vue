    ...
    <div>
        <div class="ascwo-grid ascwo-grid-cols-3 ascwo-gap-x-3 ascwo-gap-y-7 ascwo-bg-[#F8F9FB] ascwo-p-8 ascwo-pb-12 ascwo-translate-y-9">
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Enable design from scratch", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("No", "all-signs-customizer-for-woocommerce") }}</p>
                            ...
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("Yes", "all-signs-customizer-for-woocommerce") }}</p>
                        </div>
                    </div>                        
                </div>
                <div class="ascwo-bg-transparent ascwo-text-[11px] ascwo-text-[#444444] ascwo-border-solid ascwo-border-[1px] ascwo-border-t-0 ascwo-border-[#E0E0E0] ascwo-rounded ascwo-rounded-t-none ascwo-p-3">
                    {{ __("Would you like to allow your clients to design the product from scratch? Or do you prefer allowing the customization only for templates assigned to the custom product ?", "all-signs-customizer-for-woocommerce") }}
                </div>
            </div>
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Redirect to cart page after adding a custom design to the cart", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <span class="ascwo-text-[#444444] ascwo-text-[11px]">{{ __("No", "all-signs-customizer-for-woocommerce") }}</span>
                            ...
                            <span class="ascwo-text-[#444444] ascwo-text-[11px]">{{ __("Yes", "all-signs-customizer-for-woocommerce") }}</span>
                        </div>
                    </div>                        
                </div>
               
                <div class="ascwo-bg-transparent ascwo-text-[11px] ascwo-text-[#444444] ascwo-border-solid ascwo-border-[1px] ascwo-border-t-0 ascwo-border-[#E0E0E0] ascwo-rounded ascwo-rounded-t-none ascwo-p-3">
                    {{ __("This options allow you to define what to do after adding a design to the cart", "all-signs-customizer-for-woocommerce") }}
                </div>
            </div>
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Redirect to checkout page after adding a custom design to the cart", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <span class="ascwo-text-[#444444] ascwo-text-[11px]">{{ __("No", "all-signs-customizer-for-woocommerce") }}</span>
            ...
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Display or no recap on checkout page", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("No", "all-signs-customizer-for-woocommerce") }}</p>
            ...
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Hide add to cart button for custom on product detail page", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("No", "all-signs-customizer-for-woocommerce") }}</p>
                ...
                <div class="ascwo-bg-transparent ascwo-text-[11px] ascwo-text-[#444444] ascwo-border-solid ascwo-border-[1px] ascwo-border-t-0 ascwo-border-[#E0E0E0] ascwo-rounded ascwo-rounded-t-none ascwo-p-3">
                    {{ __("This options allow you to define whether or not you want hide the add to cart button for custom products on the products page.", "all-signs-customizer-for-woocommerce") }}
                </div>
            </div>
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("Hide design buttons on shop page", "all-signs-customizer-for-woocommerce") }} 
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("No", "all-signs-customizer-for-woocommerce") }}</p>
                ...
                <div class="ascwo-bg-transparent ascwo-text-[11px] ascwo-text-[#444444] ascwo-border-solid ascwo-border-[1px] ascwo-border-t-0 ascwo-border-[#E0E0E0] ascwo-rounded ascwo-rounded-t-none ascwo-p-3">
                    {{ __("This option displays/hides the customization button on the store page.", "all-signs-customizer-for-woocommerce") }}
                </div>
            </div>
            <div class="">
                <div class="ascwo-flex ascwo-bg-transparent ascwo-border-solid ascwo-border-[1px] ascwo-border-[#E0E0E0] ascwo-rounded-t ascwo-p-3 ascwo-py-4">
                    <div class="ascwo-font-bold ascwo-text-[14px] ascwo-w-2/4">
                        {{ __("hide add to cart buttons for custom product on shop", "all-signs-customizer-for-woocommerce") }}
                    </div>
                    <div class="ascwo-flex ascwo-space-x-2 ascwo-justify-end ascwo-w-2/4">
                        <div class="ascwo-flex ascwo-justify-center ascwo-items-center ascwo-space-x-4">
                            <p class="ascwo-text-md ascwo-font-medium ascwo-text-black">{{ __("No", "all-signs-customizer-for-woocommerce") }}</p>
                ...
                <div class="ascwo-bg-transparent ascwo-text-[11px] ascwo-text-[#444444] ascwo-border-solid ascwo-border-[1px] ascwo-border-t-0 ascwo-border-[#E0E0E0] ascwo-rounded ascwo-rounded-t-none ascwo-p-3">
                    {{ __("This option hides the add-to-cart buttons on customizable products on the store page.", "all-signs-customizer-for-woocommerce") }}
                </div>
            </div>
        </div>
    </div>
...
onMounted(() => {
    if(props.data){
        product.value = {...product.value,...props.data}
    }
});
