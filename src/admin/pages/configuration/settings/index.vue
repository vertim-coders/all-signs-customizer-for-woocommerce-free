<template>
    <div class="asowp-sticky asowp-top-[80px] asowp-z-[999] asowp-shadow-md asowp-h-[50px] asowp-translate-y-2">
        <div class="asowp-bg-white asowp-justify-center asowp-items-center asowp-flex asowp-h-full">
            <div class="">
                <button @click="router.push('/configs/'+config+'/'+configID+'/settings/generals')" :class="`asowp-flex asowp-w-fit asowp-h-fit asowp-p-3.5 asowp-bg-transparent asowp-space-x-2 asowp-px-6 asowp-text-black ${route.name == 'config-settings-generals' ? 'asowp-border-b-[2px] asowp-border-r-0 asowp-border-l-0 asowp-border-t-0 asowp-border-solid asowp-border-b-[#016464] asowp-text-[#016464] asowp-bg-[#F9F9F9]' : 'asowp-border-none'} hover:asowp-border-b-[2px] hover:asowp-border-r-0 hover:asowp-border-l-0 hover:asowp-border-t-0 hover:asowp-border-solid hover:asowp-border-b-[#016464] hover:asowp-bg-[#F9F9F9] hover:asowp-text-[#016464] asowp-cursor-pointer`">
            ...
            <div class="">
                <button @click="router.push('/configs/'+config+'/'+configID+'/settings/customizer-options')" :class="`asowp-flex asowp-w-fit asowp-h-fit asowp-p-3.5 asowp-bg-transparent asowp-space-x-2 asowp-px-6 asowp-text-black ${route.name == 'config-settings-customizer-options' ? 'asowp-border-b-[2px] asowp-border-r-0 asowp-border-l-0 asowp-border-t-0 asowp-border-solid asowp-border-b-[#016464] asowp-text-[#016464] asowp-bg-[#F9F9F9]' : 'asowp-border-none'} hover:asowp-border-b-[2px] hover:asowp-border-r-0 hover:asowp-border-l-0 hover:asowp-border-t-0 hover:asowp-border-solid hover:asowp-border-b-[#016464] hover:asowp-bg-[#F9F9F9] hover:asowp-text-[#016464] asowp-cursor-pointer`">
            ...
            <div class="">
                <button @click="goToLanguageImage" :class="`asowp-flex asowp-w-fit asowp-h-fit asowp-p-3.5 asowp-bg-transparent asowp-space-x-2 asowp-px-6 asowp-text-black ${route.name == 'config-settings-languages-images' ? 'asowp-border-b-[2px] asowp-border-r-0 asowp-border-l-0 asowp-border-t-0 asowp-border-solid asowp-border-b-[#016464] asowp-text-[#016464] asowp-bg-[#F9F9F9]' : 'asowp-border-none'} hover:asowp-border-b-[2px] hover:asowp-border-r-0 hover:asowp-border-l-0 hover:asowp-border-t-0 hover:asowp-border-solid hover:asowp-border-b-[#016464] hover:asowp-bg-[#F9F9F9] hover:asowp-text-[#016464] asowp-cursor-pointer`">
