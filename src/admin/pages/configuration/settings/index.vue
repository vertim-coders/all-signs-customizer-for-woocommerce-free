<template>
    <div class="aso-sticky aso-top-[80px] aso-z-[999] aso-shadow-md aso-h-[50px] aso-translate-y-2">
...
const goToLanguageImage = (c)=>{
    router.push('/configs/'+config.replace(/-/,' ')+'/'+configID+'/settings/language-images')
    .then(() => {
