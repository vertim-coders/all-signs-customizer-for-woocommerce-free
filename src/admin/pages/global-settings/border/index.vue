    ...
    <div class="asowp-h-[100vh]">
        <div class="asowp-space-y-1 asowp-translate-y-6" v-if="!isNewBorder">
            <div class="asowp-bg-[#fff] asowp-flex asowp-flex-col asowp-space-y-3 asowp-px-3 asowp-py-8 asowp-border-solid asowp-border-2 asowp-border-[#D1D1D1] asowp-rounded-[10px]">
                <div class="asowp-bg-[#F8F9FB] asowp-text-[14px] asowp-font-bold asowp-px-4 asowp-py-4">
                    {{ __('List of Borders', 'all-signs-options-pro') }}
                </div>   
                        ...
                        <tbody class="asowp-bg-white">
                            ...
                            <tr  v-for="border, key in borders" :key=key class="asowp-border-t-0 asowp-border-l-0 asowp-border-r-0 asowp-border-b-2 asowp-border-solid asowp-border-[#f0f0f1]">
                                ...
                                <td class="asowp-px-6 asowp-py-2 asowp-text-center asowp-text-[11px]">
                                    <img :src="border.icon" class="asowp-w-6 asowp-h-6" v-if="border.icon != ''"/>

                                </td>
                                <td class="asowp-px-6 asowp-py-2 asowp-flex asowp-justify-center asowp-space-x-2">
                                    <button class="asowp-bg-transparent asowp-border-none asowp-text-[#2DD05B] asowp-cursor-pointer" @click="selectBorder(key,border)">
        ...
        <div class="asowp-space-y-2 asowp-translate-y-6 asowp-bg-[#fff] asowp-flex asowp-flex-col asowp-space-y-3 asowp-px-3 asowp-py-8 asowp-border-solid asowp-border-2 asowp-border-[#D1D1D1] asowp-rounded-[10px]" v-if="isNewBorder">
            <div class="asowp-text-[16px] asowp-font-bold">
                {{isEdit ? __('Edit Border', 'all-signs-options-pro') : __('Add new border', 'all-signs-options-pro')}}
            </div>
            <hr class="Polaris-Divider asowp-w-full" style="border: 1px solid #ebebeb;">
            <div class="asowp-px-1 asowp-py-1">
                <div class="asowp-flex asowp-space-x-2 asowp-justify-between">
                    <div class="asowp-flex asowp-flex-col asowp-w-[50%] asowp-space-y-3">
                        <label class="asowp-text-[12px] asowp-text-[#444444]">{{ __('Label', 'all-signs-options-pro') }}</label>
                        <input type="text" v-model="border.name" class="asowp-w-full asowp-h-[35px]" style="border-radius: 10px !important;"/>
                    </div>
                    <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[12px]">
                        <label class="asowp-text-[12px] asowp-text-[#444444]">{{ __('Upload icon', 'all-signs-options-pro') }}</label>
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-w-full">
                            <div class="asowp-flex asowp-space-x-2 asowp-justify-between asowp-border asowp-border-solid asowp-border-[#000] asowp-rounded-[5px] asowp-p-1">
                                <button @click="selectBorderIcon" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-2 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">{{ __('Upload Icon', 'all-signs-options-pro') }}</button>
            ...
            <div class="asowp-flex asowp-font-bold asowp-space-x-4 asowp-px-4 asowp-py-4 asowp-justify-end asowp-items-end">
                ...
                <div class="asowp-bg-[#016464] asowp-rounded" v-if="!isEdit">
                    <button @click="updateBorder" class="asowp-flex asowp-bg-transparent asowp-w-fit asowp-space-x-2 asowp-h-fit asowp-text-white  asowp-px-12 asowp-p-2.5 asowp-border-none asowp-opacity-90 hover:asowp-border-none hover:asowp-text-white hover:asowp-opacity-100 asowp-cursor-pointer">
...
const selectBorder = (id,bd) =>{
    borderId.value = id
    border.value = bd
    addNewFixingMethod();
}
const addNewFixingMethod = () => {
    isNewBorder.value = !isNewBorder.value;
}
...
const selectBorderIcon = async(e) => { 
    e.preventDefault();
    var uploader = wp.media(
        {
            title: __("Select Border icon", "all-signs-options-pro"), // Traduction ici aussi
            button: {
                text: __("Select Icon", "all-signs-options-pro") // Traduction ici aussi
            },
            multiple: false
        }
    )
