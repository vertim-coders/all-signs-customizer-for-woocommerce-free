                        ...
                        <tbody class="aso-bg-white">
                            ...
                            <tr  v-for="border, key in borders" :key=key class="aso-border-t-0 aso-border-l-0 aso-border-r-0 aso-border-b-2 aso-border-solid aso-border-[#f0f0f1]">
                                ...
                                <td class="aso-px-6 aso-py-2 aso-text-center aso-text-[11px]">
                                    <img :src="border.icon" class="aso-w-6 aso-h-6" v-if="border.icon != ''"/>

                                </td>
                                <td class="aso-px-6 aso-py-2 aso-flex aso-justify-center aso-space-x-2">
                                    <button class="aso-bg-transparent aso-border-none aso-text-[#2DD05B] aso-cursor-pointer" @click="selectBorder(key,border)">
        ...
        <div class="aso-space-y-2" v-if="isNewBorder">
            ...
            <div class="aso-bg-[#F8F9FB] aso-px-8 aso-py-4">
                ...
                <div class="aso-flex aso-justify-between">
                    <div class="aso-flex aso-flex-col aso-w-2/5 aso-space-y-3">
                        ...
                        <input type="text" v-model="border.name" class="aso-w-full"/>
                    </div>
                    <div class="aso-w-2/5 aso-space-y-2 aso-flex aso-flex-col aso-text-[12px]">
                        ...
                        <div class="aso-flex aso-flex-col aso-space-y-2 aso-w-full aso-pt-2 aso-w-1/2">
                            <div class="aso-flex aso-space-x-2">
                                <button @click="selectBorderIcon" class="aso-bg-[#016464] aso-border-none aso-w-fit aso-h-fit aso-p-4 aso-rounded aso-px-4 aso-text-white aso-opacity-90 hover:aso-opacity-100 aso-text-[10px] aso-cursor-pointer">upload Icon</button>
                                <div :class="`aso-relative aso-w-[82px] aso-h-[49px] aso-rounded-md aso-overflow-hidden`">
                                    <img v-if="border.icon != ''" :src="border.icon" alt="" class="aso-absolute aso-w-full aso-h-full">
                                    <button v-if="border.icon != ''" @click="()=>{border.icon = ''}" :class="`aso-bg-[#016464] aso-absolute aso-bottom-0 aso-right-0 aso-text-white aso-p-1 aso-rounded-tl-lg aso-border-none`">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                ...
                <div class="aso-bg-[#016464] aso-rounded" v-if="!isEdit">
                    <button @click="updateBorder" class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-text-white  aso-px-12 aso-p-2.5 aso-border-none aso-opacity-90 hover:aso-border-none hover:aso-text-white hover:aso-opacity-100 aso-cursor-pointer">
