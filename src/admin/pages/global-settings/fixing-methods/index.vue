<template>
    <div>
        <div class="asowp-space-y-4 asowp-py-10" v-if="!isNewFixingMethod">
            <div>
                <div class="asowp-sticky asowp-z-[998] asowp-top-[105px] asowp-bg-[#F8F9FB] asowp-text-[14px] asowp-font-bold asowp-px-4 asowp-py-4 asowp-border-solid asowp-border-[1px] asowp-border-[#DDDDDD]">
        ...
        <div class="asowp-space-y-4" v-if="isNewFixingMethod">
            ...
            <div class="asowp-bg-[#F8F9FB] asowp-px-8 asowp-py-4 asowp-space-y-6 asowp-pb-14">
                ...
                <div class="asowp-flex asowp-justify-between">
                    <div class="asowp-flex asowp-flex-col asowp-w-2/5 asowp-space-y-3">
                        ...
                        <input type="text" v-model="fixingMethod.name" class="asowp-w-full"/>
                    </div>
                    <div class="asowp-w-2/5 asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[12px]">
                        ...
                        <input type="text" v-model="fixingMethod.description" class="asowp-w-full"/>
                    </div>
                </div>
                <div class="asowp-flex asowp-justify-between">
                    <div class="asowp-flex asowp-flex-col asowp-w-2/5 asowp-space-y-3">
                        ...
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-pt-2 asowp-w-1/2">
                            <div class="asowp-flex asowp-space-x-2">
                                <button @click="selectFixingMethodIcon" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-4 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">upload Icon</button>
