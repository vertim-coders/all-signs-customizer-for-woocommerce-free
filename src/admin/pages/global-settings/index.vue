    ...
    <div class="aso-h-[85vh] aso-overflow-y-auto aso-overflow-x-auto aso-relative">
        <div class="aso-sticky aso-z-[9999] aso-w-full aso-top-0 aso-shadow-md">
            ...
            <div class="aso-bg-white aso-space-x-6 aso-justify-center aso-items-center aso-flex">
                <div class="">
                    <button @click="$router.push('/global-settings/license')" :class="`aso-flex aso-w-fit aso-h-fit aso-p-4 aso-bg-transparent aso-space-x-2 aso-text-black ${route.name == 'global-settings-license' ? 'aso-border-b-[3px] aso-border-r-0 aso-border-l-0 aso-border-t-0 aso-border-solid aso-border-b-[#016464] aso-text-[#016464] aso-bg-[#F9F9F9]' : 'aso-border-none'} hover:aso-border-b-[2px] hover:aso-border-r-0 hover:aso-border-l-0 hover:aso-border-t-0 hover:aso-border-solid hover:aso-border-b-[#016464] hover:aso-bg-[#F9F9F9] hover:aso-text-[#016464] aso-cursor-pointer`">
