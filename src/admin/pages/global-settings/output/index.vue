...
<<<<<<< HEAD
        <div class="asowp-space-y-4 asowp-py-6" v-if="!isFetching">
            <div>
...
=======
        <div class="asowp-space-y-4 asowp-py-10" v-if="!isFetching">
            <div>
                <div class="asowp-bg-[#F8F9FB] asowp-flex asowp-flex-col asowp-px-8 asowp-py-8 asowp-border-solid asowp-border-[1px] asowp-border-[#DDDDDD]">
                    <div class="asowp-flex asowp-space-x-2">
                    ...
                    <div class="asowp-font-semibold asowp-text-[14px] asowp-py-6">
                        Use the command id as the name of the zip file that will contain the uploaded files during customization
                    </div>
