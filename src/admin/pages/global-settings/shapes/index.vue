<template>
    <div>
        ...
        <div class="" v-if="isNewShapes">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-justify-between aso-px-8 aso-py-8">
                <div class="aso-flex aso-flex-col aso-w-2/5 aso-space-y-3">
                    <label class="aso-text-[12px] aso-text-[#444444]">Title</label>
                    <input type="text" v-model="shape.name" class="aso-w-full"/>
                </div>
                <div class="aso-w-2/5 aso-space-y-2 aso-flex aso-flex-col aso-text-[12px]">
                    ...
                    <div class="aso-flex aso-flex-col aso-space-y-2 aso-w-full aso-pt-2 aso-w-1/2">
                        <div class="aso-flex aso-space-x-2">
                            <button @click="selectShapeIcon" class="aso-bg-[#016464] aso-border-none aso-w-fit aso-h-fit aso-p-4 aso-rounded aso-px-4 aso-text-white aso-opacity-90 hover:aso-opacity-100 aso-text-[10px] aso-cursor-pointer">upload Icon</button>
                            <div :class="`aso-relative aso-w-[82px] aso-h-[49px] aso-rounded-md aso-overflow-hidden`">
                                <img v-if="shape.icon != ''" :src="shape.icon" alt="" class="aso-absolute aso-w-full aso-h-full">
                                <button v-if="shape.icon != ''" @click="()=>{shape.icon = ''}" :class="`aso-bg-[#016464] aso-absolute aso-bottom-0 aso-right-0 aso-text-white aso-p-1 aso-rounded-tl-lg aso-border-none`">
            ...
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                ...
                <div class="aso-bg-[#016464] aso-rounded" v-if="!isEdit">
                    <button @click="updateShape" class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-text-white  aso-px-12 aso-p-2.5 aso-border-none aso-opacity-90 hover:aso-border-none hover:aso-text-white hover:aso-opacity-100 aso-cursor-pointer">
