<template>
    <div class="asowp-h-[100vh]">
        ...
        <div class="asowp-space-y-2 asowp-translate-y-1" v-show="!isNew">
            <div class="asowp-bg-[#fff] asowp-translate-y-2 asowp-flex asowp-flex-col asowp-space-y-3 asowp-px-3 asowp-py-8 asowp-border-solid asowp-border-2 asowp-border-[#D1D1D1] asowp-rounded-[10px]">
                <div  class="asowp-flex asowp-justify-end asowp-space-x-2 asowp-w-4/4 asowp-text-[12px] asowp-bg-[#F8F9FB] asowp-px-4 asowp-py-4 asowp-pb-2">
                    <button v-if="!isFetching" class="asowp-flex asowp-w-fit asowp-h-fit asowp-rounded asowp-bg-[#016464] asowp-px-4 asowp-space-x-2 asowp-p-1.5 asowp-border-none asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-cursor-pointer" @click="addClipart">
                        ...
                        <div class="asowp-text-[14px]">
                            {{ __('Add new cliparts', 'all-signs-options-pro') }}
                        </div>
                    </button>
                </div>
        ...
        <div class="asowp-space-y-2 asowp-translate-y-3 asowp-bg-[#fff] asowp-flex asowp-flex-col asowp-space-y-3 asowp-px-3 asowp-py-8 asowp-border-solid asowp-border-2 asowp-border-[#D1D1D1] asowp-rounded-[10px]" v-if="isNew">
            <div class="asowp-shadow-t-xl asowp-justify-between asowp-items-center asowp-flex asowp-space-x-2">
                <div class="asowp-text-[16px] asowp-font-bold asowp-px-2 ">
                    {{isEdit ? __('Edit clipart', 'all-signs-options-pro') : __('Add cliparts', 'all-signs-options-pro')}}
                </div>
                <div class="asowp-flex asowp-items-center asowp-space-x-4 asowp-font-semibold asowp-px-2 asowp-py-1">
                    <label>{{ __('Use Cliparts API', 'all-signs-options-pro') }}</label>
                    ...
                    <button v-if="!useApi && !isEdit" :disabled="isLoading" @click="selectClipartImages" class="asowp-flex asowp-jsutify-center asowp-items-center asowp-bg-[#016464] asowp-rounded asowp-w-fit asowp-space-x-2 asowp-h-fit asowp-text-white asowp-px-2 asowp-p-2.5 asowp-rounded asowp-border-none hover:asowp-opacity-100 hover:asowp-border-none hover:asowp-text-white hover:asowp-bg-[#016464] asowp-cursor-pointer">
                            ...
                            <span class="asowp-font-semibold asowp-text-[16px]">{{ __('Add Images', 'all-signs-options-pro') }}</span>
                    </button>
                </div>
                
            </div>
            <hr class="Polaris-Divider asowp-w-full" style="border: 1px solid #ebebeb;">
            <div class="asowp-shadow-sm asowp-flex asowp-justify-between asowp-space-x-10 asowp-font-semibold asowp-px-4 asowp-py-4"  v-if="useApi && !isEdit">
                
                
                <div class="asowp-flex  asowp-space-x-10 asowp-font-semibold asowp-px-4 asowp-py-4">
                    <label>{{ __('Select All', 'all-signs-options-pro') }}</label>
                    <div class="asowp-flex asowp-items-center asowp-translate-x-2 asowp-translate-y-0.5">
            ...
            <div class="asowp-px-4 asowp-py-4 asowp-space-y-8" v-if="!useApi && isEdit">
                <div class="asowp-flex asowp-space-x-2 asowp-justify-between">
                    <div class="asowp-w-[33.33%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[14px]">
                        <label for="" class="asowp-font-normal">{{ __('Label', 'all-signs-options-pro') }}</label>
                        <input type="text" v-model="clipart.title"  class="asowp-rounded asowp-w-full asowp-h-[35px]" style="border-radius: 10px !important;">
                    </div>
                    <div class="asowp-w-[33.33%] asowp-flex asowp-flex-col asowp-text-[12px]">
                        ...
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-pt-2">
                            <div class="asowp-flex asowp-border asowp-border-solid asowp-border-[#000] asowp-rounded-[5px] asowp-p-1">
                                <button @click="selectClipartImage" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-2 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">{{ __('upload image', 'all-signs-options-pro') }}</button>
            ...
            <div class="asowp-relative asowp-px-4 asowp-py-4 asowp-space-y-2" v-if="!useApi && !isEdit">
                <div class="asowp-flex asowp-justify-between asowp-items-center asowp-relative asowp-space-x-4" :key="key" v-for="(clipart,key) in cliparts">
                    <div class="asowp-w-[33.33%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[14px]">
                        <label for="" class="asowp-font-normal">{{ __('Label', 'all-signs-options-pro') }}</label>
                        <input type="text" v-model="cliparts[key].title"  class="asowp-rounded asowp-w-full asowp-h-[35px]" style="border-radius: 10px !important;">
                    </div>
                    <div class="asowp-w-[33.33%] asowp-flex asowp-flex-col asowp-text-[12px]">
                        <label for="" class="asowp-font-normal">{{ __('Upload icon', 'all-signs-options-pro') }}</label>
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-pt-2">
                            <div class="asowp-flex asowp-border asowp-border-solid asowp-border-[#000] asowp-rounded-[5px] asowp-p-1">
                                <button @click="(e)=>selectClipartImage(e,key)" class="asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-2 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">{{ __('upload image', 'all-signs-options-pro') }}</button>
                                <div :class="`asowp-relative asowp-w-[82px] asowp-h-[30px] asowp-rounded-md asowp-overflow-hidden`">
                ...
                <div class="asowp-pt-4">
                    <button :disabled="isLoading" @click="handleAddClipart" class="asowp-flex asowp-jsutify-center asowp-items-center asowp-bg-[#016464] asowp-rounded asowp-w-fit asowp-space-x-2 asowp-h-fit asowp-text-white asowp-px-2 asowp-p-2.5 asowp-rounded asowp-border-none hover:asowp-opacity-100 hover:asowp-border-none hover:asowp-text-white hover:asowp-bg-[#016464] asowp-cursor-pointer">
                        ...
                        <span class="asowp-font-semibold asowp-text-[16px]">{{ __('Add cliparts', 'all-signs-options-pro') }}</span>
                    </button>
                </div>
            </div>
                ...
                <div class="asowp-flex asowp-justify-start asowp-items-center">
                    <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[14px]">
                        <select id="" v-model="selectedCategory" class="asowp-h-[40px]">
                            <option value="animals">{{ __('Animals', 'all-signs-options-pro') }}</option>
                            <option value="arrows">{{ __('Arrows', 'all-signs-options-pro') }}</option>
                            <option value="decorationFestivities">{{ __('Decoration & Festivities', 'all-signs-options-pro') }}</option>
                            <option value="emojisFlags">{{ __('Emojis & Flags', 'all-signs-options-pro') }}</option>
                            <option value="foodsDrinks">{{ __('Foods & Drinks', 'all-signs-options-pro') }}</option>
                            <option value="healthcare">{{ __('Healthcare', 'all-signs-options-pro') }}</option>
                            <option value="householdTools">{{ __('Household Tools', 'all-signs-options-pro') }}</option>
                            <option value="mostPopular">{{ __('Most Popular', 'all-signs-options-pro') }}</option>
                            <option value="peoples">{{ __('Peoples', 'all-signs-options-pro') }}</option>
                            <option value="plantsNature">{{ __('Plants & Nature', 'all-signs-options-pro') }}</option>
                            <option value="prohibitionsWarnings">{{ __('Prohibitions & Warnings', 'all-signs-options-pro') }}</option>
                            <option value="shapes">{{ __('Shapes', 'all-signs-options-pro') }}</option>
                            <option value="sportActivities">{{ __('Sport & Activities', 'all-signs-options-pro') }}</option>
                            <option value="symbolsMarkings">{{ __('Symbols & Markings', 'all-signs-options-pro') }}</option>
                            <option value="vehiclesTraffic">{{ __('Vehicles & Traffic', 'all-signs-options-pro') }}</option>
                            <option value="others">{{ __('Others', 'all-signs-options-pro') }}</option>
                        </select>
                    </div>
                    <div class="asowp-bg-[#016464] asowp-rounded">
                        <button @click="getApiCliparts" class="asowp-flex asowp-bg-transparent asowp-w-fit asowp-space-x-2 asowp-h-fit asowp-text-white asowp-px-8 asowp-p-2.5 asowp-rounded asowp-border-none asowp-opacity-90 hover:asowp-opacity-100 hover:asowp-border-none hover:asowp-text-white hover:asowp-bg-[#016464] asowp-cursor-pointer">
                            ...
                            <span class="asowp-font-semibold asowp-text-[16px]">{{ __('Get', 'all-signs-options-pro') }}</span>
                        </button>
                    </div>
                </div>
                <div v-if="apiCliparts.length>0">
                    <h2 class="asowp-font-bold asowp-font-[15px]">{{ __('Images found', 'all-signs-options-pro') }}</h2>
                </div>
                <div>
                ...
                <div class="asowp-flex asowp-justify-end asowp-items-center asowp-shadow-xl asowp-sticky asowp-bottom-0" v-if="Object.keys(clipartsSelected).length > 0">
                    <div class="asowp-bg-[#016464] asowp-rounded">
                        <button @click="displayAllChoice" class="asowp-flex asowp-bg-transparent asowp-w-fit asowp-space-x-2 asowp-h-fit asowp-text-white asowp-px-8 asowp-p-2.5 asowp-rounded asowp-border-none asowp-opacity-90 hover:asowp-opacity-100 hover:asowp-border-none hover:asowp-text-white hover:asowp-bg-[#016464] asowp-cursor-pointer">
                            <span class="asowp-font-semibold asowp-text-[16px]">{{ __('I made my choices', 'all-signs-options-pro') }}</span>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="asowp-grid asowp-grid-cols-3 asowp-py-4 asowp-px-4 asowp-mt-28">
                    <div class="asowp-flex asowp-justify-between asowp-items-center asowp-relative asowp-space-x-2" :key="key" v-for="(clipart,key) in cliparts">
                        <div class="asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[12px]">
                            <label for="" class="asowp-font-normal">{{ __('Image', 'all-signs-options-pro') }}</label>
            ...
            <div class="asowp-relative asowp-p-4 asowp-w-full asowp-max-w-md asowp-max-h-full">
                <div class="asowp-relative asowp-bg-white asowp-rounded-lg asowp-shadow dark:bg-gray-700">
                    ...
                    <div class="asowp-p-4 md:p-5 asowp-text-center">
                        ...
                        <h3 class="asowp-mb-5 asowp-text-lg asowp-font-normal asowp-text-gray-500 dark:text-gray-400">{{ __('Are you sure you want to delete this cliparts ?', 'all-signs-options-pro') }}</h3>
...
const selectClipartImages = async(e) => { 
    ...
    var uploader = wp.media(
        {
            title: __("Select many images","all-signs-options-pro"),
            button: {
                text: __("Select many images","all-signs-options-pro")
            },
            multiple: true
        }
    )
