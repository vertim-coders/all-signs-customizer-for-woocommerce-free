<template>
  <div class="ascwo-space-y-3">
    <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4 ascwo-flex ascwo-items-center ascwo-justify-between ascwo-gap-4">
      <div class="ascwo-flex ascwo-items-center ascwo-gap-3">
        <button type="button" @click="router.push({ name: 'managecliparts' })" class="ascwo-bg-transparent ascwo-border-none ascwo-p-0 ascwo-text-[14px] ascwo-leading-5 ascwo-font-[900] ascwo-text-[#303030] ascwo-cursor-pointer hover:ascwo-text-[#303030]">
          {{ __('Clipart groups', 'all-signs-customizer-for-woocommerce') }}
        </button>
      ...
      <button type="button" @click="router.push({ name: 'managecliparts' })" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#202223] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">
        {{ __('Back to clipart groups', 'all-signs-customizer-for-woocommerce') }}
      </button>
    </section>
    ...
    <template v-if="!isNew">
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4 ascwo-flex ascwo-items-center ascwo-justify-between ascwo-gap-4">
        <div>
          ...
          <p class="ascwo-m-0 ascwo-mt-1 ascwo-text-[13px] ascwo-leading-4 ascwo-text-[#616161]">{{ __('Manage the cliparts inside this group.', 'all-signs-customizer-for-woocommerce') }}</p>
        </div>
        <button type="button" @click="goToCreateClipart" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white ascwo-inline-flex ascwo-items-center ascwo-gap-2">
          ...
          {{ __('Add new clipart', 'all-signs-customizer-for-woocommerce') }}
        </button>
      </section>
      ...
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
        <div v-if="isFetching" class="ascwo-min-h-[200px] ascwo-flex ascwo-items-center ascwo-justify-center ascwo-text-[13px] ascwo-text-[#616161]">
          {{ __('Loading...', 'all-signs-customizer-for-woocommerce') }}
        </div>
        <div v-else-if="clipartGroups.length === 0" class="ascwo-min-h-[220px] ascwo-flex ascwo-flex-col ascwo-items-center ascwo-justify-center ascwo-text-center">
          ...
          <h2 class="ascwo-m-0 ascwo-text-[20px] ascwo-leading-6 ascwo-font-[900] ascwo-text-[#303030]">{{ __('No Cliparts found', 'all-signs-customizer-for-woocommerce') }}</h2>
          <p class="ascwo-m-0 ascwo-mt-3 ascwo-text-[13px] ascwo-text-[#616161]">{{ __('Try changing the filters or search term', 'all-signs-customizer-for-woocommerce') }}</p>
        </div>
        <table v-else class="ascwo-cliparts-table ascwo-w-full ascwo-border-collapse ascwo-text-left">
          <thead class="ascwo-bg-[#f6f6f7]">
            <tr>
              ...
              <th class="ascwo-px-3 ascwo-py-2.5 ascwo-text-[12px] ascwo-font-[800] ascwo-text-[#616161]">{{ __('Image', 'all-signs-customizer-for-woocommerce') }}</th>
              <th class="ascwo-px-3 ascwo-py-2.5 ascwo-text-[12px] ascwo-font-[800] ascwo-text-[#616161]">{{ __('Additional Price', 'all-signs-customizer-for-woocommerce') }}</th>
            ...
            <tr v-for="(item, key) in clipartGroups" :key="key" class="ascwo-border-b ascwo-border-solid ascwo-border-[#e5e7eb]">
              ...
              <td class="ascwo-px-3 ascwo-py-3">
                <div class="ascwo-flex ascwo-items-center ascwo-gap-2">
                  <button type="button" @click="goToEditClipart(key)" class="ascwo-h-7 ascwo-px-2.5 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">{{ __('Edit', 'all-signs-customizer-for-woocommerce') }}</button>
                  <button type="button" @click="selectClipart(key, item, true)" class="ascwo-h-7 ascwo-px-2.5 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#8a0f00] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#8a0f00]">{{ __('Delete', 'all-signs-customizer-for-woocommerce') }}</button>
                </div>
              </td>
            </tr>
          </tbody>
    ...
    <template v-else>
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
        <h1 class="ascwo-m-0 ascwo-text-[20px] ascwo-leading-6 ascwo-font-[900] ascwo-text-[#303030]">{{ isEdit ? __('Edit clipart', 'all-signs-customizer-for-woocommerce') : __('Add clipart', 'all-signs-customizer-for-woocommerce') }}</h1>
      </section>
      ...
      <section class="ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-shadow-sm ascwo-px-5 ascwo-py-4">
        ...
        <div v-if="!useApi || isEdit" class="ascwo-space-y-3">
          <div v-for="(row, key) in editableRows" :key="key" class="ascwo-border ascwo-border-solid ascwo-border-[#d1d5db] ascwo-rounded-xl ascwo-p-4">
            <h2 class="ascwo-m-0 ascwo-mb-3 ascwo-text-[14px] ascwo-font-[900] ascwo-text-[#303030]">{{ __('Clipart', 'all-signs-customizer-for-woocommerce') }} {{ key + 1 }}</h2>
            ...
            <button v-if="!isEdit && editableRows.length > 1" type="button" @click="handleDeleteClipartSelected(key)" class="ascwo-mt-4 ascwo-h-7 ascwo-px-2.5 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#8a0f00] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#8a0f00]">{{ __('Remove', 'all-signs-customizer-for-woocommerce') }}</button>
          </div>
        ...
        <div v-else class="ascwo-space-y-4">
          <div class="ascwo-flex ascwo-items-center ascwo-gap-3">
            ...
            <button type="button" @click="getApiCliparts" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white">{{ __('Get', 'all-signs-customizer-for-woocommerce') }}</button>
          </div>
          ...
          <button v-if="Object.keys(clipartsSelected).length" type="button" @click="displayAllChoice" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white">{{ __('I made my choices', 'all-signs-customizer-for-woocommerce') }}</button>
        </div>

        <div class="ascwo-mt-6 ascwo-flex ascwo-justify-end ascwo-gap-3">
          <button type="button" @click="back" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[#202223] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7] hover:ascwo-text-[#202223]">{{ __('Back', 'all-signs-customizer-for-woocommerce') }}</button>
          <button type="button" @click="isEdit ? updateClipart() : saveClipart()" :disabled="isLoading" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#00796b] ascwo-border ascwo-border-solid ascwo-border-[#005f55] ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#00695f] hover:ascwo-text-white disabled:ascwo-bg-[#d1d1d1] disabled:ascwo-border-[#d1d1d1]">{{ isLoading ? __('Saving...', 'all-signs-customizer-for-woocommerce') : __('Save', 'all-signs-customizer-for-woocommerce') }}</button>
        </div>
      </section>
    </template>
    ...
    <div v-if="openModal" class="ascwo-fixed ascwo-inset-0 ascwo-z-[20000] ascwo-flex ascwo-items-center ascwo-justify-center">
      ...
      <div class="ascwo-relative ascwo-w-[min(460px,95vw)] ascwo-bg-white ascwo-rounded-xl ascwo-shadow-2xl ascwo-p-5">
        <h2 class="ascwo-m-0 ascwo-text-[20px] ascwo-font-[900] ascwo-text-[#303030]">{{ __('Delete clipart?', 'all-signs-customizer-for-woocommerce') }}</h2>
        <p class="ascwo-mt-3 ascwo-text-[13px] ascwo-text-[#616161]">{{ __('This action cannot be undone.', 'all-signs-customizer-for-woocommerce') }}</p>
        <div class="ascwo-mt-6 ascwo-flex ascwo-justify-end ascwo-gap-3">
          <button type="button" @click="closeModal" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-white ascwo-border ascwo-border-solid ascwo-border-[#c9cccf] ascwo-text-[13px] ascwo-font-[700] ascwo-cursor-pointer hover:ascwo-bg-[#f6f6f7]">{{ __('Cancel', 'all-signs-customizer-for-woocommerce') }}</button>
          <button type="button" @click="deleteClipart" :disabled="isLoading" class="ascwo-h-8 ascwo-px-3 ascwo-rounded-lg ascwo-bg-[#8a0f00] ascwo-border-none ascwo-text-white ascwo-text-[13px] ascwo-font-[800] ascwo-cursor-pointer hover:ascwo-bg-[#731000] hover:ascwo-text-white">{{ __('Delete', 'all-signs-customizer-for-woocommerce') }}</button>
        </div>
      </div>
    </div>
  </div>
...
const apiCategories = [
  { value: 'animals', label: __('Animals', 'all-signs-customizer-for-woocommerce') },
  { value: 'arrows', label: __('Arrows', 'all-signs-customizer-for-woocommerce') },
  { value: 'decorationFestivities', label: __('Decoration & Festivities', 'all-signs-customizer-for-woocommerce') },
  { value: 'emojisFlags', label: __('Emojis & Flags', 'all-signs-customizer-for-woocommerce') },
  { value: 'foodsDrinks', label: __('Foods & Drinks', 'all-signs-customizer-for-woocommerce') },
  { value: 'healthcare', label: __('Healthcare', 'all-signs-customizer-for-woocommerce') },
  { value: 'householdTools', label: __('Household Tools', 'all-signs-customizer-for-woocommerce') },
  { value: 'mostPopular', label: __('Most Popular', 'all-signs-customizer-for-woocommerce') },
  { value: 'peoples', label: __('Peoples', 'all-signs-customizer-for-woocommerce') },
  { value: 'plantsNature', label: __('Plants & Nature', 'all-signs-customizer-for-woocommerce') },
  { value: 'prohibitionsWarnings', label: __('Prohibitions & Warnings', 'all-signs-customizer-for-woocommerce') },
  { value: 'shapes', label: __('Shapes', 'all-signs-customizer-for-woocommerce') },
  { value: 'sportActivities', label: __('Sport & Activities', 'all-signs-customizer-for-woocommerce') },
  { value: 'symbolsMarkings', label: __('Symbols & Markings', 'all-signs-customizer-for-woocommerce') },
  { value: 'vehiclesTraffic', label: __('Vehicles & Traffic', 'all-signs-customizer-for-woocommerce') },
  { value: 'others', label: __('Others', 'all-signs-customizer-for-woocommerce') },
];
