<template>
    <div class="asowp-space-y-1 asowp-translate-y-1" v-show="!createGroup">
        <div class="asowp-bg-[#fff] asowp-rounded-[10px] asowp-border-[2px] asowp-border-solid asowp-border-[#d9d9d9] asowp-text-[16px] asowp-space-x-1 asowp-px-4 asowp-py-4 asowp-flex">
            <span class="asowp-font-bold">
                {{ __("List of clipart group", "all-signs-options-pro") }}
            </span>
        </div>
        <div class="asowp-translate-y-1 asowp-bg-[#fff] asowp-p-4 asowp-rounded-[10px] asowp-border-[2px] asowp-border-solid asowp-border-[#d9d9d9]">
    ...
    <div class="asowp-space-y-1 asowp-translate-y-1" v-show="createGroup">
        <div class="asowp-bg-[#fff] asowp-p-4 asowp-rounded-[10px] asowp-border-[2px] asowp-border-solid asowp-border-[#d9d9d9]">
            <span class="asowp-text-[16px] asowp-font-bold">
                {{ __("Create new clipart group", "all-signs-options-pro") }}
            </span>
        </div>
        <div class="asowp-px-4 asowp-py-4 asowp-space-y-8 asowp-translate-y-1 asowp-bg-[#fff] asowp-rounded-[10px] asowp-border-[2px] asowp-border-solid asowp-border-[#d9d9d9]">
            <div class="asowp-flex asowp-space-x-4 asowp-justify-between">
                <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[14px]">
                    ...
                    <input type="text" v-model="newGroup.title" :class="`${emptyLabel?'asowp-field-required':''} asowp-rounded asowp-w-full asowp-h-[35px]`"  style="border-radius: 5px !important;">
                </div>
                <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[12px]">
                    ...
                    <input type="text" class="asowp-rounded asowp-w-full asowp-h-[35px]"  style="border-radius: 5px !important;" v-model="newGroup.description">
        ...
        <div class="asowp-relative asowp-p-4 asowp-w-full asowp-max-w-md asowp-max-h-full">
            <div class="asowp-relative asowp-bg-white asowp-rounded-lg asowp-shadow dark:bg-gray-700">
                ...
                <div class="asowp-p-4 md:p-5 asowp-text-center">
                    ...
                    <h3 class="asowp-mb-5 asowp-text-lg asowp-font-normal asowp-text-gray-500 dark:text-gray-400">{{ __("Are you sure you want to delete this cliparts Group ?", "all-signs-options-pro") }}</h3>
