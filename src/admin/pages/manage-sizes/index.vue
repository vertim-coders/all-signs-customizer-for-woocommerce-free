    ...
    <div class="aso-h-[100vh]">
        <div class="aso-space-y-1" v-show="!createSize">
            ...
            <div v-if="!isFetching" class="aso-flex aso-justify-end aso-space-x-2 aso-w-4/4 aso-bg-[#F8F9FB] aso-text-[12px] aso-px-4 aso-py-4 aso-pb-2">
                <button class="aso-flex aso-w-fit aso-h-fit aso-rounded aso-bg-[#016464] aso-px-4 aso-space-x-2 aso-p-1.5 aso-border-none aso-text-white aso-opacity-90 hover:aso-opacity-100 aso-cursor-pointer" @click="() => { createSize = true;}">
            ...
            <div class="aso-relative" id="monTableau">
                <table class="aso-text-center aso-border aso-border-collapse aso-border-0 aso-w-full">
                    ...
                    <tbody class="aso-bg-white">
                        ...
                        <tr  v-if="sizes.length == 0 && !isFetching">
                            <td colspan="3">
                        ...
                        <tr v-if="!isFetching" v-for="(size,key) in sizes" class="aso-border-t-0 aso-border-l-0 aso-border-r-0 aso-border-b-2 aso-border-solid aso-border-[#f0f0f1]">
                            ...
                            <td class="aso-px-6 aso-py-2 aso-flex aso-justify-center">
                                <button @click="()=>selectSize(key,size)" class="aso-bg-transparent aso-border-none aso-text-[#2DD05B] aso-cursor-pointer">
                                ...
                                <button @click="()=>selectSize(key,size,true)" class="aso-bg-transparent aso-border-none aso-text-[#A00000] aso-cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-5 aso-h-5">
        ...
        <div class="aso-space-y-1" v-show="createSize">
            ...
            <div class="aso-bg-[#F8F9FB] aso-px-4 aso-py-4 aso-space-y-8">
                <div class="aso-flex aso-justify-between">
                    <div class="aso-w-2/5 aso-space-y-2 aso-flex aso-flex-col aso-text-[14px]">
                        ...
                        <input type="number" v-model="newSize.width"  class="aso-rounded aso-w-full aso-h-[30px]">
                    </div>
                    <div class="aso-w-2/5 aso-space-y-2 aso-flex aso-flex-col aso-text-[12px]">
                        <label for="" class="aso-font-normal">Height</label>
                        <input type="number"  v-model="newSize.height"  class="aso-rounded aso-w-full aso-h-[30px]">
                    </div>
                </div>
                <div class="aso-flex aso-text-[16px]">
                    ...
                    <div class="aso-flex aso-items-center aso-translate-x-5 aso-translate-y-0.5">
                        <label for="uploadFont" class="aso-relative aso-inline-flex aso-items-center aso-cursor-pointer">
                            <input id="uploadFont" type="checkbox" name="upload-font" class="aso-sr-only aso-peer" v-model="newSize.thickness.active">
                ...
                <div class="aso-w-1/2 aso-space-y-2 aso-flex aso-flex-col aso-text-[12px]" v-if="newSize.thickness.active">
                    <label for="" class="aso-font-normal">Thickness</label>
                    <input type="number" v-model="newSize.thickness.value" class="aso-rounded aso-w-[80%] aso-h-[30px]">
                </div>
            </div>
            <div class="aso-bg-[#F8F9FB] aso-flex aso-font-bold aso-space-x-4 aso-px-4 aso-py-4 aso-justify-end aso-items-end">
                ...
                <div class="aso-bg-[#016464] aso-rounded" v-if="isEdit">
                    <button @click="updateSize" :class="`aso-rounded aso-flex ${!isLoading ? 'aso-bg-amber-400 ' :'aso-bg-amber-500'} aso-w-fit aso-space-x-2 aso-h-fit aso-px-8 aso-text-white aso-p-2 aso-border-none aso-opacity-90 hover:aso-border-none hover:aso-text-white hover:aso-opacity-100 aso-cursor-pointer`">
                ...
                <div class="aso-bg-[#016464] aso-rounded" v-if="!isEdit">
                    <button :disabled="isLoading" @click="saveSize" class="aso-flex aso-bg-transparent aso-w-fit aso-space-x-2 aso-h-fit aso-text-white aso-px-8 aso-p-2.5 aso-rounded aso-border-none aso-opacity-90 hover:aso-opacity-100 hover:aso-border-none hover:aso-text-white hover:aso-bg-[#016464] aso-cursor-pointer">
                        <img src="../../../../assets/icons/ic_loading_gray.svg" class="aso-w-5 aso-w-5" v-if="isLoading" :disabled="isLoading"/>
                        <div class="aso-translate-y-1" v-if="!isLoading">
            ...
            <div class="aso-relative aso-p-4 aso-w-full aso-max-w-md aso-max-h-full">
                <div class="aso-relative aso-bg-white aso-rounded-lg aso-shadow dark:bg-gray-700">
                    ...
                    <div class="aso-p-4 md:p-5 aso-text-center">
                        ...
                        <input v-model="newSize.label" readonly class="aso-rounded aso-w-full aso-h-[35px] aso-text-center aso-p-4 aso-my-2 aso-border-none" />
                        <button @click="deleteSize" data-modal-hide="popup-modal" type="button" :class="`aso-border-solid aso-text-white ${!isLoading ? 'aso-bg-red-600 aso-cursor-pointer' :'aso-bg-red-700 aso-cursor-not-allowed'} hover:bg-red-800 focus:ring-4 focus:outline-none aso-my-2 aso-border-none  focus:ring-red-300 dark:focus:ring-red-800 aso-font-medium aso-rounded-lg aso-text-sm aso-inline-flex aso-items-center aso-px-5 aso-py-2.5 aso-text-center`">
                            <img src="../../../../assets/icons/ic_loading_gray.svg" class="aso-w-5 aso-w-5" v-if="isLoading" :disabled="isLoading"/>
                            Yes, I'm sure
                        </button>
...
const selectSize = (key, sz, isdelete=false) =>{
    sizeId.value = key;
    newSize.value = sz;
    if(!isdelete){
        isEdit.value = true;
...
const saveSize = async () => {
    ...
    const result = await api.addManageSize(newSize.value);
    if(result.success){
        await fetchSizes();
        isLoading.value = false;
        toastMessage(result.message);
        createSize.value = false;
        newSize.value = {
            width:0,
            height:0,
            thickness:{
...
const updateSize = async () => {
    isLoading.value = true;
    const result = await api.updateManageSize(sizeId.value,newSize.value);
    if(result.success){
        await fetchSizes();
        isLoading.value = false;
...
const deleteSize = async () => {
    isLoading.value = true;
    const result = await api.deleteManageSize(sizeId.value,newSize.value);
    if(result.success){
        await fetchSizes();
        isLoading.value = false;
        toastMessage(result.message);
