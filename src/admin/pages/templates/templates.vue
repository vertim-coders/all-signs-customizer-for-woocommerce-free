...
<<<<<<< HEAD
            <div class="asowp-sticky asowp-top-[80px] asowp-z-[999] asowp-rounded-xl asowp-bg-[#fff]  asowp-bg-[#fff] asowp-border asowp-border-solid asowp-border-[#e6e6e6] ">
                <div class="asowp-px-4 asowp-flex">
                    ...
                    <div class="asowp-flex asowp-justify-end asowp-items-center asowp-space-x-2 asowp-w-[50%]">
                        <form class="asowp-flex asowp-items-center asowp-h-[35px]" @submit="handleSearchChange">
                            ...
                            <div class="asowp-relative asowp-w-full">
                                <input type="search" v-model="search" @input="searchInputEmpty" id="asowp-search" class="asowp-h-[33px] asowp-w-[190px] asowp-bg-gray-50 asowp-border asowp-border-gray-300 asowp-text-gray-900 asowp-text-sm asowp-rounded-lg focus:ring-blue-500 focus:border-blue-500 asowp-block asowp-w-full asowp-ps-10 asowp-p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 asowp-m-0" placeholder="" />
                                <button type="submit" class="asowp-absolute asowp-inset-y-0 asowp-left-1 asowp-bg-transparent asowp-flex asowp-items-center ps-0 asowp-cursor-pointer asowp-border-none">
                                    <svg class="asowp-w-3 asowp-h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                        ...
                        <div class="">
                            <button class="asowp-flex asowp-w-fit asowp-rounded-[10px] asowp-bg-[#016464] asowp-px-4 asowp-space-x-2 asowp-p-1.5 asowp-border-none asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-cursor-pointer asowp-h-[30px] asowp-flex asowp-items-center asowp-justify-center" @click="isNewTemplate = true">
            ...
            <div class="asowp-px-6 asowp-py-4 asowp-space-y-3">
                <div class="asowp-flex asowp-space-x-3">
                    <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[14px]">
                        <label for="" :class="`${isEmptyName ? 'asowp-text-red-500 asowp-font-bold' :'asowp-font-normal asowp-text-[.8125rem]'}`">Name</label>
                        <input type="text" v-model="template.name" :class="`${isEmptyName ? 'asowp-field-required asowp-font-bold' :''} asowp-w-full asowp-h-[38px]`" style="border-radius: 10px !important;" @blur="template.name.trim()==''?isEmptyName =true : isEmptyName=false">
                    </div>
                    
                    <div class="asowp-w-[50%] asowp-flex asowp-flex-col asowp-space-y-2" :class="`${isEmptyConfig ? 'asowp-field-required asowp-font-bold' :''}`" >
                        <label class="asowp-text-[.8125rem] asowp-text-[#444444]">Select Configuration</label>
                        <div  v-if="!isEdit">
                            <Multiselect
                                ...
                                label="name"
                                trackBy="name"
                                class="asowp-rounded-[10px] asowp-h-[38px]"
                            />
                        </div>
                ...
                <div class="asowp-flex asowp-space-x-3">
                    <div class="asowp-w-[50%] asowp-flex asowp-flex-col asowp-space-y-2 asowp-text-[12px]">
                        <label for="" class="asowp-font-normal">Upload Preview Image</label>
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-pt-2">
                            <div class="asowp-flex asowp-space-x-2 asowp-p-2 asowp-border asowp-border-solid asowp-border-[#8c8f94] asowp-rounded-[10px]">
                                <button @click="selectTemplatePrevImg" class="asowp-flex asowp-space-x-2 asowp-bg-[#016464] asowp-border-none asowp-w-fit asowp-h-fit asowp-p-2 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">
                                    <div>
...
<<<<<<< HEAD
                    ...
                    <div class="asowp-w-[50%] asowp-flex asowp-flex-col asowp-space-y-2 asowp-text-[12px]">
                        ...
                        <div class="asowp-flex asowp-flex-col asowp-space-y-2 asowp-w-full asowp-pt-2">
                            <div class="asowp-flex asowp-space-x-2 asowp-p-2 asowp-border asowp-border-solid asowp-border-[#8c8f94] asowp-rounded-[10px]">
                                <button @click="selectTemplateRealImg" class="asowp-bg-[#016464] asowp-flex asowp-space-x-2 asowp-border-none asowp-w-fit asowp-h-fit asowp-p-2 asowp-rounded asowp-px-4 asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-text-[10px] asowp-cursor-pointer">
                                    <div>
                                        <svg class="asowp-w-4 asowp-h-4" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">        
                                            <path d="M22.4375 12.2809V18.5309C22.4375 18.9453 22.2729 19.3427 21.9799 19.6357C21.6868 19.9288 21.2894 20.0934 20.875 20.0934H2.125C1.7106 20.0934 1.31317 19.9288 1.02015 19.6357C0.72712 19.3427 0.5625 18.9453 0.5625 18.5309V12.2809C0.5625 11.8665 0.72712 11.4691 1.02015 11.176C1.31317 10.883 1.7106 10.7184 2.125 10.7184H6.8125C7.0197 10.7184 7.21841 10.8007 7.36493 10.9472C7.51144 11.0937 7.59375 11.2924 7.59375 11.4996C7.59375 11.7068 7.51144 11.9056 7.36493 12.0521C7.21841 12.1986 7.0197 12.2809 6.8125 12.2809H2.125V18.5309H20.875V12.2809H16.1875C15.9803 12.2809 15.7816 12.1986 15.6351 12.0521C15.4886 11.9056 15.4062 11.7068 15.4062 11.4996C15.4062 11.2924 15.4886 11.0937 15.6351 10.9472C15.7816 10.8007 15.9803 10.7184 16.1875 10.7184H20.875C21.2894 10.7184 21.6868 10.883 21.9799 11.176C22.2729 11.4691 22.4375 11.8665 22.4375 12.2809ZM7.36523 6.58362L10.7188 3.22913V11.4996C10.7188 11.7068 10.8011 11.9056 10.9476 12.0521C11.0941 12.1986 11.2928 12.2809 11.5 12.2809C11.7072 12.2809 11.9059 12.1986 12.0524 12.0521C12.1989 11.9056 12.2812 11.7068 12.2812 11.4996V3.22913L15.6348 6.58362C15.7814 6.73022 15.9802 6.81257 16.1875 6.81257C16.3948 6.81257 16.5936 6.73022 16.7402 6.58362C16.8868 6.43703 16.9692 6.2382 16.9692 6.03089C16.9692 5.82357 16.8868 5.62475 16.7402 5.47815L12.0527 0.790654C11.9802 0.718016 11.894 0.660392 11.7992 0.621076C11.7043 0.58176 11.6027 0.561523 11.5 0.561523C11.3973 0.561523 11.2957 0.58176 11.2008 0.621076C11.106 0.660392 11.0198 0.718016 10.9473 0.790654L6.25977 5.47815C6.11317 5.62475 6.03082 5.82357 6.03082 6.03089C6.03082 6.2382 6.11317 6.43703 6.25977 6.58362C6.40636 6.73022 6.60518 6.81257 6.8125 6.81257C7.01982 6.81257 7.21864 6.73022 7.36523 6.58362ZM18.5312 15.4059C18.5312 15.1741 18.4625 14.9475 18.3338 14.7548C18.205 14.5621 18.022 14.4119 17.8078 14.3232C17.5937 14.2345 17.3581 14.2113 17.1308 14.2565C16.9034 14.3017 16.6946 14.4134 16.5307 14.5772C16.3668 14.7411 16.2552 14.9499 16.21 15.1773C16.1648 15.4046 16.188 15.6402 16.2767 15.8543C16.3654 16.0685 16.5156 16.2515 16.7083 16.3803C16.901 16.509 17.1276 16.5778 17.3594 16.5778C17.6702 16.5778 17.9682 16.4543 18.188 16.2345C18.4078 16.0148 18.5312 15.7167 18.5312 15.4059Z" fill="white"/>        
                                        </svg>
...
<<<<<<< HEAD
                ...
                <div class="asowp-flex asowp-space-x-3">
                    <div class="asowp-w-[50%] asowp-space-y-2 asowp-flex asowp-flex-col asowp-text-[12px]">
                        <label for="" class="asowp-font-normal">Base Price</label>
                        <input type="number" v-model="template.basePrice" @blur="isNaN(template.basePrice)? template.basePrice =0 : ''" class="asowp-h-[38px] asowp-w-full" style="border-radius: 10px;">                        
                    </div>
                    <div class="asowp-w-[50%] asowp-flex asowp-flex-col asowp-justify-center asowp-space-y-2 asowp-text-[12px]">
                        <div class="asowp-flex asowp-space-x-2">
                            <label for="" class="asowp-font-normal">Enable auto-update for the preview image</label>
                            <div class="asowp-flex asowp-justify-start asowp-items-center asowp-space-x-4">
                                <label for="yesNoPreviewImage" class="asowp-relative asowp-inline-flex asowp-items-center asowp-cursor-pointer asowp-border-[1px] asowp-border-solid asowp-border-black asowp-rounded-full">
                                    <input id="yesNoPreviewImage" type="checkbox" class="asowp-sr-only asowp-peer" v-model="template.enablePreviewImage">
                                    <div :class="`peer-checked:after:asowp-border-[#016464] peer-checked:after:asowp-border-solid peer-checked:after:asowp-border-[5px] peer-checked:after:asowp-top-[-2px] peer-checked:after:asowp-translate-y-[-15%] asowp-w-10 asowp-h-2.5 asowp-border asowp-border-[5px] asowp-border-[#016464] asowp-bg-zinc-300 asowp-rounded-full asowp-peer peer-checked:after:asowp-translate-x-[125%] after:asowp-content-[''] after:asowp-absolute after:asowp-top-[-3px] after:asowp-left-[-2px] after:asowp-bg-zinc-300 after:asowp-border-white after:asowp-border-solid after:asowp-translate-y-[-15%] after:asowp-border-[#FFFFFF] after:asowp-border-[5px] after:asowp-rounded-full after:asowp-h-2.5 after:asowp-w-2.5 after:asowp-transition-all after:asowp-shadow-lg`"></div>
                                </label>
                            </div>
                        </div>
                        <div class="asowp-flex asowp-space-x-2">
                            <label for="" class="asowp-font-normal">Enable add to cart</label>
                            <div class="asowp-flex asowp-justify-start asowp-items-center asowp-space-x-4">
                                <label for="yesNoAddCart" class="asowp-relative asowp-inline-flex asowp-items-center asowp-cursor-pointer asowp-border-[1px] asowp-border-solid asowp-border-black asowp-rounded-full">
                                    <input id="yesNoAddCart" type="checkbox" class="asowp-sr-only asowp-peer" v-model="template.enableAddToCart">
                                    <div :class="`peer-checked:after:asowp-border-[#016464] peer-checked:after:asowp-border-solid peer-checked:after:asowp-border-[5px] peer-checked:after:asowp-top-[-2px] peer-checked:after:asowp-translate-y-[-15%] asowp-w-10 asowp-h-2.5 asowp-border asowp-border-[5px] asowp-border-[#016464] asowp-bg-zinc-300 asowp-rounded-full asowp-peer peer-checked:after:asowp-translate-x-[125%] after:asowp-content-[''] after:asowp-absolute after:asowp-top-[-3px] after:asowp-left-[-2px] after:asowp-bg-zinc-300 after:asowp-border-white after:asowp-border-solid after:asowp-translate-y-[-15%] after:asowp-border-[#FFFFFF] after:asowp-border-[5px] after:asowp-rounded-full after:asowp-h-2.5 after:asowp-w-2.5 after:asowp-transition-all after:asowp-shadow-lg`"></div>
                                </label>
                            </div>
                        </div>
                ...
                <div class="asowp-space-x-2 asowp-flex">
                
                    <div class="asowp-w-[50%] asowp-flex asowp-flex-col asowp-space-y-2">
                        <label class="asowp-text-[.8125rem] asowp-text-[#444444]">Select category</label>
                        <Multiselect
                            v-model="template.categoryId"
                            placeholder="Select category"
                            noOptionsText="No category found"
                    ...
                    <div class="asowp-flex asowp-items-end asowp-w-[50%] asowp-text-[12px]">
                        <button class="asowp-flex asowp-w-fit asowp-h-fit asowp-rounded asowp-bg-[#016464] asowp-px-4 asowp-space-x-2 asowp-p-1.5 asowp-border-none asowp-text-white asowp-opacity-90 hover:asowp-opacity-100 asowp-cursor-pointer" @click="openCategoryModal = true">
                            <div class="asowp-text-[14px]">
                                Add new
                            </div>
