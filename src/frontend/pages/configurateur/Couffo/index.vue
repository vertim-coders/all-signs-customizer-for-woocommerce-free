        ...
        <div :class="`aso-w-full aso-h-full aso-flex aso-flex-col lg:aso-flex-row-reverse`">
            <div class="aso-w-full lg:aso-w-[92%] aso-h-[54%] lg:aso-h-full aso-flex aso-flex-col">
                <div :class="`aso-w-full aso-h-[9%] lg:aso-h-[10%] aso-bg-[${configColors.bars.backgroundColor}] aso-text-[${configColors.bars.titleColor}] aso-flex aso-items-center aso-justify-between`">
                    ...
                    <div @click="centerSign(canvas)" v-show="!isLoaded" :class="`aso-hidden lg:aso-flex aso-w-1/3 aso-justify-center aso-text-[${configColors.bars.titleColor}] aso-text-base lg:aso-text-2xl aso-font-bold aso-text-center`">
                    ...
                    <div v-show="!isLoaded" class="aso-hidden lg:aso-flex aso-w-1/3 aso-full-center aso-space-x-4">
                        <span @click="confirmResetAll(true)" :class="`aso-w-fit aso-h-fit aso-flex aso-full-center aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-bg-[${configColors.bars.reset.backgroundColor}] aso-text-[${configColors.bars.reset.textColor}] hover:aso-bg-[${configColors.bars.reset.hoverBackgroundColor}] hover:aso-text-[${configColors.bars.reset.hoverTextColor}] aso-border-2 aso-border-[${configColors.bars.reset.borderColor}] hover:aso-border-[${configColors.bars.reset.hoverBorderColor}] aso-space-x-2 aso-p-2 aso-px-3 aso-rounded-full aso-base-animation aso-cursor-pointer`">
                            <svg v-if="configSectionIcons.resetAllIcon === '' " class="aso-h-5 aso-w-5" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="simple-line-icons:reload">
                                <path id="Vector" d="M14.9789 0C7.48448 0 1.38745 6.09744 1.38745 13.5918C1.38745 20.6362 6.81604 26.5274 13.7967 27.1298L11.1056 28.4938C10.7732 28.6762 10.5754 29.0863 10.7723 29.4102L10.8675 29.6563C11.0653 29.9802 11.4937 30.0951 11.8251 29.9136L16.3166 27.6139C16.3223 27.6102 16.3284 27.6112 16.334 27.6074L16.6354 27.4424C16.8018 27.351 16.912 27.2015 16.956 27.0351C17.002 26.8687 16.9809 26.6835 16.882 26.5223L16.7034 26.2293C16.7006 26.2237 16.695 26.2199 16.6917 26.2148L13.9176 21.8798C13.7207 21.5559 13.2932 21.441 12.96 21.6224L12.742 21.7743C12.4096 21.9557 12.3876 22.4245 12.5845 22.7475L14.2214 25.2867C14.2125 25.2862 14.2045 25.2829 14.196 25.2825C8.06477 24.8803 3.26242 19.7442 3.26242 13.5919C3.26245 7.13109 8.51852 1.875 14.9789 1.875C21.4401 1.875 26.7257 7.13109 26.7257 13.5919C26.7257 17.3119 25.0171 20.7286 22.0382 22.966C21.6244 23.2772 21.5409 23.8651 21.8517 24.279C22.163 24.6938 22.7508 24.7763 23.1647 24.4655C26.6199 21.8701 28.6012 17.9068 28.6012 13.5919C28.6007 6.09753 22.4737 0 14.9789 0Z" fill="currentColor"/>
                    ...
                    <div v-show="!isLoaded" class="aso-flex aso-flex-wrap aso-gap-2 aso-w-2/3 lg:aso-w-1/3 aso-items-center aso-justify-end">
                        ...
                        <div :class="`aso-flex lg:aso-hidden aso-text-center aso-text-lg aso-font-semibold aso-text-[${configColors.bars.price.textBeforeColor}]`">
                            {{configVisualiserTexts.textBeforePrice}}
                        </div>
                        <div :class="`aso-flex lg:aso-hidden aso-text-lg lg:aso-text-3xl aso-font-bold aso-text-center aso-text-[${configColors.bars.price.textColor}]`">
                            {{formatPrice(finalPrices)}} 
                        </div>
                        <div :class="`aso-flex lg:aso-hidden aso-text-center aso-text-lg aso-font-semibold aso-text-[${configColors.bars.price.textAfterColor}]`">
                ...
                <div :class="`aso-relative aso-w-full aso-h-[91%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[${configColors.canvas.backgroundColor}]`">
                    ...
                    <div id="aso-canvas-containers" :class="`flipper aso-relative aso-w-full aso-h-full lg:aso-h-[90%]`">
            ...
            <div id="aso-optionsButtons-container" :class="`aso-relative aso-w-full aso-h-[8%] lg:aso-w-[8%] lg:aso-h-full aso-p-0 aso-flex aso-flex-col aso-shadow-lg aso-bg-[${configColors.optionsSideBar.backgroundColor}]`">
                ...
                <div v-show="!isLoaded" id="aso-options-buttons" class="aso-w-full aso-h-full aso-flex lg:aso-flex-col aso-items-center lg:aso-space-y-4 aso-py-4 aso-px-4 lg:aso-px-0 aso-overflow-auto no-scrollbar">
                    ...
                    <div v-if="materialType == 'simple' && (sizees.length > 0 || customSizeActive) || (materialType == 'advance' && advancedComponent.options.length > 0)" @click="showOptions('color')" :class="`aso-w-[80%]`">
                    ...
                    <div v-if="(materialType == 'simple' && currentMaterialTextImages.enableText && (sizees.length > 0 || customSizeActive) ) || materialType == 'advance' && advancedComponent.options.length > 0" @click="showOptions('text')" :class="`aso-w-[80%]`">
                    ...
                    <div v-if="(materialType == 'simple' && currentMaterialTextImages.enableImage && (sizees.length > 0 || customSizeActive) ) || materialType == 'advance' && advancedComponent.options.length > 0" @click="showOptions('image')" :class="`aso-w-[80%]`">
