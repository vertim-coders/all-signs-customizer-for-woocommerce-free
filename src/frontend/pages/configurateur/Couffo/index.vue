    ...
    <div class="aso-relative aso-w-full aso-h-full">
        ...
        <div :class="`aso-w-full aso-h-full aso-flex aso-flex-col lg:aso-flex-row-reverse`">
            <div class="aso-w-full lg:aso-w-[92%] aso-h-[54%] lg:aso-h-full aso-flex aso-flex-col">
                <div :class="`aso-w-full aso-h-[9%] lg:aso-h-[10%] aso-bg-[${configColors.bars.backgroundColor}] aso-text-[${configColors.bars.titleColor}] aso-flex aso-items-center aso-justify-between`">
                    ...
                    <div @click="centerSign(canvas)" v-show="!isLoaded" :class="`aso-flex aso-w-1/3 aso-justify-center aso-text-[${configColors.bars.titleColor}] aso-text-base lg:aso-text-2xl aso-font-bold aso-text-center`">
                    ...
                    <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-full-center">
                        <div id="aso-editButtons" :class="`aso-bg-[${configColors.objectsOptions.backgroundColor}] aso-hidden lg:aso-flex aso-full-center aso-space-x-1 aso-p-2 aso-px-3 aso-rounded-lg`">
                            <div @click="editObject()" id="aso-editObject" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `aso-cursor-pointer` : `aso-cursor-not-allowed` } aso-flex aso-full-center aso-space-x-1 aso-bg-[${configColors.objectsOptions.edit.buttonColor}] aso-text-[${configColors.objectsOptions.edit.textColor}] hover:aso-bg-[${configColors.objectsOptions.edit.hoverButtonColor}] hover:aso-text-[${configColors.objectsOptions.edit.hoverTextColor}] aso-base-animation aso-px-1 aso-rounded-md`">
                            ...
                            <div @click="cloneObject()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `aso-cursor-pointer` : `aso-cursor-not-allowed` } aso-flex aso-full-center aso-space-x-1 aso-bg-[${configColors.objectsOptions.clone.buttonColor}] aso-text-[${configColors.objectsOptions.clone.textColor}] hover:aso-bg-[${configColors.objectsOptions.clone.hoverButtonColor}] hover:aso-text-[${configColors.objectsOptions.clone.hoverTextColor}] aso-base-animation aso-px-1 aso-rounded-md`">
                            ...
                            <div @click="deleteObject()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `aso-cursor-pointer` : `aso-cursor-not-allowed` } aso-flex aso-full-center aso-space-x-1 aso-bg-[${configColors.objectsOptions.delete.buttonColor}] aso-text-[${configColors.objectsOptions.delete.textColor}] hover:aso-bg-[${configColors.objectsOptions.delete.hoverButtonColor}] hover:aso-text-[${configColors.objectsOptions.delete.hoverTextColor}] aso-base-animation aso-px-1 aso-rounded-md`">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-5 aso-h-5">
                            ...
                            <div @click="centerHorizontally()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `aso-cursor-pointer` : `aso-cursor-not-allowed` } aso-flex aso-full-center aso-space-x-1 aso-bg-[${configColors.objectsOptions.center.buttonColor}] aso-text-[${configColors.objectsOptions.center.textColor}] hover:aso-bg-[${configColors.objectsOptions.center.hoverButtonColor}] hover:aso-text-[${configColors.objectsOptions.center.hoverTextColor}] aso-base-animation aso-px-1 aso-rounded-md`">
                                <svg focusable="false" viewBox="0 0 24 24" class="aso-w-5 aso-h-5">
                ...
                <div :class="`aso-relative aso-w-full aso-h-[91%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[${configColors.canvas.backgroundColor}]`">
                    ...
                    <div :class="`aso-absolute aso-bottom-0 aso-w-full aso-h-[10%] aso-bg-[${configColors.bars.backgroundColor}]/60 aso-hidden lg:aso-flex aso-full-center aso-space-x-4`">
                        ...
                        <div class="aso-w-2/3 aso-h-full aso-flex aso-justify-end aso-items-center">
                            <div id="aso-price" :class="`aso-bg-[${configColors.bars.price.backgroundColor}]  aso-flex aso-full-center aso-space-x-2 aso-h-[90%] aso-px-2`">
                                ...
                                <div :class="`aso-flex aso-text-[${configColors.bars.price.textColor}] aso-text-lg lg:aso-text-3xl aso-font-bold aso-text-center`">
                                    {{formatPrice(finalPrices)}}
                                </div>
            ...
            <div id="aso-optionsButtons-container" :class="`aso-relative aso-w-full aso-h-[8%] lg:aso-w-[8%] lg:aso-h-full aso-p-0 aso-flex aso-flex-col aso-shadow-lg aso-bg-[${configColors.optionsSideBar.backgroundColor}]`">
                ...
                <div v-show="!isLoaded" id="aso-options-buttons" class="aso-w-full aso-h-full aso-flex lg:aso-flex-col aso-items-center lg:aso-space-y-4 aso-py-4 aso-px-4 lg:aso-px-0 aso-overflow-auto no-scrollbar">
                    <div v-if="allMaterials.length > 1" @click="showOptions('material')" :class="`aso-w-[80%]`">
                        <div :class="`${step === 'material' ? `aso-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] aso-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:aso-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] aso-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:aso-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation aso-cursor-pointer`">
                    ...
                    <div v-if="showScrollButton">
                        <div @click="ScrollLeft('aso-options-buttons')" :class="`aso-absolute aso-top-[0%] aso-left-0 aso-w-fit lg:aso-w-full aso-h-full lg:aso-h-fit aso-bg-[${configColors.optionsSideBar.scrollButtonsBackgroundColor}]/60 aso-text-[${configColors.optionsSideBar.scrollButtonsTextColor}] hover:aso-bg-[${configColors.optionsSideBar.scrollButtonsHoverBackgroundColor}]/60 hover:aso-text-[${configColors.optionsSideBar.scrollButtonsHoverTextColor}] aso-flex aso-full-center aso-px-1 lg:aso-px-2 lg:aso-py-1 aso-cursor-pointer aso-base-animation`">
                                ...
                                <label :for="material.name + index" :class="`aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-bg-[${configColors.optionsSideBar.options.modals.option.hoverBackgroundColor}]/50  hover:aso-text-[${configColors.optionsSideBar.options.modals.option.hoverTextColor}] aso-p-2 aso-base-animation`">
                                    ...
                                    <div :class="`aso-w-3/4 aso-flex aso-flex-col aso-space-y-1`">
                                        ...
                                        <div class="aso-w-full aso-flex aso-items-center aso-justify-between">
                                            ...
                                            <span :class="`${selectedMaterial == material.name ? `aso-bg-[${configColors.optionsSideBar.options.modals.option.activeTextColor}]` : `aso-text-transparent `} aso-flex aso-w-fit aso-h-fit aso-p-1 aso-border-solid aso-border-2 aso-rounded-full`">
                                ...
                                <label :for="'aso-model' + option.name + option.size.width + index" :class="`aso-flex aso-full-center aso-space-x-2 aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-bg-[${configColors.optionsSideBar.options.modals.option.hoverBackgroundColor}]/50  hover:aso-text-[${configColors.optionsSideBar.options.modals.option.hoverTextColor}] aso-p-2 aso-base-animation`">
                                    ...
                                    <div :class="`aso-w-3/4 aso-flex aso-flex-col aso-space-y-1`">
                                        ...
                                        <div class="aso-w-full aso-flex aso-items-center aso-justify-between">
                                            ...
                                            <span :class="`${activeSignModelName == option.name && activeSignModelId === index ? `aso-bg-[${configColors.optionsSideBar.options.modals.option.activeTextColor}]` : `aso-text-transparent `} aso-flex aso-w-fit aso-h-fit aso-p-1 aso-border-solid aso-border-2 aso-rounded-full`">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="aso-w-4 aso-h-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                </svg>
                                            </span>                
                                        ...
                                        <label :for="fixing.name + index" :class="`aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-bg-[${configColors.optionsSideBar.options.modals.option.hoverBackgroundColor}]/50  hover:aso-text-[${configColors.optionsSideBar.options.modals.option.hoverTextColor}] aso-p-2 aso-base-animation`">
                                            ...
                                            <div :class="`aso-w-3/4 aso-flex aso-flex-col aso-space-y-1`">
                                                ...
                                                <div class="aso-w-full aso-flex aso-items-center aso-justify-between">
                                                    ...
                                                    <span :class="`${activeFixingMethode == fixing.type ? `aso-bg-[${configColors.optionsSideBar.options.modals.option.activeTextColor}]` : `aso-text-transparent `} aso-flex aso-w-fit aso-h-fit aso-p-1 aso-border-solid aso-border-2 aso-rounded-full`">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="aso-w-4 aso-h-4">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                        </svg>
                                                    </span>                
                                ...
                                <div v-if="configImageSettingsClipart.active" class="aso-space-y-3">
                                    <div class="aso-flex aso-flex-col aso-space-y-2">
                                        <div v-for="(clipart, index) in allClipart">
                                            ...
                                            <div v-show="showClipart && clipartId == index" :class="`aso-relative lg:aso-absolute lg:aso-top-0 lg:aso-right-0 lg:aso-translate-x-[101%] lg:aso-w-full lg:aso-h-[90%] aso-bg-[${configColors.backgroundColorOptionsMenu}] aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] lg:aso-shadow-xl`">
                                                <div class="aso-flex aso-flex-wrap aso-gap-2 aso-p-1">
                                ...
                                <div class="aso-space-y-3">
                                    ...
                                    <div class="aso-w-full aso-flex aso-items-center">
                                        <div class="aso-flex aso-space-x-6">
                                            ...
                                            <span @click="turnLeftImage()" :class="`aso-flex aso-flex-col aso-full-center aso-space-y-4 aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-text-[${configColors.optionsSideBar.options.modals.option.activeTextColor}] aso-base-animation`">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-5 aso-h-5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3" />
                                                </svg>
                                            ...
                                            <span @click="turnRightImage()" :class="`aso-flex aso-flex-col aso-full-center aso-space-y-4 aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-text-[${configColors.optionsSideBar.options.modals.option.activeTextColor}] aso-base-animation`">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-5 aso-h-5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m15 15 6-6m0 0-6-6m6 6H9a6 6 0 0 0 0 12h3" />
                                                </svg>
                                            ...
                                            <span @click="flipImage()" :class="`aso-flex aso-flex-col aso-full-center aso-space-y-4 aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-text-[${configColors.optionsSideBar.options.modals.option.activeTextColor}] aso-base-animation`">
                                    ...
                                    <label :for="'aso-addOptions' + addComponentValue.title + option.title + index" :class="`aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer aso-text-[${configColors.optionsSideBar.options.modals.option.textColor}] hover:aso-bg-[${configColors.optionsSideBar.options.modals.option.hoverBackgroundColor}]/50  hover:aso-text-[${configColors.optionsSideBar.options.modals.option.hoverTextColor}] aso-p-2 aso-base-animation`">
                                        ...
                                        <div :class="`aso-w-3/4 aso-flex aso-flex-col aso-space-y-1`">
                                            ...
                                            <div class="aso-w-full aso-flex aso-items-center aso-justify-between">
                                                ...
                                                <span :class="`${ addComponentSelected.some(item => item.option === addComponentValue.title && item.value === option.title)  ? `aso-bg-[${configColors.optionsSideBar.options.modals.option.activeTextColor}]` : `aso-text-transparent `} aso-flex aso-w-fit aso-h-fit aso-p-1 aso-border-solid aso-border-2 aso-rounded-full`">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="aso-w-4 aso-h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                    </svg>
                                                </span>                
        ...
        <div v-if="route.name == 'template-maker'" v-show="showTempSettings" id="aso-templateObjects-options" :class="`aso-absolute aso-top-[11%] aso-right-0 aso-w-[30%] aso-h-[40%] aso-bg-[${configColors.optionsSideBar.options.modals.backgroundColor}] aso-text-[${configColors.optionsSideBar.options.modals.textColor}]`">
        ...
        <div v-if="finish" :class="`aso-absolute aso-top-0 aso-z-30 aso-w-full aso-h-full aso-flex aso-flex-col aso-bg-[${configColors.recaps.backgroundColor}]`">
        ...
        <div v-if="resetAllBool" :class="`aso-absolute aso-top-0 aso-bg-[${configColors.bars.reset.modalBackgroundColor}]/70 aso aso-w-full aso-h-full aso-flex aso-full-center`">
            <div :class="`aso-w-[40%] aso-h-[40%] aso-bg-[${configColors.bars.reset.modalContainerBackground}] aso-text-[${configColors.bars.reset.modalTextColor}] aso-p-2 aso-shadow-2xl`">
...
<script setup>
    ...
    onMounted(async() => {
        ...
        console.log(configColors.value, "config")
