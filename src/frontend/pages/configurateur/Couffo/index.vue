        ...
        <div :class="`aso-w-full aso-h-full aso-flex aso-flex-col lg:aso-flex-row-reverse`">
                ...
                <div :class="`aso-w-full aso-h-[9%] lg:aso-h-[10%] aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] aso-flex aso-items-center aso-justify-between`">
                    ...
                    <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-full-center">
                        <div class="aso-bg-white/10 aso-hidden lg:aso-flex aso-full-center aso-space-x-4 aso-p-2 aso-px-4 aso-rounded-lg">
                            <div @click="cloneObject()" :class="`aso-flex aso-full-center aso-space-x-1 hover:aso-text-[${configColors.textColorContentHeader}]/70 aso-cursor-pointer aso-base-animation`">
                            ...
                            <div @click="deleteObject()" :class="`aso-flex aso-full-center aso-space-x-1 hover:aso-text-[${configColors.textColorContentHeader}]/70 aso-cursor-pointer aso-base-animation`">
                            ...
                            <div @click="centerVertically()" :class="`aso-flex aso-full-center aso-space-x-1 hover:aso-text-[${configColors.textColorContentHeader}]/70 aso-cursor-pointer aso-base-animation`">
                            ...
                            <div @click="centerHorizontally()" :class="`aso-flex aso-full-center aso-space-x-1 hover:aso-text-[${configColors.textColorContentHeader}]/70 aso-cursor-pointer aso-base-animation`">
                                <svg focusable="false" viewBox="0 0 24 24" class="aso-w-5 aso-h-5">
            ...
            <div id="aso-optionsButtons-container" :class="`aso-relative aso-w-full aso-h-[8%] lg:aso-w-[8%] lg:aso-h-full aso-p-0 aso-flex aso-flex-col aso-shadow-lg aso-bg-[${configColors.backgroundColorContentSide}]`">
                ...
                <div v-show="!isLoaded" class="aso-w-full aso-h-full aso-flex lg:aso-flex-col aso-items-center lg:aso-space-y-4 aso-py-4 aso-overflow-auto no-scrollbar">
                    <div @click="showOptions('material')" :class="`aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation`">
                        ...
                        <div class="aso-text-[10px] lg:aso-text-[13px] aso-leading-normal aso-font-medium">
                    ...
                    <div v-if="materialType == 'advance'" v-for="(component, id) in currentMaterial.data" class="aso-w-[80%]" >
                        <div @click="showOptions('component', component)" :class="`aso-w-full aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation`">
                    ...
                    <div v-if="materialType == 'simple'" @click="showOptions('border')" :class="`aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation`">
                    ...
                    <div v-if="materialType == 'simple'" @click="showOptions('color')" :class="`aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation`">
                    ...
                    <div v-if="(materialType == 'simple' && additionalOptions.length > 0 )" v-for="(option, id) in additionalOptions" class="aso-w-[80%]" >
                        <div @click="showOptions('add-options', option)" :class="`aso-w-full aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation`">
            ...
            <div class="aso-w-full aso-h-[32%] lg:aso-w-fit lg:aso-h-fit">
                <div v-show="showOption" id="aso-options-container" :class="`aso-relative lg:aso-absolute lg:aso-left-[8%] lg:aso-top-[10%] aso-w-full lg:aso-w-[30%] aso-h-[85%] lg:aso-h-[70%] aso-bg-[${configColors.backgroundColorOptionsMenu}] aso-text-[${configColors.textColorOptionsMenu}] aso-rounded-md lg:aso-shadow-xl aso-z-20`">
                    ...
                    <div v-show="step == 'add-options'" class="aso-flex aso-flex-col lg:aso-space-y-1 aso-w-full aso-h-full" id="aso-fixings-section">
                        ...
                        <div v-if="materialType == 'simple'" class="aso-w-full aso-h-full aso-p-4 aso-overflow-auto aso-scrollBar">
                            <div v-for="(option, index) in addOptionsValue.options">
                                <div class="aso-space-y-3 aso-w-full aso-h-full">
                                    <input type="radio" :id="'aso-addOptions' + addOptionsValue.title + option.title + index" name="aso-fixings" class=" peer aso-hidden" @change="selectAddOption(addOptionsValue.title, option.title, option.additionalPrice)">
                                    <label :for="'aso-addOptions' + addOptionsValue.title + option.title + index" class="aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer">
                                        <div :class="`${option.icon === '' ? `aso-bg-[${configColors.backgroundColorHeader}]` : `` } aso-w-1/4 aso-h-20`">
                                            <img v-if="option.icon != ''" :src="option.icon" class="aso-w-full aso-h-full" />
                                        </div>
                                        <div class="aso-w-3/4 aso-flex aso-flex-col aso-space-y-1">
                                            ...
                                            <div class="aso-w-full aso-flex aso-items-center aso-justify-between">
                                                ...
                                                <span :class="`${ addOptionSelected.some(item => item.option === addOptionsValue.title && item.value === option.title)  ? `aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}]` : `aso-text-transparent`} aso-flex aso-w-fit aso-h-fit aso-p-1 aso-border-2 aso-rounded-full`">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="aso-w-4 aso-h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                    </svg>
                                                </span>                
            ...
            <div v-if="showImg" class="aso-absolute aso-top-[50%] aso-translate-y-[-50%] aso-left-[50%] aso-translate-x-[-50%] aso-w-[80%] aso-h-[80%] aso-bg-white aso-border-solid aso-p-2">
                <svg @click="closePreviewImg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-6 aso-h-6 aso-absolute aso-top-0 aso-right-0">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
    
                <img id="showPreview" :src="previewImg" class="aso-w-fit aso-h-fit" />
            </div>
        </div>
...
<script setup>
            ...
            additionalOptions.value.forEach(addOption => {
                ...
                while (index < addOption.options.length && !haveDefault) {
                    if(addOption.options[index].isDefault){
                        selectAddOption(addOption.title, addOption.options[index].title, addOption.options[index].additionalPrice)
                        haveDefault = true
                        break;
                    }
                    index++;
                ...
                if(!haveDefault){
                    selectAddOption(addOption.title, addOption.options[0].title, addOption.options[0].additionalPrice)
                }
            })
        }
    ...
    var selectedAddOption = ref("")
    var addOptionSelected = ref([])
    function selectAddOption(addOption, option, price){
        ...
        addUniqueObject(addOptionSelected.value, {option: addOption, value: option}, 'option')

        selectedAddOption.value = option

        // console.log(addOptionSelected.value, "selected")
        // console.log(addOptionsValue.value, "selected fsdfsdf")
    ...
    function showConfigRender(){
        previewImg.value = generateImage(canvas, 'png');
        showImg.value = true
