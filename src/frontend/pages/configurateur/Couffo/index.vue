<template>
    <div class="asowp-relative asowp-w-full asowp-h-full">
        ...
        <div :class="`asowp-w-full asowp-h-full asowp-flex asowp-flex-col ${desktopColumnPosition == 'left' ? `lg:asowp-flex-row-reverse` : `lg:asowp-flex-row`}`">
            <div class="asowp-w-full lg:asowp-w-[92%] asowp-h-[54%] lg:asowp-h-full asowp-flex asowp-flex-col">
                <div :class="`asowp-w-full asowp-h-[9%] lg:asowp-h-[10%] asowp-bg-[${configColors.bars.backgroundColor}] asowp-text-[${configColors.bars.titleColor}] asowp-flex asowp-items-center asowp-justify-between`">
                    ...
                    <div v-show="!isLoaded" class="asowp-flex asowp-space-x-2 asowp-w-4/5 lg:asowp-w-1/3 asowp-h-full asowp-items-center asowp-justify-end">
                        <div v-if="finishButtonPosition == 'bottom'" id="asowp-editButtons" :class="`asowp-bg-[${configColors.objectsOptions.backgroundColor}] asowp-hidden lg:asowp-flex asowp-full-center asowp-space-x-1 asowp-p-2 asowp-px-3 asowp-rounded-lg`">
                        ...
                        <button v-if="finishButtonPosition == 'top'" :disabled="currentSizeData.width <= 0 || currentSizeData.height <= 0" v-show="!isLoaded" @click="finishConfig()" :class="`asowp-hidden lg:asowp-flex asowp-full-center asowp-w-fit asowp-h-full asowp-bg-[${configColors.recaps.buttonFinishBackgroundColor}] hover:asowp-bg-[${configColors.recaps.buttonFinishHoverBackgroundColor}] asowp-text-[${configColors.recaps.buttonFinishTextColor}] hover:asowp-text-[${configColors.recaps.buttonFinishHoverTextColor}] asowp-font-semibold asowp-p-2 asowp-px-6 asowp-base-animation asowp-cursor-pointer disabled:asowp-cursor-not-allowed asowp-buttons-rad-none`">
                        ...
                        <div v-if="!hidePricing" class="asowp-flex lg:asowp-hidden asowp-full-center asowp-space-x-1 asowp-mr-1">
                        ...
                        <div v-if="!hidePricing" :class="`asowp-flex lg:asowp-hidden asowp-text-center asowp-text-lg asowp-font-semibold asowp-text-[${configColors.bars.price.textBeforeColor}]`">
                            {{configVisualiserTexts.textBeforePrice}}
                        </div>
                        <div v-if="!hidePricing" :class="`asowp-flex lg:asowp-hidden asowp-text-lg lg:asowp-text-3xl asowp-font-bold asowp-text-center asowp-text-[${configColors.bars.price.textColor}]`">
                            <!-- {{formatPrice(finalPrices)}}  -->
                            {{addformatToPrice(finalPrice)}} 
                        </div>
                        <div v-if="!hidePricing" :class="`asowp-flex lg:asowp-hidden asowp-text-center asowp-text-lg asowp-font-semibold asowp-text-[${configColors.bars.price.textAfterColor}]`">
                ...
                <div :class="`asowp-relative asowp-w-full asowp-h-[91%] lg:asowp-h-[90%] asowp-flex asowp-flex-col asowp-items-center asowp-bg-[${configColors.canvas.backgroundColor}]`">
                    <div v-show="configDoublePart.active" class="asowp-w-full asowp-h-[6%] asowp-flex asowp-items-center asowp-bg-white asowp-space-x-3 asowp-px-4 asowp-border-y">
                        ...
                        <span @click="flipRect" :class="`asowp-mx-2 asowp-rounded-full asowp-p-1.5 asowp-font-medium asowp-h-[80%] asowp-w-fit asowp-bg-[${configColors.backgroundColorHeader}]/30 asowp-relative asowp-flex asowp-justify-between asowp-items-center asowp-border asowp-cursor-pointer`">
                            <span :class="`${activeFace === 'front-face' ? 'asowp-left-[1%]' : 'asowp-translate-x-[105%] asowp-right-[53%]'} asowp-bg-[${configColors.optionsSideBar.options.modals.buttons.backgroundColor}] asowp-translate-x asowp-absolute asowp-w-[50%] asowp-h-[95%] asowp-transition-all ease-in duration-200 z-0 asowp-rounded-full asowp-top-[5%]`"></span>
                    ...
                    <div :class="`asowp-absolute asowp-bottom-0 asowp-w-full asowp-h-[10%] asowp-bg-[${configColors.bars.backgroundColor}]/60 asowp-hidden lg:asowp-flex asowp-full-center asowp-space-x-4`">
                        ...
                        <div :class="`${finishButtonPosition == 'top' ? `asowp-w-1/5` : `asowp-w-1/3`} asowp-flex asowp-justify-start asowp-items-center asowp-space-x-4 asowp-px-6`">
                        ...
                        <div :class="`${finishButtonPosition == 'top' ? `asowp-w-4/5` : `asowp-w-2/3`} asowp-h-full asowp-flex asowp-justify-end asowp-items-center`">
                            <div v-if="!hidePricing" class="asowp-flex asowp-full-center asowp-space-x-1 asowp-mr-2">
                            ...
                            <div v-if="!hidePricing" id="asowp-price" :class="`asowp-bg-[${configColors.bars.price.backgroundColor}]  asowp-flex asowp-full-center asowp-space-x-2 asowp-h-[90%] asowp-px-2`">
                            ...
                            <div v-if="finishButtonPosition == 'top'" id="asowp-editButtons" :class="`asowp-bg-[${configColors.objectsOptions.backgroundColor}] asowp-hidden lg:asowp-flex asowp-full-center asowp-space-x-1 asowp-p-2 asowp-px-3 asowp-rounded-lg`">
                                <div @click="editObject()" id="asowp-editObject" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `asowp-cursor-pointer` : `asowp-cursor-not-allowed` } asowp-flex asowp-full-center asowp-space-x-1 asowp-bg-[${configColors.objectsOptions.edit.buttonColor}] asowp-text-[${configColors.objectsOptions.edit.textColor}] hover:asowp-bg-[${configColors.objectsOptions.edit.hoverButtonColor}] hover:asowp-text-[${configColors.objectsOptions.edit.hoverTextColor}] asowp-base-animation asowp-px-1 asowp-rounded-md`">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="asowp-w-5 asowp-h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                    </svg>
                            ...
                            <div v-if="finishButtonPosition == 'bottom'" class="asowp-w-1/4 asowp-h-full asowp-flex asowp-justify-end">
                    ...
                    <div v-show="step == 'text'" class="asowp-flex asowp-flex-col lg:asowp-space-y-3 asowp-w-full asowp-h-full" id="asowp-texts-section">
                        ...
                        <div class="asowp-h-full asowp-overflow-auto asowp-scrollBar asowp-space-y-2 asowp-p-3">
                            ...
                            <div v-show="selectText" class="asowp-space-y-2">
                                ...
                                <div v-if="configTextType == 'normal' || (activeFace === 'front-face' && !signTextColor1.active) || (activeFace === 'back-face' && !signTextColor2.active)" class="asowp-space-y-1">
        ...
        <div v-if="finish" :class="`asowp-config-recap asowp-absolute asowp-top-0 asowp-z-30 asowp-w-full asowp-h-full asowp-flex asowp-flex-col asowp-bg-[${configColors.recaps.backgroundColor}]`">
            ...
            <div class="asowp-h-[15%] asowp-flex asowp-flex-col asowp-text-[16px] asowp-leading-normal">
                ...
                <div class="asowp-flex asowp-h-[60%]">
                    ...
                    <button v-if="route.name != 'template-maker'" :disabled="isAddingToCart || isAdminPreview" @click="addToCart" :class="`asowp-w-1/2 asowp-h-full asowp-bg-[${configColors.recaps.buttonAddToCartBackgroundColor}] hover:asowp-bg-[${configColors.recaps.buttonAddToCartHoverBackgroundColor}] asowp-text-[${configColors.recaps.buttonAddToCartTextColor}] hover:asowp-text-[${configColors.recaps.buttonAddToCartHoverTextColor}] asowp-flex asowp-full-center asowp-buttons-rad-none asowp-base-animation ${isAdminPreview ? 'asowp-opacity-60 asowp-cursor-not-allowed' : 'asowp-cursor-pointer'}`" >
                        <img :src="frontendLoadingIcon" class="asowp-w-5 asowp-h-5" v-if="isAddingToCart"/>
                    ...
                    <button v-if="route.name == 'template-maker'" :disabled="isSavingTemplate" @click="saveTemplate" :class="`asowp-w-1/2 asowp-h-full asowp-bg-[${configColors.recaps.buttonAddToCartBackgroundColor}] hover:asowp-bg-[${configColors.recaps.buttonAddToCartHoverBackgroundColor}] asowp-text-[${configColors.recaps.buttonAddToCartTextColor}] hover:asowp-text-[${configColors.recaps.buttonAddToCartHoverTextColor}] asowp-flex asowp-full-center asowp-buttons-rad-none asowp-base-animation asowp-cursor-pointer`" >
                        <img :src="frontendLoadingIcon" class="asowp-w-5 asowp-h-5" v-if="isSavingTemplate"/>
                        Save
                    </button>
                </div>
            </div>
        ...
        <div v-if="isLoading || removeBgImageLoading" class="asowp-absolute asowp-left-0 asowp-top-0 asowp-flex asowp-justify-center asowp-items-center asowp-w-full asowp-h-full asowp-bg-black/30 asowp-backdrop-blur-md asowp-z-30">
            <span :class="`asowp-flex asowp-text-cyan-600`">
...
<script setup>
    ...
    const isAdminPreview = route.name === 'preview-back' || Boolean(document.querySelector('#asowp-frontend-app[data-asowp-preview-config-id]'));
    const frontendLoadingIcon = `${String(window?.asowp_data?.assets_url || "").replace(/\/$/, "")}/icons/ic_loading_gray.svg`;
    ...
    function getDefaultMaterialIndex(){
        const materials = Array.isArray(props.config.data.materials) ? props.config.data.materials : []
        const defaultIndex = materials.findIndex((material) => material && material.isDefault === true)
        return defaultIndex >= 0 ? defaultIndex : 0
    }

    function selectDefaultMaterial(){
        const materials = Array.isArray(props.config.data.materials) ? props.config.data.materials : []
        if(materials.length > 0){
            const materialIndex = getDefaultMaterialIndex()
            selectMaterial(materials[materialIndex], materialIndex)
        }
    }
    ...
    const removeConfiguratorLoader = () => {
        const loader = document.querySelector("#asowp-configurator-loader");
        if (loader) {
            loader.remove();
        }
    };
    ...
    onMounted(async() => {
        ...
        try{
            ...
            lastActiveOption.value = activeConfigOptionAfterCondition.value.length > 0
                ? activeConfigOptionAfterCondition.value[activeConfigOptionAfterCondition.value.length - 1].type
                : ''
