<template>
    <div class="ascwo-relative ascwo-w-full ascwo-h-full">

        <div :class="`ascwo-w-full ascwo-h-full ascwo-flex ascwo-flex-col ${desktopColumnPosition == 'left' ? `lg:ascwo-flex-row-reverse` : `lg:ascwo-flex-row`}`">
            <div class="ascwo-w-full lg:ascwo-w-[92%] ascwo-h-[54%] lg:ascwo-h-full ascwo-flex ascwo-flex-col">
                <div :class="`ascwo-w-full ascwo-h-[9%] lg:ascwo-h-[10%] ascwo-bg-[${configColors.bars.backgroundColor}] ascwo-text-[${configColors.bars.titleColor}] ascwo-flex ascwo-items-center ascwo-justify-between`">
                    ...
                    <div @click="centerSign(canvas)" v-show="!isLoaded" :class="`ascwo-hidden lg:ascwo-flex ascwo-w-1/3 ascwo-justify-center ascwo-text-[${configColors.bars.titleColor}] ascwo-text-base lg:ascwo-text-2xl ascwo-font-bold ascwo-text-center`">
                    ...
                    <div @click="() => showStateButtons = !showStateButtons" v-show="!isLoaded" :class="`ascwo-relative ascwo-flex lg:ascwo-hidden ascwo-w-1/5 ascwo-pl-2 ascwo-justify-start ascwo-text-[${configColors.bars.titleColor}]`">
                        ...
                        <div v-if="showStateButtons" :class="`ascwo-absolute ascwo-bottom-0 ascwo-translate-y-[110%] ascwo-z-10 ascwo-flex ascwo-bg-[${configColors.bars.backgroundColor}] ascwo-fit ascwo-full-center ascwo-space-x-3 ascwo-px-2`">
                            ...
                            <span @click="showConfigRender()" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.preview.backgroundColor}] ascwo-text-[${configColors.bars.preview.textColor}] hover:ascwo-bg-[${configColors.bars.preview.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.preview.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.preview.borderColor}] hover:ascwo-border-[${configColors.bars.preview.hoverBorderColor}]`">
                                <svg v-if="configSectionIcons.changeIconPreview === '' " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-4 ascwo-h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                </svg>
                                <img v-if="configSectionIcons.changeIconPreview !== '' " :src="configSectionIcons.changeIconPreview" class="ascwo-w-5 ascwo-h-5" />                                                            
                            </span>

                            <span v-if="configImageSettings.enableDownloadImage" @click="downLoadConfigRender()" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.preview.backgroundColor}] ascwo-text-[${configColors.bars.preview.textColor}] hover:ascwo-bg-[${configColors.bars.preview.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.preview.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.preview.borderColor}] hover:ascwo-border-[${configColors.bars.preview.hoverBorderColor}]`">
                                <svg v-if="configSectionIcons.changeIconDownload === '' " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-4 ascwo-h-4">
                            ...
                            <span v-if="props.config.data.settings.languageImages.uploadDesign.helpContent != ''" @click="()=> showHelpSection = !showHelpSection" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.help.backgroundColor}] ascwo-text-[${configColors.bars.help.textColor}] hover:ascwo-bg-[${configColors.bars.help.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.help.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.help.borderColor}] hover:ascwo-border-[${configColors.bars.help.hoverBorderColor}]`">
                                ...
                                <img v-if="configSectionIcons.changeIconHelp !== '' " :src="configSectionIcons.changeIconHelp" class="ascwo-w-4 ascwo-h-4" />                                                            
                            </span>

                            <a v-if="props.config.data.settings.languageImages.uploadDesign.activate" :href="props.config.data.settings.languageImages.uploadDesign.link" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.preview.backgroundColor}] ascwo-text-[${configColors.bars.preview.textColor}] hover:ascwo-bg-[${configColors.bars.preview.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.preview.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.preview.borderColor}] hover:ascwo-border-[${configColors.bars.preview.hoverBorderColor}]`">
                                <svg v-if="configSectionIcons.changeIconImport === '' " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-4 ascwo-h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
                                </svg>
                                <img v-if="configSectionIcons.changeIconImport !== '' " :src="configSectionIcons.changeIconImport" class="ascwo-w-4 ascwo-h-4" />                                                            
                            </a>
                        </div>
                    </div>
    
                    <div v-show="!isLoaded" class="ascwo-hidden lg:ascwo-flex ascwo-w-1/3 ascwo-full-center ascwo-space-x-4">
                        <span @click="confirmResetAll(true)" :class="`ascwo-w-fit ascwo-h-fit ascwo-flex ascwo-full-center ascwo-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] ascwo-bg-[${configColors.bars.reset.backgroundColor}] ascwo-text-[${configColors.bars.reset.textColor}] hover:ascwo-bg-[${configColors.bars.reset.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.reset.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.reset.borderColor}] hover:ascwo-border-[${configColors.bars.reset.hoverBorderColor}] ascwo-space-x-2 ascwo-p-2 ascwo-px-3 ascwo-rounded-full ascwo-base-animation ascwo-cursor-pointer`">
                            <svg v-if="configSectionIcons.resetAllIcon === '' " class="ascwo-h-5 ascwo-w-5" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="simple-line-icons:reload">
                                <path id="Vector" d="M14.9789 0C7.48448 0 1.38745 6.09744 1.38745 13.5918C1.38745 20.6362 6.81604 26.5274 13.7967 27.1298L11.1056 28.4938C10.7732 28.6762 10.5754 29.0863 10.7723 29.4102L10.8675 29.6563C11.0653 29.9802 11.4937 30.0951 11.8251 29.9136L16.3166 27.6139C16.3223 27.6102 16.3284 27.6112 16.334 27.6074L16.6354 27.4424C16.8018 27.351 16.912 27.2015 16.956 27.0351C17.002 26.8687 16.9809 26.6835 16.882 26.5223L16.7034 26.2293C16.7006 26.2237 16.695 26.2199 16.6917 26.2148L13.9176 21.8798C13.7207 21.5559 13.2932 21.441 12.96 21.6224L12.742 21.7743C12.4096 21.9557 12.3876 22.4245 12.5845 22.7475L14.2214 25.2867C14.2125 25.2862 14.2045 25.2829 14.196 25.2825C8.06477 24.8803 3.26242 19.7442 3.26242 13.5919C3.26245 7.13109 8.51852 1.875 14.9789 1.875C21.4401 1.875 26.7257 7.13109 26.7257 13.5919C26.7257 17.3119 25.0171 20.7286 22.0382 22.966C21.6244 23.2772 21.5409 23.8651 21.8517 24.279C22.163 24.6938 22.7508 24.7763 23.1647 24.4655C26.6199 21.8701 28.6012 17.9068 28.6012 13.5919C28.6007 6.09753 22.4737 0 14.9789 0Z" fill="currentColor"/>
                        ...
                        <div class="ascwo-flex ascwo-full-center ascwo-space-x-4">
                    ...
                    <div v-show="!isLoaded" class="ascwo-flex ascwo-space-x-2 ascwo-w-4/5 lg:ascwo-w-1/3 ascwo-h-full ascwo-items-center ascwo-justify-end">
                        <div v-if="finishButtonPosition == 'bottom'" id="ascwo-editButtons" :class="`ascwo-bg-[${configColors.objectsOptions.backgroundColor}] ascwo-hidden lg:ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-p-2 ascwo-px-3 ascwo-rounded-lg`">
                            <div @click="editObject()" id="ascwo-editObject" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.edit.buttonColor}] ascwo-text-[${configColors.objectsOptions.edit.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.edit.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.edit.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                            ...
                            <div @click="cloneObject()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.clone.buttonColor}] ascwo-text-[${configColors.objectsOptions.clone.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.clone.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.clone.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                                ...
                                <p class="ascwo-text-[11px] ascwo-font-semibold">{{ configVisualiserTexts.textCanvasClone && configVisualiserTexts.textCanvasClone.trim() !== '' ? configVisualiserTexts.textCanvasClone : 'Clone' }}</p>
                            </div>

                            <div @click="deleteObject()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.delete.buttonColor}] ascwo-text-[${configColors.objectsOptions.delete.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.delete.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.delete.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-5 ascwo-h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                </svg>
                                <p class="ascwo-text-[11px] ascwo-font-semibold">{{ configVisualiserTexts.textCanvasDelete && configVisualiserTexts.textCanvasDelete.trim() !== '' ? configVisualiserTexts.textCanvasDelete : 'Delete' }}</p>
                            </div>
    
                            <div @click="centerVertically()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.center.buttonColor}] ascwo-text-[${configColors.objectsOptions.center.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.center.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.center.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                                ...
                                <p class="ascwo-text-[11px] ascwo-font-semibold">{{ configVisualiserTexts.textCanvasCenterV && configVisualiserTexts.textCanvasCenterV.trim() !== '' ? configVisualiserTexts.textCanvasCenterV : 'CenterV' }}</p>
                            </div>
    
                            <div @click="centerHorizontally()" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.center.buttonColor}] ascwo-text-[${configColors.objectsOptions.center.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.center.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.center.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                                <svg focusable="false" viewBox="0 0 24 24" class="ascwo-w-5 ascwo-h-5">
                                ...
                                <p class="ascwo-text-[11px] ascwo-font-semibold">{{ configVisualiserTexts.textCanvasCenterH && configVisualiserTexts.textCanvasCenterH.trim() !== '' ? configVisualiserTexts.textCanvasCenterH : 'CenterH' }}</p>
                            </div>
                        </div>

                        <button v-if="finishButtonPosition == 'top'" :disabled="currentSizeData.width <= 0 || currentSizeData.height <= 0" v-show="!isLoaded" @click="finishConfig()" :class="`ascwo-hidden lg:ascwo-flex ascwo-full-center ascwo-w-fit ascwo-h-full ascwo-bg-[${configColors.recaps.buttonFinishBackgroundColor}] hover:ascwo-bg-[${configColors.recaps.buttonFinishHoverBackgroundColor}] ascwo-text-[${configColors.recaps.buttonFinishTextColor}] hover:ascwo-text-[${configColors.recaps.buttonFinishHoverTextColor}] ascwo-font-semibold ascwo-p-2 ascwo-px-6 ascwo-base-animation ascwo-cursor-pointer disabled:ascwo-cursor-not-allowed ascwo-buttons-rad-none`">
                        ...
                        <div v-if="!hidePricing" class="ascwo-flex lg:ascwo-hidden ascwo-full-center ascwo-space-x-1 ascwo-mr-1">
                            <p class="ascwo-text-xs">Qty:</p>
                            <input type="number" id="ascwo-quantity" name="ascwo-quantity" class="ascwo-w-[60px] ascwo-h-[20px] ascwo-p-1" min="1" v-model="configQuantity" @input="(e)=>{setQuantity()}" style=" height: 20px; width: 50px; ">
                        </div>
                        <div v-if="!hidePricing" :class="`ascwo-flex lg:ascwo-hidden ascwo-text-center ascwo-text-lg ascwo-font-semibold ascwo-text-[${configColors.bars.price.textBeforeColor}]`">
                            {{configVisualiserTexts.textBeforePrice}}
                        </div>
                        <div v-if="!hidePricing" :class="`ascwo-flex lg:ascwo-hidden ascwo-text-lg lg:ascwo-text-3xl ascwo-font-bold ascwo-text-center ascwo-text-[${configColors.bars.price.textColor}]`">
                            <!-- {{formatPrice(finalPrices)}}  -->
                            {{addformatToPrice(finalPrice)}} 
                        </div>
                        <div v-if="!hidePricing" :class="`ascwo-flex lg:ascwo-hidden ascwo-text-center ascwo-text-lg ascwo-font-semibold ascwo-text-[${configColors.bars.price.textAfterColor}]`">
                            {{configVisualiserTexts.textAfterPrice}}
                        </div>
                    </div>
                </div>
        
                <div :class="`ascwo-relative ascwo-w-full ascwo-h-[91%] lg:ascwo-h-[90%] ascwo-flex ascwo-flex-col ascwo-items-center ascwo-bg-[${configColors.canvas.backgroundColor}]`">
                    <div v-show="configDoublePart.active" class="ascwo-w-full ascwo-h-[6%] ascwo-flex ascwo-items-center ascwo-bg-white ascwo-space-x-3 ascwo-px-4 ascwo-border-y">
                        ...
                        <span @click="flipRect" :class="`ascwo-mx-2 ascwo-rounded-full ascwo-p-1.5 ascwo-font-medium ascwo-h-[80%] ascwo-w-fit ascwo-bg-[${configColors.backgroundColorHeader}]/30 ascwo-relative ascwo-flex ascwo-justify-between ascwo-items-center ascwo-border ascwo-cursor-pointer`">
                            <span :class="`${activeFace === 'front-face' ? 'ascwo-left-[1%]' : 'ascwo-translate-x-[105%] ascwo-right-[53%]'} ascwo-bg-[${configColors.optionsSideBar.options.modals.buttons.backgroundColor}] ascwo-translate-x ascwo-absolute ascwo-w-[50%] ascwo-h-[95%] ascwo-transition-all ease-in duration-200 z-0 ascwo-rounded-full ascwo-top-[5%]`"></span>
                    ...
                    <div id="ascwo-canvas-containers" :class="`flipper ascwo-relative ascwo-w-full ascwo-h-full lg:ascwo-h-[90%]`">
                    ...
                    <div :class="`ascwo-absolute ascwo-bottom-0 ascwo-w-full ascwo-h-[10%] ascwo-bg-[${configColors.bars.backgroundColor}]/60 ascwo-hidden lg:ascwo-flex ascwo-full-center ascwo-space-x-4`">
                        
                        <div :class="`${finishButtonPosition == 'top' ? `ascwo-w-1/5` : `ascwo-w-1/3`} ascwo-flex ascwo-justify-start ascwo-items-center ascwo-space-x-4 ascwo-px-6`">
                            <span @click="showConfigRender()" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.preview.backgroundColor}] ascwo-text-[${configColors.bars.preview.textColor}] hover:ascwo-bg-[${configColors.bars.preview.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.preview.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.preview.borderColor}] hover:ascwo-border-[${configColors.bars.preview.hoverBorderColor}] ascwo-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)]`">
                                <svg v-if="configSectionIcons.changeIconPreview === '' " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-4 ascwo-h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                </svg>
                            ...
                            <span v-if="props.config.data.settings.languageImages.uploadDesign.helpContent != ''" @click="()=> showHelpSection = !showHelpSection" :class="`ascwo-flex ascwo-p-1.5 ascwo-full-center ascwo-cursor-pointer ascwo-rounded-full ascwo-bg-[${configColors.bars.help.backgroundColor}] ascwo-text-[${configColors.bars.help.textColor}] hover:ascwo-bg-[${configColors.bars.help.hoverBackgroundColor}] hover:ascwo-text-[${configColors.bars.help.hoverTextColor}] ascwo-border-2 ascwo-border-[${configColors.bars.help.borderColor}] hover:ascwo-border-[${configColors.bars.help.hoverBorderColor}] ascwo-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)]`">
                                <svg v-if="configSectionIcons.changeIconHelp === '' " viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg" class="ascwo-w-4 ascwo-h-4">
                                    <path d="M9.375 9.92967C9.375 9.92967 9.45937 7.93162 11.3402 6.32955C12.457 5.37836 13.7982 5.10287 15 5.08592C16.0975 5.07199 17.0783 5.26392 17.6648 5.55939C18.6674 6.06677 20.625 7.30193 20.625 9.92967C20.625 12.6948 18.9152 13.9482 16.9717 15.3292C15.0281 16.7103 14.5312 18.0647 14.5312 19.6172" stroke="currentColor" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round"/>
                                    <path d="M14.5312 26.1556C15.5668 26.1556 16.4062 25.2882 16.4062 24.2181C16.4062 23.1481 15.5668 22.2806 14.5312 22.2806C13.4957 22.2806 12.6562 23.1481 12.6562 24.2181C12.6562 25.2882 13.4957 26.1556 14.5312 26.1556Z" fill="currentColor"/>
                                </svg>
                        ...
                        <div :class="`${finishButtonPosition == 'top' ? `ascwo-w-4/5` : `ascwo-w-2/3`} ascwo-h-full ascwo-flex ascwo-justify-end ascwo-items-center`">
                            <div v-if="!hidePricing" class="ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-mr-2">
                                <p class="ascwo-text-sm">Quantity:</p>
                                <input type="number" id="ascwo-quantity" name="ascwo-quantity" class="ascwo-w-[60px] ascwo-h-[20px] ascwo-p-1" min="1" v-model="configQuantity" @input="(e)=>{setQuantity()}" style=" height: 20px; width: 80px;">
                            </div>

                            <div v-if="!hidePricing" id="ascwo-price" :class="`ascwo-bg-[${configColors.bars.price.backgroundColor}]  ascwo-flex ascwo-full-center ascwo-space-x-2 ascwo-h-[90%] ascwo-px-2`">
                                <div :class="`ascwo-text-center ascwo-text-lg ascwo-font-semibold ascwo-text-[${configColors.bars.price.textBeforeColor}]`">
                                    {{configVisualiserTexts.textBeforePrice}}
                                </div>
                                <div :class="`ascwo-flex ascwo-text-[${configColors.bars.price.textColor}] ascwo-text-lg lg:ascwo-text-3xl ascwo-font-bold ascwo-text-center`">
                                    <!-- {{formatPrice(finalPrices)}} -->
                                    {{addformatToPrice(finalPrice)}}
                                </div>
                                <div :class="`ascwo-text-center ascwo-text-lg ascwo-font-semibold ascwo-text-[${configColors.bars.price.textAfterColor}]`">
                                    {{configVisualiserTexts.textAfterPrice}}
                                </div>
                            </div>

                            <div v-if="finishButtonPosition == 'top'" id="ascwo-editButtons" :class="`ascwo-bg-[${configColors.objectsOptions.backgroundColor}] ascwo-hidden lg:ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-p-2 ascwo-px-3 ascwo-rounded-lg`">
                                <div @click="editObject()" id="ascwo-editObject" :class="`${(activeCanvas !== null && (activeCanvas.getActiveObject() !== undefined && activeCanvas.getActiveObject() !== null)) ? `ascwo-cursor-pointer` : `ascwo-cursor-not-allowed` } ascwo-flex ascwo-full-center ascwo-space-x-1 ascwo-bg-[${configColors.objectsOptions.edit.buttonColor}] ascwo-text-[${configColors.objectsOptions.edit.textColor}] hover:ascwo-bg-[${configColors.objectsOptions.edit.hoverButtonColor}] hover:ascwo-text-[${configColors.objectsOptions.edit.hoverTextColor}] ascwo-base-animation ascwo-px-1 ascwo-rounded-md`">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-5 ascwo-h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                    </svg>
                            ...
                            <div v-if="finishButtonPosition == 'bottom'" class="ascwo-w-1/4 ascwo-h-full ascwo-flex ascwo-justify-end">
                                <button :disabled="currentSizeData.width <= 0 || currentSizeData.height <= 0" v-show="!isLoaded" @click="finishConfig()" :class="`ascwo-hidden lg:ascwo-flex ascwo-full-center ascwo-w-[80%] ascwo-h-full ascwo-bg-[${configColors.recaps.buttonFinishBackgroundColor}] hover:ascwo-bg-[${configColors.recaps.buttonFinishHoverBackgroundColor}] ascwo-text-[${configColors.recaps.buttonFinishTextColor}] hover:ascwo-text-[${configColors.recaps.buttonFinishHoverTextColor}] ascwo-font-semibold ascwo-p-2 ascwo-px-3 ascwo-base-animation ascwo-cursor-pointer disabled:ascwo-cursor-not-allowed ascwo-buttons-rad-none`">
                                    {{ configVisualiserTexts.textButtonFinish && configVisualiserTexts.textButtonFinish.trim() !== '' ? configVisualiserTexts.textButtonFinish : 'Finish' }}
                                </button>
                            </div>
                        </div>
                    ...
                    <div v-if="showHelpSection" :class="`ascwo-absolute ascwo-left-[2%] ascwo-bottom-0 ascwo-flex ascwo-flex-col lg:ascwo-translate-y-[-25%] ascwo-w-[250px] lg:ascwo-w-[350px] ascwo-h-[50%] ascwo-bg-[${configColors.optionsSideBar.options.modals.backgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.modals.textColor}]`">
            ...
            <div id="ascwo-optionsButtons-container" :class="`ascwo-relative ascwo-w-full ascwo-h-[8%] lg:ascwo-w-[8%] lg:ascwo-h-full ascwo-p-0 ascwo-flex ascwo-flex-col ascwo-shadow-lg ascwo-bg-[${configColors.optionsSideBar.backgroundColor}]`">
                <div v-if="isLoaded" class="ascwo-w-full ascwo-h-full ascwo-flex ascwo-flex-col">
                    <div class="ascwo-h-[90%] ascwo-flex ascwo-full-center ascwo-flex-row ascwo-space-x-4 lg:ascwo-space-x-0 lg:ascwo-flex-col lg:ascwo-space-y-4 ascwo-animate-pulse">
                        <div class="ascwo-w-[50px] lg:ascwo-w-[80%] ascwo-bg-gradient-to-r ascwo-from-zinc-400 ascwo-via-zinc-200 ascwo-to-zinc-400 ascwo-p-4 ascwo-h-[90%] lg:ascwo-h-[11%]"></div>
                        <div class="ascwo-w-[50px] lg:ascwo-w-[80%] ascwo-bg-gradient-to-r ascwo-from-zinc-400 ascwo-via-zinc-200 ascwo-to-zinc-400 ascwo-p-4 ascwo-h-[90%] lg:ascwo-h-[11%]"></div>
                        <div class="ascwo-w-[50px] lg:ascwo-w-[80%] ascwo-bg-gradient-to-r ascwo-from-zinc-400 ascwo-via-zinc-200 ascwo-to-zinc-400 ascwo-p-4 ascwo-h-[90%] lg:ascwo-h-[11%]"></div>
                        <div class="ascwo-w-[50px] lg:ascwo-w-[80%] ascwo-bg-gradient-to-r ascwo-from-zinc-400 ascwo-via-zinc-200 ascwo-to-zinc-400 ascwo-p-4 ascwo-h-[90%] lg:ascwo-h-[11%]"></div>
                        <div class="ascwo-w-[50px] lg:ascwo-w-[80%] ascwo-bg-gradient-to-r ascwo-from-zinc-400 ascwo-via-zinc-200 ascwo-to-zinc-400 ascwo-p-4 ascwo-h-[90%] lg:ascwo-h-[11%]"></div>
                ...
                <div v-show="!isLoaded" id="ascwo-options-buttons" class="ascwo-w-full ascwo-h-full ascwo-flex lg:ascwo-flex-col ascwo-items-center lg:ascwo-space-y-0 ascwo-py-4 ascwo-px-4 lg:ascwo-px-0 ascwo-overflow-auto no-scrollbar">
                    
                    <div v-for="(option, id) in activeConfigOptionAfterCondition" class="ascwo-w-[80%]">
                        <div v-if="option.type == 'materials' && option.active" @click="showOptions('material')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'material' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                                ...
                                <div class="ascwo-text-[10px] lg:ascwo-text-[13px] ascwo-leading-normal ascwo-font-medium ascwo-text-center ascwo-text-nowrap lg:ascwo-text-wrap">
                                    {{configVisualiserTexts.textMaterial}} 
                                </div>
                            </div>
                        </div>
                        
                        <div v-if="materialType == 'advance'" v-for="(component, id) in currentMaterial.data" class="ascwo-my-1" >
                        ...
                        <div v-if="option.type == 'sizes'" @click="showOptions('size')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'size' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'shapes'" @click="showOptions('shape')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'shape' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'fixing-methodes'" @click="showOptions('fixing-methode')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'fixing-methode' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'borders'" @click="showOptions('border')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'border' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'colors'" @click="showOptions('color')" :class="`ascwo-my-1`">
                        ...
                        <div v-if="option.type == 'texts'" @click="showOptions('text')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'text' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'images'" @click="showOptions('image')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'image' && addComponentId === id ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'qrcodes'" @click="showOptions('qr-code')" :class="`ascwo-my-1`">
                            <div :class="`${step === 'image' && addComponentId === id ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                        ...
                        <div v-if="option.type == 'additional-components'" v-for="(option, id) in additionalComponents" class="ascwo-my-1" >
                        ...
                        <div v-if="option.type == 'additional-options'" class="ascwo-my-1" >
                            <div @click="showOptions('add-options')" :class="`${step === 'add-options' ? `ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} ascwo-h-fit ascwo-flex ascwo-flex-col ascwo-full-center ascwo-space-y-1 ascwo-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] ascwo-px-4 ascwo-py-1 ascwo-rounded-lg ascwo-base-animation ascwo-cursor-pointer`">
                    ...
                    <div v-if="showScrollButton">
                        <div @click="ScrollLeft('ascwo-options-buttons')" :class="`ascwo-absolute ascwo-top-[0%] ascwo-left-0 ascwo-w-fit lg:ascwo-w-full ascwo-h-full lg:ascwo-h-fit ascwo-bg-[${configColors.optionsSideBar.scrollButtonsBackgroundColor}]/60 ascwo-text-[${configColors.optionsSideBar.scrollButtonsTextColor}] hover:ascwo-bg-[${configColors.optionsSideBar.scrollButtonsHoverBackgroundColor}]/60 hover:ascwo-text-[${configColors.optionsSideBar.scrollButtonsHoverTextColor}] ascwo-flex ascwo-full-center lg:ascwo-py-1 ascwo-cursor-pointer ascwo-base-animation`">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-7 ascwo-h-7 -ascwo-rotate-90 lg:ascwo-rotate-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                            </svg>                              
                        </div>
                        
                        <div @click="ScrollRight('ascwo-options-buttons')" :class="`ascwo-absolute ascwo-top-0 lg:ascwo-top-[100%] lg:ascwo-translate-y-[-100%] ascwo-right-0 lg:ascwo-left-0 ascwo-w-fit lg:ascwo-w-full ascwo-h-full lg:ascwo-h-fit ascwo-bg-[${configColors.optionsSideBar.scrollButtonsBackgroundColor}]/60 ascwo-text-[${configColors.optionsSideBar.scrollButtonsTextColor}] hover:ascwo-bg-[${configColors.optionsSideBar.scrollButtonsHoverBackgroundColor}]/60 hover:ascwo-text-[${configColors.optionsSideBar.scrollButtonsHoverTextColor}] ascwo-flex ascwo-full-center lg:ascwo-py-1 ascwo-cursor-pointer ascwo-base-animation`">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ascwo-w-7 ascwo-h-7 -ascwo-rotate-90 lg:ascwo-rotate-0">
            ...
            <div class="ascwo-w-full ascwo-flex-1 ascwo-min-h-0 lg:ascwo-w-fit lg:ascwo-h-fit">
                <div v-show="showOption" id="ascwo-options-container" :class="`ascwo-relative lg:ascwo-absolute ${desktopColumnPosition == 'left' ? `lg:ascwo-left-[8%]` : `lg:ascwo-right-[8%]`} lg:ascwo-top-[11%] ascwo-w-full ascwo-h-full ascwo-min-h-0 lg:ascwo-w-[35%] lg:ascwo-h-[70%] ascwo-bg-[${configColors.optionsSideBar.options.modals.backgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.modals.textColor}] ascwo-rounded-md lg:ascwo-shadow-xl ascwo-z-20`">
                    ...
                    <div v-show="step == 'shape'" class="ascwo-flex ascwo-flex-col lg:ascwo-space-y-2 ascwo-w-full ascwo-h-full" id="ascwo-shapes">
                        ...
                        <div class="ascwo-w-full ascwo-h-full ascwo-overflow-auto ascwo-scrollBar">
                    ...
                    <div v-show="step == 'color'" class="ascwo-flex ascwo-flex-col lg:ascwo-space-y-3 ascwo-w-full ascwo-h-full" id="ascwo-colors-section">
                        <p :class="`ascwo-hidden lg:ascwo-flex ascwo-bg-[${configColors.optionsSideBar.options.modals.headerBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.modals.headerTextColor}] ascwo-text-lg ascwo-font-semibold ascwo-p-2 ascwo-px-4`">
                    ...
                    <div v-show="step == 'text'" class="ascwo-flex ascwo-flex-col lg:ascwo-space-y-3 ascwo-w-full ascwo-h-full" id="ascwo-texts-section">
                        ...
                        <div class="ascwo-h-full ascwo-overflow-auto ascwo-scrollBar ascwo-space-y-2 ascwo-p-3">
                            ...
                            <div v-show="selectText" class="ascwo-space-y-2">
                                ...
                                <div v-if="configTextType == '3D'">
                                    ...
                                    <div class="ascwo-flex ascwo-flex-col ascwo-space-y-2">
                                        <p class="ascwo-font-semibold">3D effect</p>
                        ...
                        <span v-if="allowNextButton && lastActiveOption != 'texts'" @click="nextOption('texts')" :class="`ascwo-absolute ascwo-bottom-0 ascwo-translate-y-[100%] ascwo-translate-y-[100%] ascwo-left-0 ascwo-w-full ascwo-flex ascwo-bg-[${configColors.optionsSideBar.options.modals.buttons.backgroundColor}] hover:ascwo-bg-[${configColors.optionsSideBar.options.modals.buttons.hoverBackgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.modals.buttons.textColor}] hover:ascwo-text-[${configColors.optionsSideBar.options.modals.buttons.hoverTextColor}] font-semibold ascwo-text-md ascwo-full-center ascwo-border ascwo-py-1 ascwo-base-animation ascwo-cursor-pointer`">
                            Next
                        </span>
                    </div>
                ...
                <div class="ascwo-w-full ascwo-flex lg:ascwo-hidden ascwo-h-[15%] ascwo-bg-red-400">
        ...
        <div v-if="showImg" :class="`ascwo-absolute ascwo-top-0 ascwo-z-20 ascwo-bg-[${configColors.bars.reset.modalBackgroundColor}]/70 aso ascwo-w-full ascwo-h-full ascwo-flex ascwo-full-center ascwo-overflow-hidden`">
        ...
        <div v-if="route.name == 'template-maker'" v-show="showTempSettings" id="ascwo-templateObjects-options" :class="`ascwo-absolute ascwo-top-[11%] ascwo-right-0 ascwo-w-fit ascwo-h-fit ascwo-bg-[${configColors.optionsSideBar.options.modals.backgroundColor}] ascwo-text-[${configColors.optionsSideBar.options.modals.textColor}]`">
        ...
        <div v-if="finish" :class="`ascwo-absolute ascwo-top-0 ascwo-z-30 ascwo-w-full ascwo-h-full ascwo-flex ascwo-flex-col ascwo-bg-[${configColors.recaps.backgroundColor}]`">
            ...
            <div :class="`ascwo-flex ascwo-flex-col ascwo-flex-1 ascwo-overflow-auto ascwo-scrollBar ascwo-text-[${configColors.recaps.optionTextColor}]`">
                ...
                <!-- <div v-if="materialType === 'advance' && activeSignColor != '' " class="ascwo-flex ascwo-items-center ascwo-justify-between ascwo-w-full ascwo-px-4 ascwo-py-3 ascwo-border-b-2">
                    <div :class="`ascwo-w-1/3 ascwo-text-[#000000]`">
                        <p v-if="configVisualiserTexts.textColor" class="ascwo-text-[16px] text-black ascwo-font-semibold">{{configVisualiserTexts.textColor}}</p>
                        <p v-if="!configVisualiserTexts.textColor" class="ascwo-text-[16px] text-black ascwo-font-semibold">Color</p>
                    </div>
                    <p class="ascwo-text-[14px] ascwo-space-y-1 ascwo-flex ascwo-flex-col ascwo-items-center w-2/3 justify-end">
                        <div class="ascwo-flex ascwo-space-x-2 ascwo-full-center">
                            <span v-if="configDoublePart.active"  class="ascwo-font-medium">{{configDoublePart.part1}}: </span>
                            <span class="lowercase first-letter:uppercase">{{activeSignColor}}</span>
                            <span :class="`ascwo-h-fit ascwo-w-fit ascwo-p-[1px] ascwo-border ascwo-border-[${configColors.backgroundColorHeader}]`">
                                <img :src="activeSignColorCode1" class="ascwo-w-[35px] ascwo-h-[35px]" />
                            </span>
                        </div>
                ...
                <div v-if="materialType === 'simple' && (activeFace1Border != '' || activeFace2Border != '') " :class="`ascwo-flex ascwo-items-center ascwo-justify-between ascwo-px-4 ascwo-py-3 ascwo-border-b-2 ascwo-border-[${configColors.recaps.optionBorderColor}] hover:ascwo-bg-[${configColors.recaps.optionHoverBackgroundColor}] hover:ascwo-text-[${configColors.recaps.optionHoverTextColor}] hover:ascwo-bg-[${configColors.recaps.optionHoverBorderColor}] ascwo-base-animation`">
                    ...
                    <div class="ascwo-text-[14px] ascwo-space-y-1 ascwo-flex ascwo-flex-col ascwo-items-center w-2/3 justify-end">
                        <div class="ascwo-flex ascwo-space-x-2 ascwo-full-center">
                            ...
                            <div v-if="activeFace1Border !== 'none' && (signTextColor1.active && !colorForBorder1)" class="ascwo-flex ascwo-space-x-1 ascwo-full-center">
                            ...
                            <div v-if="activeFace1Border !== 'none' && colorForBorder1" class="ascwo-flex ascwo-space-x-1 ascwo-full-center">
                        ...
                        <div v-if="configDoublePart.active" class="ascwo-flex ascwo-space-x-2 ascwo-full-center">
                            ...
                            <div v-if="activeFace2Border !== 'none' && (signTextColor2.active && !colorForBorder2)" class="ascwo-flex ascwo-space-x-1 ascwo-full-center">
                            ...
                            <div v-if="activeFace2Border !== 'none' && colorForBorder2" class="ascwo-flex ascwo-space-x-1 ascwo-full-center">
        ...
        <div v-if="isLoading || removeBgImageLoading" class="ascwo-absolute ascwo-left-0 ascwo-top-0 ascwo-flex ascwo-justify-center ascwo-items-center ascwo-w-full ascwo-h-full ascwo-bg-black/30 ascwo-backdrop-blur-md ascwo-z-30">
            <span :class="`ascwo-flex ascwo-text-cyan-600`">
...
<script setup>
    ...
    function showOptions(option, stepValue, id){
        textSideHelp.value = false
        console.log("showOptions", option)
    ...
    async function selectTemplate(data, statut){
        ...
        if(sign.material.type === 'simple'){
            ...
            if(currentBorder != undefined){
                ...
                await handleSelectBorder(sign.border.face1.type, sign.border.face1.codeHex)
        ...
        if(shapees.value.length >0){
            ...
            while (index < matchingShapes.length && !haveDefault) {
                if(matchingShapes[index].shapee.isDefault){
                    if(matchingShapes[index].shapee.shapeSize){
                        handleGetOutlineSize(matchingShapes[index].shapee.shapeSize)
                        console.log(matchingShapes[index].shapee.shapeSize, "oooo")
                    }
            ...
            if(!haveDefault){
                if(matchingShapes[0].shapee.shapeSize){
                    handleGetOutlineSize(matchingShapes[0].shapee.shapeSize)
                }
    ...
    function checkScreenSize(width, height, fillFactor) {
        ...
        // Assurer que activeCanvas est défini
        if (!activeCanvas) {
            console.error("activeCanvas n'est pas défini. Le redimensionnement ne peut pas continuer.");
            return;
        }

        const safeObject = handleGetObjectByName("safeObject", activeCanvas);
        if (!safeObject) {
            console.error("safeObject introuvable. Le redimensionnement ne peut pas continuer.");
            return;
        }

        // Marge de sécurité pour ne pas coller aux bords (en pixels)
        const margin = 60;
        const availableWidth = canvasWidth - margin;
        const availableHeight = canvasHeight - margin;

        // Dimensions réelles de l'objet (sans le zoom actuel)
        const objectWidth = safeObject.width * safeObject.scaleX;
        const objectHeight = safeObject.height * safeObject.scaleY;

        let heightLine = handleGetObjectByName('heightLine', activeCanvas)
        let heightValue = handleGetObjectByName('height-value', activeCanvas)
        let heightDiff = (1.5) + (heightValue.width * heightValue.scaleX) + 100

        let widthLine = handleGetObjectByName('widthtLine', activeCanvas)
        let widthValue = handleGetObjectByName('width-value', activeCanvas)
        let widthDiff = (1.5) + (widthValue.height * widthValue.scaleY) + 30

        if (objectWidth <= 0 || objectHeight <= 0) {
            console.error("Les dimensions de safeObject sont invalides. Le redimensionnement ne peut pas continuer.");
            return;
        }
        ...
        const zoomX = availableWidth / newObjectWidth;
        const zoomY = availableHeight / newObjectHeight;
        // const zoomX = availableWidth / objectWidth;
        // const zoomY = availableHeight / objectHeight;
        // Le ratio de zoom final est le plus petit des deux pour que l'objet rentre entièrement
        let scaleRatio = Math.min(zoomX, zoomY);

        // Appliquer un facteur de remplissage supplémentaire si fourni
        if (fillFactor && fillFactor !== 0) {
            scaleRatio *= fillFactor;
        }

        // Appeler la fonction qui centre et applique le zoom
    ...
    function selectMaterial(material, id){
        ...
        handleGetMaterialType(material.type)
    ...
    async function selectSignModel(model, id){
        handleReadyToSaveState(false);
    ...
    async function selectBorder(border, settings, price, excludeShapes, excludeSizes, id, restart) {
        var border1Price = 0
        var border2Price = 0
        ...
        if(firstBorderCheck.value){
            var currentId = id
            var activeBorder = await handleSelectBorder(border)
    ...
    function changeBorderColor(colorHex, price, name){
        ...
        // console.log(borderColorName1.value, "activeFace1Border color", colorHex, price, name)
    ...
    async function removeBackground(){
        ...
        if(activeImg.name == "ascwo-SignImage" && activeImg.objectType == "no-svg"){
            ...
            // showLoader(false)
            removeBgImageLoading.value = false
    ...
    async function finishConfig(){
        ...
        configData.value = {
            ...
            printImage: await genImageWithoutFixing(canvas, 'svg'),
        ...
        if(configDoublePart.value.active){
            ...
            configData.value = {
                ...
                printImage: {
                    face1: await genImageWithoutFixing(canvas, 'svg'),
                    face2: await genImageWithoutFixing(canvasBack, 'svg'),
                },
                designImages: {
        ...
        if(showRecapAfterFinish.value == true){
            finish.value = true
    ...
    function getActiveConfigSections(configOptions) {
        return configOptions.filter(option => {
            ...
            switch (option.type) {
                case 'materials':
                    // Condition divisée en deux parties comme dans le template
                    return allMaterials.value.length > 1 || 
                        (materialType.value === 'advance' && currentMaterial.value?.data?.length > 0);

                case 'sizes':
                    return materialType.value === 'simple' && 
                        (sizees.value.length > 0 || customSizeActive.value);

                case 'shapes':
                    return materialType.value === 'simple' && 
                        shapees.value.length > 0;

                case 'fixing-methodes':
                    return fixinggs.value.length > 0;

                case 'borders':
                    return materialType.value === 'simple' && 
                        borderrs.value.allBorders.length > 0;

                case 'colors':
                    return (materialType.value === 'simple' && 
                        (sizees.value.length > 0 || customSizeActive.value)) ||
                        (materialType.value === 'advance' && 
                        advancedComponent.value?.options?.length > 0);

                case 'texts':
                    return (materialType.value === 'simple' && 
                        currentMaterialTextImages.value.enableText && 
                        (sizees.value.length > 0 || customSizeActive.value)) ||
                        (materialType.value === 'advance' && 
                        advancedComponent.value?.options?.length > 0);
                ...
                case 'images':
                    return (materialType.value === 'simple' && 
                        currentMaterialTextImages.value.enableImage && 
                        (sizees.value.length > 0 || customSizeActive.value)) ||
                        (materialType.value === 'advance' && 
                        advancedComponent.value?.options?.length > 0);
                ...
                case 'qrcodes':
                    return (materialType.value === 'simple' && 
                        currentMaterialTextImages.value.enableQrCode && 
                        (sizees.value.length > 0 || customSizeActive.value)) ||
                        (materialType.value === 'advance' && 
                        advancedComponent.value?.options?.length > 0);
                ...
                case 'additional-components':
                    return materialType.value === 'simple' && 
                        additionalComponents.value.length > 0;

                case 'additional-options':
                    return configAdditionnalOptions.value.length > 0;
    ...
    //     let nextFormatedStep
    //     if(materialType.value == "simple"){
    //         if(option == "additional-components"){
    //             if(additionalComponents.value.length > 0 && addComponentId.value < additionalComponents.value.length - 1){
    //                 showOptions("add-options", additionnalOptions.value[addComponentId.value+1], addComponentId.value+1)
    //             }
    //         }else{
    //             let nextStep = getNextOption(option)
    //             if(nextStep){
    //                 if(nextStep.type == "qrcodes"){
    //                     nextFormatedStep = "qr-code"
    //                 }else if(nextStep.type == "additional-options"){
    //                     nextFormatedStep = "add-options"
    //                 }else if(nextStep.type == "additional-components"){
    //                     nextFormatedStep = "add-components"
    //                 }else{
    //                     nextFormatedStep = nextStep.type.replace(/s$/, '')
    //                 }
    //             }
    //             if(nextFormatedStep == "add-components"){
    //                 showOptions(nextFormatedStep, additionalComponents.value[0], 0)
    //             }else{
    //                 showOptions(nextFormatedStep)
    //             }
    //         }
    //     }else{
    //         console.log("material advance", currentMaterial.value.data.length)
    //         if(option == "additional-components"){
    //             if(advancedComponent.value?.options?.length > 0 && addComponentId.value < advancedComponent.value.options.length - 1){
    //                 showOptions("add-options", advancedComponent.value.options[addComponentId.value+1], addComponentId.value+1)
    //             }
    //         }else if(option == "materials"){
    //             // if(currentMaterial.value.data.length > 0 && advancedComponentId.value < currentMaterial.value.data.length - 1){
    //             if(currentMaterial.value.data.length > 0){
    //                 showOptions("component", currentMaterial.value.data[0], 0) 
    //             }
    //         }else if(option == "components"){
    //             if(currentMaterial.value.data.length > 0 && advancedComponentId.value < currentMaterial.value.data.length - 1){
    //                 showOptions("component", currentMaterial.value.data[advancedComponentId.value + 1], advancedComponentId.value + 1) 
    //             }else{
    //                 let nextStep = getNextOption("materials")
    //                 if(nextStep){
    //                     if(nextStep.type == "qrcodes"){
    //                         nextFormatedStep = "qr-code"
    //                     }else if(nextStep.type == "additional-options"){
    ...
    //                 }
    //                 if(nextFormatedStep == "add-components"){
    //                     showOptions(nextFormatedStep, advancedComponent.value.options[0], 0)
    //                 }else{
    //                     showOptions(nextFormatedStep)
    //                 }
    //             }
    ...
    //     console.log(activeConfigOptionAfterCondition.value, "activeConfigOptionAfterCondition", nextFormatedStep)

    // }
    function nextOption(option) {
        const formatStep = (type) => {
            const mapping = {
                'qrcodes': 'qr-code',
                'additional-options': 'add-options',
                'additional-components': 'add-components'
            };
            return mapping[type] || type.replace(/s$/, '');
        };
        ...
        const handleSimpleMode = () => {
            ...
            const nextStep = getNextOption(option);
            if (!nextStep) return;

            const formattedStep = formatStep(nextStep.type);
            if (formattedStep === "add-components") {
                showOptions(formattedStep, additionalComponents.value[0], 0);
            } else {
                showOptions(formattedStep);
            }
        };
        ...
        const handleAdvancedMode = () => {
            ...
            if (option === "components") {
                if (currentMaterial.value.data.length > 0 && advancedComponentId.value < currentMaterial.value.data.length - 1) {
                    ...
                    const nextStep = getNextOption("materials");
                    if (!nextStep) return;

                    const formattedStep = formatStep(nextStep.type);
                    if (formattedStep === "add-components") {
                    showOptions(formattedStep, advancedComponent.value.options[0], 0);
                    } else {
                    showOptions(formattedStep);
                    }
                }
        ...
        materialType.value === "simple" ? handleSimpleMode() : handleAdvancedMode();
        console.log(activeConfigOptionAfterCondition.value, "activeConfigOptionAfterCondition");
    }

    function getNextOption(currentOption) {                
        // Cas où aucune option n'est disponible
        if (activeConfigOptionAfterCondition.value.length === 0) return null;
        
        // Cas où aucune option n'est spécifiée (premier appel)
        if (!currentOption) return activeOptions[0];
        
        // Trouver l'index de l'option actuelle
        const currentIndex = activeConfigOptionAfterCondition.value.findIndex(opt => opt.type === currentOption);
        
        // Si l'option n'est pas trouvée (peut-être désactivée) ou est la dernière
        if (currentIndex === -1 || currentIndex === activeConfigOptionAfterCondition.value.length - 1) {
            return activeConfigOptionAfterCondition.value[0]; // Retourner à la première option
        }
        
        // Retourner l'option suivante
        return activeConfigOptionAfterCondition.value[currentIndex + 1];
    }
    

    let showRecapAfterFinish = ref(true)
    let finishButtonPosition = ref("top")
    let desktopColumnPosition = ref("left")
    ...
    onMounted(async() => {
        ...
        try{
            ...
            hidePricing.value = (configSettings.value.generals.product.hidePricing && configSettings.value.generals.product.hidePricing == true) ? true : false
            configOptions.value = configSettings.value.generals.product.configOptions ? configSettings.value.generals.product.configOptions : configOptions.value
            activeConfigOption.value = configOptions.value.filter(option => option.active === true);
            showRecapAfterFinish.value = configSettings.value.generals.product.showRecapAfterFinish ? configSettings.value.generals.product.showRecapAfterFinish : showRecapAfterFinish.value
            
            desktopColumnPosition.value = configSettings.value.customizerSign.customizerOptions.desktopColumnOrder
            finishButtonPosition.value = (configSettings.value.customizerSign.customizerOptions?.finishButtonPosition ? configSettings.value.customizerSign.customizerOptions?.finishButtonPosition : 'bottom')

            handleGetImageSettings(configImageSettings.value)
            // console.log(configSettings.value.customizerSign.customizerOptions, "777")
            ...
            activeConfigOptionAfterCondition.value = getActiveConfigSections(activeConfigOption.value)
            lastActiveOption.value = activeConfigOptionAfterCondition.value[activeConfigOptionAfterCondition.value.length - 1].type
