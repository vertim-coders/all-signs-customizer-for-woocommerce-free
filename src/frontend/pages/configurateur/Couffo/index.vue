<template>
    <div id="aso-frontend-app" class="aso-relative aso-flex aso-flex-row-reverse aso-w-full aso-h-[100vh]">

        <div class="aso-w-full lg:aso-w-[92%] aso-h-full aso-flex aso-flex-col">
            <div class="aso-w-full aso-h-[7%] lg:aso-h-[10%] aso-bg-gradient-to-r aso-from-[#016464] aso-to-[#038888] aso-flex aso-items-center aso-justify-between">
                ...
                <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-justify-center aso-items-center">
                    <div class="aso-flex lg:aso-hidden aso-text-[#FFBC3C] lg:aso-text-black aso-text-lg lg:aso-text-3xl aso-font-bold aso-text-center">
                        $ 495,09
                    </div>
                </div>
            </div>
            ...
            <div class="aso-relative aso-w-full aso-h-[93%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[#f5f5f5]">
                <div id="aso-canvas-containers" class="aso-relative aso-w-full aso-h-[54%] lg:aso-h-[82%] aso-border-4 aso-border-black">
        ...
        <div id="aso-optionsButtons-container" class="aso-relative aso-w-[8%] aso-h-full aso-p-0 aso-flex aso-flex-col aso-shadow-lg aso-bg-black">
            ...
            <div v-show="!isLoaded" class="aso-w-full aso-h-full aso-flex aso-flex-col aso-items-center aso-space-y-4 aso-py-4 aso-overflow-auto no-scrollbar">
                <div @click="showOptions('product')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div @click="showOptions('size')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div @click="showOptions('shape')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="mdi:shape">
                ...
                <div @click="showOptions('fixing-methode')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div @click="showOptions('border')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div @click="showOptions('color')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div @click="showOptions('text')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div @click="showOptions('image')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-6 aso-h-6">
        ...
        <div>
            <div v-show="showOption" id="aso-options-container" class="aso-relative lg:aso-absolute lg:aso-left-[8%] lg:aso-top-[10%] aso-w-full lg:aso-w-[30%] aso-h-[32%] lg:aso-h-[70%] aso-bg-white aso-rounded-md aso-shadow-xl">
                ...
                <div v-show="step == 'size'" class="aso-flex aso-flex-col lg:aso-space-y-2 aso-w-full aso-h-full" id="aso-sizes-section">
                    ...
                    <div class="aso-w-full aso-h-full aso-space-y-2 aso-p-4 aso-overflow-auto aso-scrollBar">
                        ...
                        <div class="aso-space-y-2">
                            ...
                            <span @click="changeSize(customWidth, customHeight)" class="aso-w-full aso-bg-[#016464] aso-text-white hover:aso-bg-[#029797] font-semi-bold aso-text-sm aso-border aso-px-2 aso-p-1 aso-rounded-md aso-base-animation">Done</span>
                        </div>
                        ...
                        <div class="aso-space-y-2">
                            ...
                            <div class="aso-flex aso-space-x-2">
                                <div class="aso-w-full aso-flex aso-flex-col aso-space-y-2">
                                    <!-- <label class="aso-text-xs" for="sizeWidth">{{ customWidth }}</label> -->
                                    <input class="aso-w-full aso-border aso-border-zinc-600 aso-p-1 aso-rounded-sm" type="number" name="" id="aso-thickness" max="" >
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="aso-w-full aso-h-full aso-p-3 aso-overflow-auto aso-scrollBar">
                        ...
                        <div class="aso-flex aso-flex-wrap aso-gap-2 aso-p-1">
                            <div v-for="(color, index) in colors" >
                                <div @click="changeSignColor(color)" :class="`${activeSignColor == color.name ? `aso-border-4 aso-border-[#016464]` : `` } aso-w-10 aso-h-10 aso-bg-[${color.code}] aso-flex aso-full-center aso-font-bold aso-text-lg aso-text-black aso-rounded-full aso-cursor-pointer`"> T </div>
                            </div>
                ...
                <div v-show="step == 'image'" class="aso-flex aso-flex-col lg:aso-space-y-3 aso-w-full aso-h-full" id="aso-images-section">
                    ...
                    <div class="aso-w-full aso-h-full aso-space-y-2 aso-p-2 aso-overflow-auto aso-scrollBar">
                        <div class="aso-w-full aso-bg-zinc-200 aso-flex aso-flex-col aso-space-y-3 aso-full-center aso-p-4">
                            <span @click="() =>{editImage = false}" class="aso-w-3/4 aso-flex aso-full-center aso-space-x-3 aso-bg-[#016464] aso-text-white aso-text-md aso-p-2 aso-px-4 aso-rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-6 aso-h-6">
...
// import { fabric } from 'fabric';
    ...
    function changeSignColor(color) {
        ...
        console.log(activeSignColor.value)
    }
