                    ...
                    <div @click="() => showStateButtons = !showStateButtons" v-show="!isLoaded" :class="`asowp-relative asowp-flex lg:asowp-hidden asowp-w-1/4 asowp-pl-2 asowp-justify-start asowp-text-[${configColors.bars.titleColor}]`">
                        ...
                        <div v-if="showStateButtons" :class="`asowp-absolute asowp-bottom-0 asowp-translate-y-[110%] asowp-z-10 asowp-flex asowp-bg-[${configColors.bars.backgroundColor}] asowp-fit asowp-full-center asowp-space-x-3 asowp-px-2`">
                            ...
                            <span @click="redo" :class="`asowp-w-fit asowp-h-fit asowp-flex asowp-full-center asowp-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] asowp-p-2 asowp-rounded-full asowp-bg-[${configColors.bars.undoRedo.backgroundColor}] asowp-text-[${configColors.bars.undoRedo.textColor}] hover:asowp-bg-[${configColors.bars.undoRedo.hoverBackgroundColor}] hover:asowp-text-[${configColors.bars.undoRedo.hoverTextColor}] asowp-border-2 asowp-border-[${configColors.bars.undoRedo.borderColor}] hover:asowp-border-[${configColors.bars.undoRedo.hoverBorderColor}] asowp-base-animation asowp-cursor-pointer`">
                                <svg v-if="configSectionIcons.icon === '' " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="asowp-w-4 asowp-h-4 lg:asowp-w-5 lg:asowp-h-5">
                    ...
                    <div id="asowp-optionsButtons-container" :class="`asowp-w-full asowp-relative asowp-px-10 lg:asowp-px-2 lg:asowp-w-[60%] asowp-h-[8%] lg:asowp-h-[15%] asowp-flex asowp-full-center asowp-bg-[${configColors.backgroundColorHeader}] asowp-text-[${configColors.textColorContentHeader}] lg:asowp-bg-transparent`">
                        ...
                        <div v-show="!isLoaded" id="asowp-options-buttons" class="asowp-scrollDiv asowp-flex asowp-items-center asowp-w-full asowp-h-fit asowp-p-0.5 asowp-overflow-x-auto asowp-scrollBar">
                            ...
                            <div v-for="(option, id) in activeConfigOption" :key="option.type" class="asowp-w-fit asowp-h-[90%] asowp-flex"> 
                                ...
                                <div v-if="option.type == 'materials' && materialType == 'advance'" v-for="(component, id) in currentMaterial.data" class="asowp-cardDiv" >
                                ...
                                <div v-if="materialType == 'simple' && option.type == 'sizes' && (sizees.length > 0 || customSizeActive)" @click="showOptions('size')" :class="`${step === 'size' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'shapes' && shapees.length > 0 && materialType == 'simple'" @click="showOptions('shape')" :class="`${step === 'shape' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'fixing-methodes' && fixinggs.length > 0" @click="showOptions('fixing-methode')" :class="`${step === 'fixing-methode' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'borders' && materialType == 'simple' && borderrs.allBorders.length > 0" @click="showOptions('border')" :class="`${step === 'border' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'colors' && ((materialType == 'simple' && (sizees.length > 0 || customSizeActive)) || (materialType == 'advance' && advancedComponent.options.length > 0))" @click="showOptions('color')" :class="`${step === 'color' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'texts' && ((materialType == 'simple' && currentMaterialTextImages.enableText && (sizees.length > 0 || customSizeActive)) || (materialType == 'advance' && advancedComponent.options.length > 0))" @click="showOptions('text')" :class="`${step === 'text' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'images' && ((materialType == 'simple' && currentMaterialTextImages.enableImage && (sizees.length > 0 || customSizeActive)) || (materialType == 'advance' && advancedComponent.options.length > 0))" @click="showOptions('image')" :class="`${step === 'image' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'qrcodes' && ((materialType == 'simple' && currentMaterialTextImages.enableQrCode && (sizees.length > 0 || customSizeActive)) || (materialType == 'advance' && advancedComponent.options.length > 0))" @click="showOptions('qr-code')" :class="`${step === 'qr-code' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
                                ...
                                <div v-if="option.type == 'additional-components' && (materialType == 'simple' && additionalComponents.length > 0 )" v-for="(option, id) in additionalComponents" class=" asowp-cardDiv" >
                                ...
                                <div v-if="option.type == 'additional-options' && configAdditionnalOptions.length > 0" @click="showOptions('add-options')" :class="`${step === 'add-options' ? `asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}]` : ``} asowp-flex asowp-flex-col asowp-full-center asowp-space-y-1  asowp-bg-[${configColors.optionsSideBar.options.buttons.backgroundColor}] hover:asowp-bg-[${configColors.optionsSideBar.options.buttons.hoverBackgroundColor}] asowp-text-[${configColors.optionsSideBar.options.buttons.textColor}] hover:asowp-text-[${configColors.optionsSideBar.options.buttons.hoverTextColor}] asowp-px-4 asowp-py-1 asowp-rounded-lg lg:asowp-shadow-[-10px_0px_10px_-1px_#e0e0e0] asowp-base-animation asowp-cursor-pointer asowp-cardDiv`">
...
const route = useRoute();
    ...
    function cleanDecimalInput(input) {
        ...
        // Construire la partie entière et décimale
    ...
    onMounted(async() => {
        ...
        try{
            ...
            // console.log(configOptions.value, "777", materialType.value)
