<template> 
    <div class="asowp-relative asowp-flex asowp-w-full asowp-h-full">
        ...
        <div v-if="finish" :class="`asowp-config-recap asowp-absolute asowp-top-0 asowp-z-30 asowp-w-full asowp-h-[100%] asowp-flex asowp-flex-col asowp-bg-[${configColors.recaps.backgroundColor}]`">
...
<script setup>
    ...
    function isEditingFieldOnMobile() {
        if (window.innerWidth >= 688) {
            return false;
        }
