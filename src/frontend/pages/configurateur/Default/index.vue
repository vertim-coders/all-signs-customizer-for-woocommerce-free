        ...
        <div class="aso-relative aso-flex aso-w-full aso-h-full">
            <div class="aso-w-full lg:aso-w-[92%] aso-h-full aso-flex aso-flex-col">
                ...
                <div class="aso-relative aso-w-full aso-h-[93%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[#f5f5f5]">
                    ...
                    <div id="aso-optionsButtons-container" :class="`aso-w-full aso-relative lg:aso-w-[95%] aso-h-[8%] lg:aso-h-[15%] aso-flex aso-full-center aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] lg:aso-bg-transparent`">
                        ...
                        <div v-show="!isLoaded" class="aso-w-full aso-h-full aso-flex aso-full-center aso-overflow-auto no-scrollbar">
                            ...
                            <div v-if="materialType == 'advance'" v-for="(component, id) in currentMaterial.data" class="aso-w-fit aso-h-[90%]" >
                                <div @click="showOptions('component', component)" :class="`aso-w-fit aso-h-full aso-flex aso-flex-col aso-full-center aso-space-y-1 lg:aso-bg-[${configColors.backgroundButton}] lg:hover:aso-bg-[${configColors.backgroundColorHoverButton}] lg:aso-text-[${configColors.textColorButton}] lg:hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-rounded-lg lg:aso-shadow-[-7px_1px_15px_0px_#828282] aso-base-animation`">
                            ...
                            <div v-if="fixinggs.length > 0" @click="showOptions('fixing-methode')" :class="`aso-w-fit aso-h-[90%] aso-flex aso-flex-col aso-full-center aso-space-y-1 lg:aso-bg-[${configColors.backgroundButton}] lg:hover:aso-bg-[${configColors.backgroundColorHoverButton}] lg:aso-text-[${configColors.textColorButton}] lg:hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-rounded-lg lg:aso-shadow-[-7px_1px_15px_0px_#828282] aso-base-animation`">
                                <svg v-if="configSectionIcons.changeIconFixingMethod === '' " class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="uil:screw">
                                ...
                                <img v-if="configSectionIcons.changeIconFixingMethod !== '' " :src="configSectionIcons.changeIconFixingMethod" class="aso-w-6 aso-h-6" />
                            ...
                            <div v-if="materialType == 'simple'" @click="showOptions('color')" :class="`aso-w-fit aso-h-[90%] aso-flex aso-flex-col aso-full-center aso-space-y-1 lg:aso-bg-[${configColors.backgroundButton}] lg:hover:aso-bg-[${configColors.backgroundColorHoverButton}] lg:aso-text-[${configColors.textColorButton}] lg:hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-rounded-lg lg:aso-shadow-[-7px_1px_15px_0px_#828282] aso-base-animation`">
                            ...
                            <div v-if="(materialType == 'simple' && additionalComponents.length > 0 )" v-for="(option, id) in additionalComponents" class="aso-w-fit aso-h-[90%]" >
                                <div @click="showOptions('add-components', option)" :class="`aso-w-fit aso-h-full aso-flex aso-flex-col aso-full-center aso-space-y-1 lg:aso-bg-[${configColors.backgroundButton}] lg:hover:aso-bg-[${configColors.backgroundColorHoverButton}] lg:aso-text-[${configColors.textColorButton}] lg:hover:aso-text-[${configColors.textColorHoverButton}] aso-px-4 aso-rounded-lg lg:aso-shadow-[-7px_1px_15px_0px_#828282] aso-base-animation`">
                    ...
                    <div v-show="showOption" id="aso-options-container" :class="`aso-relative lg:aso-absolute lg:aso-left-4 lg:aso-top-[20%] lg:aso-translate-y-[-20%] aso-w-full lg:aso-w-[30%] aso-h-[32%] lg:aso-h-[70%] aso-bg-[${configColors.backgroundColorOptionsMenu}] aso-text-[${configColors.textColorOptionsMenu}] aso-rounded-md lg:aso-shadow-xl`">
                        ...
                        <div class="aso-w-full aso-h-full aso-p-4 aso-overflow-auto aso-scrollBar">
                            <div v-for="(material, index) in props.config.data.materials" class="aso-space-y-3">
                                ...
                                <label :for="material.name + index" class="aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer">
                        ...
                        <div v-show="step == 'component'" class="aso-flex aso-flex-col lg:aso-space-y-3 aso-w-full aso-h-full" id="aso-products-section">
                            ...
                            <div class="aso-w-full aso-h-full aso-p-4 aso-overflow-auto aso-scrollBar">
                                <div v-for="(option, index) in advancedComponent.options" class="aso-space-y-3">
                                    ...
                                    <label :for="'aso-model' + option.name + option.size.width + index" class="aso-flex aso-full-center aso-space-x-2">
                        ...
                        <div v-show="step == 'size'" class="aso-flex aso-flex-col lg:aso-space-y-2 aso-w-full aso-h-full" id="aso-sizes-section">
                            ...
                            <div class="aso-w-full aso-h-full aso-space-y-2 aso-p-4 aso-overflow-auto aso-scrollBar">
                                ...
                                <div v-if="customSizeActive" class="aso-space-y-2 aso-w-full">
                                    ...
                                    <span @click="changeSize(customSizeValues)" :class="`aso-w-full aso-flex aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] font-semi-bold aso-text-sm aso-full-center aso-border aso-px-2 aso-p-1 aso-rounded-md aso-base-animation`">
                                        ...
                                        <div v-for="(shape, index) in allShapes" :key="shape.name" class="aso-w-full aso-flex">
                                            <div class="aso-w-full aso-flex" v-if="shapee.shapeId == index">
                                                ...
                                                >
                                                    ...
                                                    <p>{{shape.name}}</p>
                                                    <p class="aso-text-[11px] aso-leading-normal">({{shapee.additionalPrice}} {{props.currency}})</p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div v-if="materialType === 'simple'" class="aso-w-full aso-h-full aso-space-y-2 aso-p-3 aso-overflow-auto aso-scrollBar">
                                <div class="aso-flex aso-flex-wrap aso-gap-2 aso-p-1">
                                    <div v-for="(colorr, id) in colorrs.allColors" class="aso-flex aso-flex-col aso-full-center aso-space-y-2">
                                        ...
                                        <p class="aso-text-[11px] aso-leading-normal">({{colorr.additionalPrice}} {{props.currency}})</p>
                                    </div>
                                </div>
                                        ...
                                        <div v-for="(border, index) in allBorders" :key="border.name" class="aso-w-full aso-flex">
                                            <div v-if="borderr.manageBorderId == index && (!borderr.excludeShapes.includes(currentShapeId) && !borderr.excludeSizes.includes(currentSizeId))">
                                                ...
                                                >
                                                    ...
                                                    <p>{{border.name}}</p>
                                                    <p class="aso-text-[11px] aso-leading-normal">({{borderr.additionalPrice}} {{props.currency}})</p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div v-show="step == 'image'" class="aso-flex aso-flex-col lg:aso-space-y-3 aso-w-full aso-h-full" id="aso-images-section">
                            ...
                            <div class="aso-w-full aso-h-full aso-space-y-2 aso-p-2 aso-overflow-auto aso-scrollBar">
                                <div class="aso-w-full aso-bg-zinc-200 aso-flex aso-flex-col aso-space-y-3 aso-full-center aso-p-4">
                                    <span v-if="configImageSettingsClipart.active" @click="() =>{editImage = false; showClipart = false}" :class="`aso-w-3/4 aso-flex aso-full-center aso-space-x-3 aso-text-[${configColors.backgroundButton}] aso-border aso-border-solid aso-border-[${configColors.backgroundButton}] aso-text-md aso-p-2 aso-px-4 aso-rounded-full`">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-6 aso-h-6">
                                                ...
                                                <div v-if="showClipart && clipartId == index">
                                                    <div class="aso-flex aso-flex-wrap aso-gap-2 aso-p-1">
                                                        <div v-for="(image, id) in currentClipart">
                                                            <div @click="addImageToSign(image.url, image.title, image.additionalPrice, id)" class="aso-flex aso-flex-col aso-space-y-2 aso-full-center aso-p-1 aso-border aso-cursor-pointer">
                                                                ...
                                                                <p class="aso-text-[11px] aso-leading-normal">({{image.additionalPrice}} {{props.currency}})</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div v-if="materialType == 'simple'" class="aso-w-full aso-h-full aso-p-4 aso-overflow-auto aso-scrollBar">
                                <div v-for="(option, index) in addComponentValue.options">
                                    <div class="aso-space-y-3 aso-w-full aso-h-full">
                                        ...
                                        <label :for="'aso-addOptions' + addComponentValue.title + option.title + index" class="aso-flex aso-full-center aso-space-x-2 aso-cursor-pointer">
                                            <div :class="`${option.icon === '' ? `aso-bg-[${configColors.backgroundColorHeader}]` : `` } aso-w-1/4 aso-h-20`">
                                                <img v-if="option.icon != ''" :src="option.icon" class="aso-w-full aso-h-full" />
                                            </div>
                                            <div :class="`aso-w-3/4 aso-flex aso-flex-col aso-space-y-1 aso-text-[${configColors.textColorOptionsMenu}]`">
                        ...
                        <div v-show="step == 'add-options'" class="aso-flex aso-flex-col lg:aso-space-y-1 aso-w-full aso-h-full" id="aso-fixings-section">
                            <p :class="`aso-hidden lg:aso-flex aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] aso-text-lg aso-font-semibold aso-p-2 aso-px-4`">{{props.config.data.settings.languageImages.visualizer.textFixingMethods}}</p>    
        
                            <div class="aso-w-full aso-h-full aso-space-y-2 aso-p-4 aso-overflow-auto aso-scrollBar">
                                <div v-for="(option, indexx) in configAdditionnalOptions">
                                    <div v-if="option.type == 'yes/no'" class="aso-w-full">
                                        <div class="aso-flex aso-flex-col aso-space-y-2 aso-w-full aso-relative">
                                            ...
                                            <div v-if="showYesNo && yesNoIndex == indexx" :class="`aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.backgroundColorHeader}] aso-absolute aso-top-0 aso-right-[0%] aso-w-[75%] aso-h-auto aso-p-2 aso-z-10`">
                                                <div :class="`aso-cursor-pointer aso-flex aso-items-center aso-justify-center aso-bg-[${configColors.backgroundColorHeader}] aso-absolute aso-right-0 aso-top-0 aso-p-1`" @click="()=>showYesNoExample()">
                                                ...
                                                <img :src="showYesNoImg" class="aso-w-full aso-h-full">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="option.type == 'image-input'">
                                        <div class="aso-flex aso-flex-col aso-space-y-2 aso-w-full">
                                            ...
                                            <div class="aso-grid aso-grid-cols-4 lg:aso-grid-cols-2 xl:aso-grid-cols-4 aso-gap-4 aso-relative">
                                                <div v-for="(element, index) in option.options" class="">
                                                    ...
                                                    <div v-if="inputImageExample && inputImageIndex == index && inputImageLabel == element.label" :class="`aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.backgroundColorHeader}] aso-absolute -aso-bottom-1 aso-left-[10%] aso-w-[75%] aso-h-auto aso-p-2 aso-z-10`">
                                                        <div :class="`aso-cursor-pointer aso-flex aso-items-center aso-justify-center aso-bg-[${configColors.backgroundColorHeader}] aso-absolute aso-right-0 aso-top-0 aso-p-1`" @click="showInputImageExample()">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="aso-w-6 aso-h-6">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                                            </svg>
                                                        </div>
                                    ...
                                    <div v-if="option.type == 'dropdown'" class="aso-relative aso-space-y-4">
                                        <div class="aso-space-y-2 aso-w-full aso-relative">
                                            <div class="aso-flex aso-justify-between aso-items-start aso-space-x-3">
                                                <div>
                                                    <p :class="`aso-text-[${configColors.backgroundColorHeader}] aso-font-medium lowercase first-letter:uppercase aso-text-[16px]`">{{ option.label }}</p>
                                                    <p :class="` aso-text-xs lowercase first-letter:uppercase`">{{ option.description }}</p>
                                            ...
                                            <select id="" class="aso-w-full aso-p-2 aso-border-[1.5px] border-zinc-400 aso-rounded-lg aso-text-base" :name="option.label.toLowerCase().replace(/\s+/g, '-') " @change="(e)=>addToOrUpdateArray(customAdditionalValues, indexx, option.label, dropdownValue.value, dropdownValue.price)" v-model="dropdownValue">
                                            ...
                                            <div v-if="dropdownExample && dropdownIndex == indexx && dropdownExampleImg != ''" :class="`aso-absolute aso-top-0 aso-right-[0%] aso-w-[75%] aso-h-auto aso-p-2 aso-z-10 aso-text-[${configColors.backgroundColorHeader}] aso-bg-[${configColors.backgroundColorHeader}]`">
                                                <div :class="`aso-cursor-pointer aso-flex aso-items-center aso-justify-center aso-bg-[${configColors.backgroundColorHeader}] aso-absolute aso-right-0 aso-top-0 aso-p-1`" @click="()=>showDropdownExample()">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="aso-w-6 aso-h-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                                    </svg>
                                                </div>
                                    ...
                                    <div v-if="option.type == 'note'">
                                        <div class="aso-flex aso-flex-col aso-space-y-2 aso-w-full">
                                            ...
                                            <div class="aso-w-full">
                                                <textarea  @input="(e)=>addToOrUpdateArray(customAdditionalValues, indexx, option.label, e.target.value)"  :maxlength="option.noteLimitChar" :name="option.label.toLowerCase().replace(/\s+/g, '-') " id="" cols="20" rows="10" class="aso-w-full aso-h-[113px] aso-rounded-md aso-border aso-border-gray-400 aso-p-4" v-model="noteValue" ></textarea>
                                            </div>
                ...
                <div v-if="materialType === 'simple' && activeSignColor != '' " class="aso-flex aso-items-center aso-justify-between aso-w-full aso-px-4 aso-py-3 aso-border-b-2">
                    ...
                    <p class="aso-text-[14px] aso-space-y-1 aso-flex aso-flex-col aso-items-center w-2/3 justify-end">
                        <div class="aso-flex aso-space-x-2 aso-full-center">
                            ...
                            <span v-if="signTextColor" class="lowercase first-letter:uppercase">{{colorTextColorName1}}</span>
                            <span :class="`aso-h-fit aso-w-fit aso-p-[1px] aso-border aso-border-[${configColors.backgroundColorHeader}]`">
                                <span v-if="signTextColor" :class="`aso-h-[35px] aso-w-[35px] aso-p-4 aso-bg-[${colorTextCodeHex1}] aso-flex`"></span>
                            </span>
                        </div>
                        ...
                        <div v-if="configDoublePart.active" class="aso-flex aso-space-x-2 aso-full-center">
                            ...
                            <span v-if="signTextColor" class="lowercase first-letter:uppercase">{{colorTextColorName2}}</span>
                            <span :class="`aso-h-fit aso-w-fit aso-p-[1px] aso-border aso-border-[${configColors.backgroundColorHeader}]`">
                                <span v-if="signTextColor" :class="`aso-h-[35px] aso-w-[35px] aso-p-4 aso-bg-[${colorTextCodeHex2}] aso-flex`"></span>
                            </span>
                        </div>
                    </p>
                </div>
                ...
                <div v-if="(!configDoublePart.active && configData.images.length > 0) || (configDoublePart.active && (configData.images.face1.length > 0 || configData.images.face2.length > 0))" class="aso-flex aso-items-center aso-justify-between aso-w-full aso-px-4 aso-py-3 aso-border-b-2">
                    ...
                    <div class="aso-text-[14px] aso-space-y-1 aso-flex aso-flex-col aso-items-center w-2/3 justify-end">
                        <div v-if="!configDoublePart.active && configData.images.length > 0">
                            <div v-for="(image, id) in configData.images">
                                {{image}}
                            </div>
                        </div>
                        ...
                        <div v-if="configDoublePart.active">
                            <div v-if="configData.images.face1.length > 0">
                                <span v-if="configDoublePart.active"  class="aso-font-medium">{{configDoublePart.part1}}: </span>
                                <div v-for="(image, id) in configData.images.face1" class="aso-flex aso-space-x-1">                              
                                    <span :class="`aso-h-fit aso-w-fit aso-p-[1px] aso-border aso-border-[${configColors.backgroundColorHeader}]`">
                                        <img :src="image.url" :class="`aso-h-[35px] aso-w-[35px] aso-flex`" />
                                    </span>

                                    <!-- <span>
                                        <p>width: {{image.width}}</p>
                                        <p>heigh: {{image.heigh}}</p>
                                        <p>top: {{image.top}}</p>
                            ...
                            <div v-if="configDoublePart.active && configData.images.face2.length > 0">
                                <span class="aso-font-medium">{{configDoublePart.part2}}: </span>
                                <div v-for="(image, id) in configData.images.face2">
                                    {{image}}
                                </div>
                            </div>
                        </div>
...
<script setup>
    ...
    onMounted(() => {
        ...
        console.log(configImageSettingsFilters.value, "configImageSettingss")
    ...
    async function addImageToSign(image, title, price, id){
        ...
        try {
            if(image){      
                ...
                currentImages = await handleAddImageToSign(image, newImagePriceId.value)
