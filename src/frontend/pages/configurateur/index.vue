    ...
    <div class="aso-w-full aso-h-full">
        <div class="aso-flex aso-justify-between aso-items-center aso-h-[18%] lg:aso-h-[15%] aso-bg-[#016565] lg:aso-bg-white aso-py-2 lg:aso-p-0 aso-border">
            ...
            <div class="aso-flex aso-w-1/3 aso-justify-center aso-items-center aso-space-x-4">
                <button class="aso-bg-[#22272D] aso-w-fit aso-h-fit aso-flex aso-space-x-2 aso-p-2 aso-px-3 aso-rounded-full hover:aso-bg-[#016464]">
        ...
        <div class="aso-w-full aso-flex aso-h-[600px] lg:aso-h-full aso-border-2">
                ...
                <div class="aso-relative lg:aso-top-0 aso-w-full aso-flex aso-flex-col">
                    ...
                    <div class="aso-flex aso-bg-[#016464] lg:aso-bg-transparent lg:aso-w-[60%] lg:aso-translate-x-[35%]">
                        ...
                        <div class="aso-relative lg:aso-translate-y-4 aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] lg:aso-shadow-none aso-mr-4">
                            <button class=" aso-h-[82px] lg:aso-h-fit lg:aso-w-fit aso-p-2 aso-rounded-none aso-bg-[#016464] lg:aso-bg-[#F9F9F9] hover:aso-bg-[#016464]">
                        ...
                        <div class="aso-flex lg:aso-space-x-2 aso-p-2 lg:aso-p-0 aso-overflow-x-scroll">
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="lg:aso-w-fit lg:aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464] active:aso-bg-[#3498db]" @click="product">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg  aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="material">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="size">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="shape">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="mdi:shape">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="fixing">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="color">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="text">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="border">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="image">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="lg:aso-h-full aso-h-[200px]">
                        ...
                        <div class="aso-absolute aso-w-[60%] aso-flex aso-rounded aso-shadow-lg lg:-aso-translate-y-[302%] lg:aso-translate-x-[35%]" v-if="isTextVisible && !isImageVisible && !isBorderVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isMaterialVisible && !isProductVisible" v-show="isTextVisible">
                            <div class="aso-flex aso-bg-white aso-w-full aso-space-x-2 aso-p-4">
                                ...
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#FF6600]">
                                ...
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm  aso-bg-[#604838]">  
                                </div>
    
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#000000]">
                                    
                                </div>
    
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#DFE31A]">
                                    
                                </div>

                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#FFE8D9]">  
                                </div>
    
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#535353]">
                                    
                                </div>
    
                                <div class="aso-w-5 aso-h-5 aso-rounded-sm aso-bg-[#036081]">
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-left-72 -aso-bottom-2 aso-shadow-lg"></div>
                        ...
                        <div class="aso-absolute aso-w-[100%] lg:aso-w-[40%] aso-h-[200px] lg:aso-h-fit aso-bg-white aso-flex aso-rounded aso-shadow-lg aso-top[0%] lg:-aso-translate-y-[250%] lg:aso-translate-x-[130%]" v-if="isImageVisible && !isBorderVisible && !isTextVisible && !isProductVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible" v-show="isImageVisible">
                            ...
                            <div class="aso-space-x-4 aso-p-4 aso-flex">
                                ...
                                <div class="">
                                    ...
                                    <button class="aso-bg-[#1A8FCE] aso-w-fit aso-h-fit aso-flex aso-space-x-2 aso-p-2 aso-px-3 aso-rounded-full hover:aso-bg-[#016464]">
            ...
            <div class="aso-absolute lg:aso-relative aso-right-[10%] lg:aso-right-[0%] aso-translate-y-[50%] lg:aso-translate-y-[0%] aso-bg-white aso-h-[22%] aso-space-y-2 lg:aso-h-full aso-w-[10%] aso-rounded lg:aso-rounded-none lg:aso-w-[12%] aso-flex aso-flex-col aso-py-4 lg:aso-py-12 aso-items-center lg:aso-space-y-4">
                ...
                <div class="aso-flex aso-flex-col aso-items-center aso-justify-center aso-space-y-2">
                    <button class="aso-w-8 aso-h-8 lg:aso-w-fit lg:aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-1 lg:aso-p-3 aso-rounded-full aso-bg-white aso-text-black hover:aso-bg-[#016464]">
                ...
                <div class="aso-flex aso-flex-col aso-items-center aso-justify-center aso-space-y-2">
                    <button class="aso-w-8 aso-h-8 lg:aso-w-fit lg:aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-1 lg:aso-p-3 aso-rounded-full aso-bg-[#FFBC3C] aso-text-black hover:aso-bg-[#016464]">
