<template>
    <div class="aso-w-full aso-h-full">
        ...
        <div class="aso-flex aso-h-[583px]">
            ...
            <div class="aso-bg-[#E7ECEF] aso-flex aso-flex-col aso-items-center aso-justify-between aso-w-[98%]">

                <div class="aso-relative aso-w-[55%] aso-h-[55%] aso-top-8">
  
                    <div class="aso-flex aso-justify-end aso-item-end aso-bg-red-100">

                        <div class="aso-absolute aso-h-full aso-w-0.5 aso-bg-red-400">

                            <div class="aso-absolute aso-w-4 aso-h-0.5 aso-bg-black"></div>
                            <div class="aso-absolute aso-bottom-0 aso-w-4 aso-h-0.5 aso-bg-black"></div>
                            <div class="aso-absolute aso-top-24 aso-origin-center aso-rotate-[90deg]">
                                <p class="">65mm</p>
                            </div>
                        </div>
                        ...
                        <div class="aso-absolute aso-w-full aso-h-0.5 aso-bottom-0 aso-bg-black">
                            ...
                            <div class="aso-absolute aso-left-0 aso-h-4 aso-w-0.5 aso-bg-black"></div>
                            <div class="aso-absolute aso-right-0 aso-h-4 aso-w-0.5 aso-bg-black"></div>
                            <div class="aso-absolute aso-w-full aso-h-full aso-justify-center">
            ...
            <div class="aso-bg-white aso-w-[10%] aso-pt-12 aso-flex aso-flex-col justify-between">
                ...
                <div class="aso-flex">
                    ...
                    <div class="aso-relative -aso-left-12">
                    ...
                    <div class="aso-pl-[42px] aso-pt-[60px]">
                        <p class="text-sm">Undo</p>
                    </div>
