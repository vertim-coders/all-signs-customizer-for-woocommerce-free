<template>
    <div class="aso-w-full aso-h-full">
        <div class="aso-flex aso-justify-between aso-items-center aso-h-[18%] lg:aso-h-[15%] aso-bg-[#016565] lg:aso-bg-white aso-py-2 lg:aso-p-0 aso-border">
            ...
            <div class="aso-flex aso-w-1/3 aso-justify-center aso-items-center aso-space-x-4">
                <button class="aso-bg-[#22272D] aso-w-fit aso-h-fit aso-flex aso-space-x-2 aso-p-2 aso-px-3 aso-rounded-full focus:aso-bg-[#016464] hover:aso-bg-[#016464]">
                ...
                <div class="aso-flex aso-justify-center aso-items-center">
                    <div class="aso-flex aso-justify-center aso-items-center">
                        <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-full aso-bg-white aso-text-black focus:aso-bg-[#016464] hover:aso-bg-[#016464]">
                    ...
                    <div class="aso-flex aso-justify-between aso-items-center aso-ml-4">
                        <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-bg-white aso-text-black">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-4 aso-h-4 lg:aso-w-5 lg:aso-h-5">
            ...
            <div class="aso-flex aso-w-1/3 aso-justify-center lg:aso-justify-between aso-items-center">
                ...
                <button class="aso-hidden focus:aso-bg-[#016464] hover:aso-bg-[#016464] lg:aso-flex aso-bg-[#FFBC3C] aso-rounded-tr-md hover:aso-bg-[#016464] aso-text-center aso-text-white aso-text-lg aso-font-bold">
                    Terminer
                </button>
            </div>
        </div>
        
        <div class="aso-w-full aso-flex aso-h-[600px] lg:aso-h-full aso-border-2">
            
            <div class="aso-bg-[#E7ECEF] aso-w-[100%] lg:aso-w-[96%] lg:aso-flex lg:aso-flex-col lg:aso-items-center lg:aso-justify-between aso-pb-4">

                <div class="aso-relative aso-h-[53.5%] aso-w-[100%] lg:aso-h-[65%] lg:aso-w-[60%] lg:aso-top-8">
  
                    <div class="aso-flex aso-justify-end aso-item-end">

                        <div class="aso-absolute aso-hidden lg:aso-flex aso-h-full aso-w-0.5 -aso-right-4 aso-bg-black">
                ...
                <div class="aso-relative lg:aso-top-0 aso-w-full aso-flex aso-flex-col">
                    
                    <div class="aso-flex aso-bg-[#016464] lg:aso-bg-transparent lg:aso-w-[60%] lg:aso-translate-x-[35%]">

                        <div class="aso-relative lg:aso-translate-y-4 aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] lg:aso-shadow-none aso-mr-4">
                            <button class=" aso-h-[82px] focus:aso-bg-[#016464] lg:aso-h-fit lg:aso-w-fit aso-p-2 aso-rounded-none aso-bg-[#016464] lg:aso-bg-[#F9F9F9] hover:aso-bg-[#016464]">
                        ...
                        <div class="aso-flex lg:aso-space-x-2 aso-p-2 lg:aso-p-0 aso-overflow-x-scroll">
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="lg:aso-w-fit lg:aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="product">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="aso-text-[10px] lg:aso-text-sm">
                                        Product
                                    </div>
                                </button>
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg  aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="material">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="size">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="shape">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="mdi:shape">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="fixing">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="color">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="text">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="border">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-relative aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit focus:aso-bg-[#016464] lg:aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-rounded-lg aso-bg-transparent lg:aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="image">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="aso-relative lg:aso-translate-y-4 lg:aso-translate-x-2.5 aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] lg:aso-shadow-none">
                            <button class="aso-h-[82px] focus:aso-bg-[#016464] lg:aso-h-fit lg:aso-w-fit aso-p-2 aso-rounded-none aso-bg-[#016464] lg:aso-bg-[#F9F9F9] hover:aso-bg-[#016464]">
                                <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="ooui:next-ltr">
                    ...
                    <div class="lg:aso-h-full aso-h-[200px]">
                        <div class="aso-absolute lg:aso-w-[75%] lg:aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg lg:-aso-translate-y-[205%] lg:aso-translate-x-[25%] lg:aso-space-x-2 lg:aso-space-y-0 aso-space-y-2" v-if="isProductVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible" v-show="isProductVisible">
    
                            <div class="aso-left-0 lg:aso-flex aso-hidden aso-top-0">
                                <button class="aso-h-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-w-4/4 aso-rounded-none aso-bg-[#F9F9F9] aso-p-2">
                                    <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="ooui:next-ltr">
                                        <path id="Vector" d="M27.9509 53.2L30.9609 49L15.0509 28L30.9609 7.00005L27.9509 2.80005L8.60093 28L27.9509 53.2Z" fill="#DFDFDF"/>
                                        </g>
                            ...
                            <div class="aso-flex aso-bg-white aso-p-2 aso-space-x-2">
                                ...
                                <div class="">
                                    ...
                                    <div class="aso-text-sm aso-font-bold aso-text-black">
                                        Plastic Signs
                                    </div>
    
                                    <div class="aso-text-sm aso-text-black">
                            ...
                            <div class="aso-right-0 aso-top-0 lg:aso-flex aso-hidden">
                                <button class="aso-h-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-w-4/4 aso-rounded-none aso-bg-[#F9F9F9] aso-p-2">
                                    <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="ooui:next-ltr">
                                        <path id="Vector" d="M15.0491 2.79999L12.0391 6.99998L27.9491 28L12.0391 49L15.0491 53.2L34.3991 28L15.0491 2.79999Z" fill="#DFDFDF"/>
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-left-[130px] -aso-bottom-2 aso-shadow-lg"></div>
    
    
                        </div>
                        <div class="aso-absolute lg:aso-w-[75%] lg:aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg lg:-aso-translate-y-[205%] lg:aso-translate-x-[25%] lg:aso-space-x-2 lg:aso-space-y-0 aso-space-y-2" v-if="isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isProductVisible" v-show="isMaterialVisible">
    
                            <div class="aso-left-0 aso-top-0 lg:aso-flex aso-hidden">
                                <button class="aso-h-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-w-4/4 aso-rounded-none aso-bg-[#F9F9F9] aso-p-2">
                                    <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="ooui:next-ltr">
                                        <path id="Vector" d="M27.9509 53.2L30.9609 49L15.0509 28L30.9609 7.00005L27.9509 2.80005L8.60093 28L27.9509 53.2Z" fill="#DFDFDF"/>
                            ...
                            <div class="aso-flex aso-bg-white aso-p-2 aso-space-x-2">
                                ...
                                <div class="">
                                    ...
                                    <div class="aso-text-sm aso-font-bold">
                                        Engraving
                                    </div>
    
                                    <div class="aso-text-sm">
                                        Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Tincidunt port
                                    </div>
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-left-[250px] -aso-bottom-2 aso-shadow-lg"></div>
    
    
                        </div>
                        <div class="aso-absolute aso-shadow-lg lg:-aso-translate-y-[230%] lg:aso-translate-x-[25%]" v-if="isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isMaterialVisible && !isProductVisible" v-show="isSizeVisible">
                            ...
                            <div class="aso-flex aso-justify-between aso-bg-white aso-p-4 aso-space-x-4 aso-items-center aso-rounded">
                                ...
                                <div class="aso-flex aso-w-1/3 aso-justify-center aso-items-center">
                                    <select name="size" id="" class="aso-w-40 aso-bg-white aso-border-black aso-rounded">
                                        <option value="">25x10 mm</option>
                                        <option value="">50x10 mm</option>
                                        <option value="">75x15 mm</option>
                                        <option value="">80x10 mm</option>
                                        <option value="">80x25 mm</option>
                                    </select>
                                </div>
    
                                <div class="aso-flex aso-w-2/3 aso-justify-center aso-font-bold aso-text-center aso-text-sm">
                                    Width x Height
                                </div>
                                <div class="aso-flex aso-w-1/3 aso-justify-center aso-items-center aso-space-x-4">
                                    <div class="">
                                        <input type="text" class="aso-w-20 aso-border aso-border-black aso-rounded aso-bg-white" id="width" placeholder="10 mm">
                                    </div>
                                    <div class="aso-w-6 aso-font-bold aso-text-sm">
                                        x
                                    </div>
                                    <div class="">
                                        <input type="text" class="aso-w-20 aso-bg-white aso-border-black aso-rounded" id="height" placeholder="10 mm">
                                    </div>
                                </div>
                                <div class="aso-flex aso-w-1/3 aso-justify-center aso-text-center aso-font-bold aso-text-sm">
                                    Thickness
                                </div>
    
                                <div class="aso-flex aso-w-1/3 aso-justify-center aso-items-center">
                                    <select name="size" id="" class="aso-bg-white aso-border-black aso-rounded">
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-left-[330px] -aso-bottom-2 aso-shadow-lg"></div>
    
                        </div>
                        <div class="aso-absolute lg:aso-w-[65%] aso-flex aso-justify-center aso-item-center aso-shadow-lg lg:-aso-translate-y-[225%] lg:aso-translate-x-[30%]" v-if="isShapeVisible && !isFixingVisible && !isColorVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isShapeVisible">
                            <div class="aso-left-0 aso-top-0 lg:aso-flex aso-hidden ">
                                <button class="aso-h-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-w-4/4 aso-rounded-none aso-bg-[#F9F9F9] aso-p-2">
                                    <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="ooui:next-ltr">
                            ...
                            <div class="aso-bg-white aso-h-[200px] lg:aso-h-full aso-flex aso-w-4/4 aso-flex-wrap aso-justify-start lg:aso-w-full aso-space-x-6 aso-p-4">
                                <div class="aso-translate-x-4">
    
                                    <div class="aso-w-16 aso-h-10 aso-rounded aso-border-t-2 aso-border-r-2 aso-border-b-2 aso-border-l-2 aso-border-solid aso-border-black aso-bg-white">
                                    
                                    </div>
                                    
                                    <div class="aso-text-xs aso-translate-y-2 -aso-translate-x-2">
                                        Rounded Corners
                                    </div>
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle -aso-bottom-2 aso-shadow-lg"></div>
    
    
                        </div>
                        <div class="aso-absolute lg:aso-w-[75%] lg:aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg lg:-aso-translate-y-[205%] lg:aso-translate-x-[22%] lg:aso-space-x-2 lg:aso-space-y-0 aso-space-y-2" v-if="isFixingVisible && !isColorVisible && !isShapeVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isFixingVisible">
                            <div class="aso-left-0 aso-top-0 lg:aso-flex aso-hidden">
                                <button class="aso-h-full focus:aso-bg-[#016464] hover:aso-bg-[#016464] aso-w-4/4 aso-rounded-none aso-bg-[#F9F9F9] aso-p-2">
                                    <svg width="36" height="36" viewBox="0 0 43 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="ooui:next-ltr">
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-right-72 -aso-bottom-2 aso-shadow-lg"></div>
    
    
                        </div>
                        <div class="aso-absolute aso-w-full lg:aso-w-[60%] aso-h-[200px] lg:aso-h-fit aso-flex aso-rounded lg:aso-shadow-lg lg:-aso-translate-y-[302%] lg:aso-translate-x-[35%]" v-if="isColorVisible && !isFixingVisible && !isShapeVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isColorVisible">
                            
                            <div class="aso-flex aso-bg-white aso-flex aso-flex-wrap aso-justify-start aso-w-full aso-space-x-6 lg:aso-space-x-2 aso-p-4">
                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-border aso-border-solid aso-border-black aso-bg-white">  
                                    
                                </div>
    
                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-bg-[#FF6600]">
                                    
                                </div>
    
                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-bg-[#F08267]">
                                    
                                </div>

                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm  aso-bg-[#604838]">  
                                </div>
    
                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-bg-[#000000]">
                                    
                                </div>
    
                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-bg-[#DFE31A]">
                                    
                                </div>

                                <div class="aso-w-8 aso-h-8 lg:aso-w-5 lg:aso-h-5 aso-rounded-sm aso-bg-[#FFE8D9]">  
                                </div>
    
                                
                            </div>
    
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-right-20 -aso-bottom-2 aso-shadow-lg"></div>
    
                        </div>
                        <div class="aso-absolute aso-w-[40%] aso-flex aso-rounded aso-bg-white aso-shadow-lg lg:-aso-translate-y-[252%] lg:aso-translate-x-[70%]" v-if="isTextVisible && !isImageVisible && !isBorderVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isMaterialVisible && !isProductVisible" v-show="isTextVisible">
                            <div class="aso-space-x-4 aso-p-4 aso-flex">
                                <div class="">
                                    ...
                                    <div class="aso-text-sm">
                                        click the button to add new image
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <button class="aso-bg-[#1A8FCE] focus:aso-bg-[#006666] aso-w-fit aso-h-fit aso-flex aso-space-x-3 aso-p-2 aso-px-3 aso-rounded-full hover:aso-bg-[#016464]">
                                        <svg class="aso-w-5 aso-h-5" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14 0C10.3009 0.0448832 6.76597 1.53429 4.15013 4.15013C1.53429 6.76597 0.0448832 10.3009 0 14C0.0448832 17.6991 1.53429 21.234 4.15013 23.8499C6.76597 26.4657 10.3009 27.9551 14 28C17.6991 27.9551 21.234 26.4657 23.8499 23.8499C26.4657 21.234 27.9551 17.6991 28 14C27.9551 10.3009 26.4657 6.76597 23.8499 4.15013C21.234 1.53429 17.6991 0.0448832 14 0ZM22 15H15V22H13V15H6V13H13V6H15V13H22V15Z" fill="black"/>
                                        </svg>
                                        <div class="aso-text-sm aso-text-center">
                                            Add new text
                                        </div>
                                    </button>
                            ...
                            <div class="aso-absolute aso-hidden lg:aso-flex triangle aso-right-[160px] -aso-bottom-2 aso-shadow-lg"></div>
    
                        </div>
                        <div class="aso-absolute aso-w-full lg:aso-w-[30%] aso-h-[200px] lg:aso-h-fit aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg lg:-aso-translate-y-[205%] lg:aso-translate-x-[170%]" v-if="isBorderVisible && !isTextVisible && !isImageVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isProductVisible" v-show="isBorderVisible">
                            ...
                            <div class="aso-w-full aso-bg-white aso-flex aso-space-x-12 aso-p-4">
                                <div class="">
    
                                    <div class="">
                                        <svg class="aso-w-12 aso-h-12" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g id="Group 19352812">
                                    ...
                                    <div class="aso-text-xs aso-translate-x-2">
                                        None
                                    </div>

                                </div>
                                <div class="aso-translate-y-[5%]">

                                    <div class="aso-w-16 aso-h-10 aso-border-t-2 aso-border-r-2 aso-border-b-2 aso-border-l-2 aso-border-solid aso-border-black aso-bg-white">

                                    </div>

                                    <div class="aso-text-xs aso-translate-x-2 aso-translate-y-2">
                                        Border
                                    </div>
                        ...
                        <div class="aso-absolute aso-w-[100%] lg:aso-w-[40%] aso-h-[200px] lg:aso-h-fit aso-bg-white aso-flex aso-rounded aso-shadow-lg aso-top[0%] lg:-aso-translate-y-[250%] lg:aso-translate-x-[130%]" v-if="isImageVisible && !isBorderVisible && !isTextVisible && !isProductVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible" v-show="isImageVisible">
                            
                            <div class="aso-space-x-4 aso-p-4 aso-flex" v-show="contentVisible">
                                <div class="">
                                    ...
                                    <div class="aso-text-sm">
                                        click the button to add a text
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <button class="aso-bg-[#1A8FCE] aso-w-fit aso-h-fit aso-flex aso-space-x-2 aso-p-2 aso-px-3 aso-rounded-full hover:aso-bg-[#016464]" @click="addText">
                                        <svg class="aso-w-6 aso-h-6" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g id="gravity-ui:copy-picture">
                                                <path id="Vector" fill-rule="evenodd" clip-rule="evenodd" d="M24 4.84375H16C15.2044 4.84375 14.4413 5.14994 13.8787 5.69497C13.3161 6.24 13 6.97921 13 7.75V9.6875H16C17.5913 9.6875 19.1174 10.2999 20.2426 11.3899C21.3679 12.48 22 13.9584 22 15.5V18.4062H24C24.7956 18.4062 25.5587 18.1001 26.1213 17.555C26.6839 17.01 27 16.2708 27 15.5V7.75C27 6.97921 26.6839 6.24 26.1213 5.69497C25.5587 5.14994 24.7956 4.84375 24 4.84375ZM22 21.3125H24C25.5913 21.3125 27.1174 20.7001 28.2426 19.6101C29.3679 18.52 30 17.0416 30 15.5V7.75C30 6.20843 29.3679 4.73 28.2426 3.63994C27.1174 2.54989 25.5913 1.9375 24 1.9375H16C14.4087 1.9375 12.8826 2.54989 11.7574 3.63994C10.6321 4.73 10 6.20843 10 7.75V9.6875H8C6.4087 9.6875 4.88258 10.2999 3.75736 11.3899C2.63214 12.48 2 13.9584 2 15.5V23.25C2 24.7916 2.63214 26.27 3.75736 27.3601C4.88258 28.4501 6.4087 29.0625 8 29.0625H16C17.5913 29.0625 19.1174 28.4501 20.2426 27.3601C21.3679 26.27 22 24.7916 22 23.25V21.3125ZM8 12.5938H16C16.7956 12.5938 17.5587 12.8999 18.1213 13.445C18.6839 13.99 19 14.7292 19 15.5V19.4544L17.864 18.4469C17.3161 17.9621 16.6041 17.6882 15.8621 17.6768C15.1202 17.6654 14.3995 17.9172 13.836 18.3849L10.398 21.2389L9.194 20.3631C8.67403 19.9858 8.04295 19.7797 7.39328 19.7752C6.74361 19.7707 6.10953 19.9679 5.584 20.3379L5 20.7487V15.5C5 14.7292 5.31607 13.99 5.87868 13.445C6.44129 12.8999 7.20435 12.5938 8 12.5938ZM5.172 24.2207C5.3791 24.7869 5.76222 25.277 6.26865 25.6236C6.77508 25.9702 7.37993 26.1563 8 26.1562H16C16.7706 26.1561 17.5116 25.8687 18.0694 25.3536C18.6272 24.8385 18.959 24.1352 18.996 23.3895L15.84 20.5956C15.8328 20.5896 15.8235 20.5863 15.814 20.5863C15.8045 20.5863 15.7952 20.5896 15.788 20.5956L11.438 24.2071L10.524 24.9647L9.562 24.2672L7.394 22.6901C7.38726 22.6855 7.37923 22.683 7.371 22.683C7.36277 22.683 7.35474 22.6855 7.348 22.6901L5.172 24.2207ZM11.232 16.3932C11.232 16.9862 10.9888 17.5549 10.556 17.9742C10.1232 18.3935 9.53612 18.6291 8.924 18.6291C8.31188 18.6291 7.72483 18.3935 7.292 17.9742C6.85916 17.5549 6.616 16.9862 6.616 16.3932C6.63367 15.8118 6.88448 15.26 7.3152 14.8549C7.74591 14.4497 8.32264 14.2231 8.923 14.2231C9.52336 14.2231 10.1001 14.4497 10.5308 14.8549C10.9615 15.26 11.2123 15.8118 11.23 16.3932H11.232Z" fill="black"/>
                                                </g>
                                        </svg>
                                        <div class="aso-text-sm aso-text-center">
                                            Add new image
                    ...
                    <div class="aso-flex lg:aso-hidden">
                        <div class="aso-w-[50%] aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)]">
                            <button class="aso-w-full aso-bg-white aso-text-black aso-rounded-bl-2xl aso-rounded-br-2xl hover:aso-bg-[#016464]">Cancel</button>
                        </div>
                        <div class="aso-w-[50%] aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)]">
                            <button class="aso-w-full aso-bg-white aso-text-black aso-rounded-bl-2xl aso-rounded-br-2xl">Terminer</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="aso-absolute lg:aso-relative aso-right-[10%] lg:aso-right-[0%] aso-translate-y-[50%] lg:aso-translate-y-[0%] aso-bg-white aso-h-[22%] aso-space-y-2 lg:aso-h-full aso-w-[10%] aso-rounded lg:aso-rounded-none lg:aso-w-[12%] aso-flex aso-flex-col aso-py-4 lg:aso-py-12 aso-items-center lg:aso-space-y-4">
              
                <div class="aso-flex aso-flex-col aso-items-center aso-justify-center aso-space-y-2">
                    <button class="aso-w-8 aso-h-8 lg:aso-w-fit lg:aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-1 lg:aso-p-3 aso-rounded-full aso-bg-white aso-text-black focus:aso-bg-[#016464] hover:aso-bg-[#016464]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-3 aso-h-3 lg:aso-w-5 lg:aso-h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
                    </button>
                    <div class="aso-hidden lg:aso-text-sm lg:aso-flex">
                        Preview
                    </div>
                </div>
                <div class="aso-flex aso-flex-col aso-items-center aso-justify-center aso-space-y-2">
                    <button class="aso-w-8 aso-h-8 lg:aso-w-fit lg:aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-1 lg:aso-p-3 aso-rounded-full aso-bg-white aso-text-black focus:aso-bg-[#016464] hover:aso-bg-[#016464]">
                        <svg class="aso-w-3 aso-h-3 lg:aso-w-5 lg:aso-h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="aso-flex aso-flex-col aso-items-center aso-justify-center aso-space-y-2">
                    <button class="aso-w-8 aso-h-8 lg:aso-w-fit lg:aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-1 lg:aso-p-3 aso-rounded-full aso-bg-[#FFBC3C] aso-text-black focus:aso-bg-[#016464] hover:aso-bg-[#016464]">
                        <svg class="aso-w-3 aso-h-3 lg:aso-w-5 lg:aso-h-5" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const isShapeVisible = ref(false);
...
const fixing = () => {
  isFixingVisible.value = !isFixingVisible.value;
...
const shape = () => {
  isShapeVisible.value = !isShapeVisible.value;
  if (isColorVisible.value) {
    isColorVisible.value = false;
  }
  if (isFixingVisible.value) {
...
const size = () => {
  isSizeVisible.value = !isSizeVisible.value;
  if (isColorVisible.value) {
    isColorVisible.value = false;
  }
  if (isFixingVisible.value) {
...
const product = () => {
  isProductVisible.value = !isProductVisible.value;
  if (isColorVisible.value) {
    isColorVisible.value = false;
  }
  if (isFixingVisible.value) {
