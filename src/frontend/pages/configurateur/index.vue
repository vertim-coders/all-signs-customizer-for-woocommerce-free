                ...
                <div class="aso-w-full aso-flex aso-justify-center">
                    <div class="aso-flex aso-w-[60%] aso-overflow-x-scroll">
                        ...
                        <div class="aso-flex">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="product">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="material">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="size">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="shape">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="mdi:shape">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="fixing">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="color">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="text">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="border">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-flex aso-justify-center aso-items-center">
                                <button class="aso-w-fit aso-h-fit aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-ml-2 aso-rounded-lg aso-bg-white aso-text-black hover:aso-bg-[#016464]" @click="image">
                                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="aso-absolute aso-right-[380px] aso-pt-5">
                                <button class="aso-h-12 aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9] hover:aso-bg-[#016464]">
                                    <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="aso-absolute aso-w-[50%] aso-h-12 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isColorVisible && !isFixingVisible && !isShapeVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isColorVisible">
                            <div class="aso-absolute aso-left-0 aso-top-0">
                                <button class="aso-h-12 aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9]">
                                    <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                                    </svg>
                            ...
                            <div class="aso-absolute aso-right-0 aso-top-0">
                                    <button class="aso-h-12 aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9]">
                                        <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                                        </svg>
                        ...
                        <div class="aso-absolute aso-w-[55%] aso-h-24 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isFixingVisible && !isColorVisible && !isShapeVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isFixingVisible">
                            ...
                            <div class="aso-flex aso-bg-white aso-pl-12">
                                ...
                                <div class="">
                                    ...
                                    <div class="aso-text-sm aso-font-bold aso-pt-2">
                                        Adhesive Tape
                                    </div>
                            ...
                            <div class="aso-flex aso-bg-white aso-ml-2 ">
                            ...
                            <div class="aso-absolute aso-right-0 aso-top-0 next">
                                <button class="aso-h-[96px] aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9]">
                                    <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                                    </svg>
                            ...
                            <div class="aso-absolute triangle aso-right-72 -aso-bottom-2 aso-shadow-lg"></div>


                        </div>

                        <div class="aso-h-20 aso-w-[50%] aso-justify-center aso-absolute aso-flex aso-bg-white aso-p-3 aso-pl-12 aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isShapeVisible && !isFixingVisible && !isColorVisible && !isSizeVisible && !isMaterialVisible && !isProductVisible" v-show="isShapeVisible">
                        ...
                        <div class="aso-absolute aso-w-[50%] aso-h-12 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isMaterialVisible && !isProductVisible" v-show="isSizeVisible">
                            <div class="aso-absolute aso-left-0 aso-top-0">
                                <button class="aso-h-12 aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9]">
                                    <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                        ...
                        <div class="aso-absolute aso-w-[55%] aso-h-24 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isProductVisible" v-show="isMaterialVisible">
                        ...
                        <div class="aso-absolute aso-w-[55%] aso-h-24 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isProductVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible" v-show="isProductVisible">
                        ...
                        <div class="aso-absolute aso-w-[50%] aso-h-12 aso-flex aso-justify-center aso-item-center aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isTextVisible && !isImageVisible && !isBorderVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isMaterialVisible && !isProductVisible" v-show="isTextVisible">
                            <div class="aso-absolute aso-left-0 aso-top-0">
                                <button class="aso-h-12 aso-w-10 aso-p-2 aso-rounded-none aso-bg-[#F9F9F9]">
                                    <svg class="aso-w-6 aso-h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                            ...
                            <div class="aso-absolute aso-right-0 aso-top-0">
                                ...
                                <div class="aso-absolute triangle aso-left-[380px] -aso-bottom-2 aso-shadow-lg"></div>

                        </div>

                        <div class="aso-h-20 aso-w-[20%] aso-right-[450px] aso-items-center aso-justify-center aso-absolute aso-flex aso-bg-white aso-p-3 aso-pl-12 aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isBorderVisible && !isTextVisible && !isImageVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible && !isProductVisible" v-show="isBorderVisible">
                            ...
                            <div class="">
                                ...
                                <div class="aso-text-xs aso-ml-2">
                                    None
                                </div>
                            ...
                            <div class="aso-ml-8">
                                ...
                                <div class="aso-w-16 aso-h-10 aso-border-t-2 aso-border-r-2 aso-border-b-2 aso-border-l-2 aso-border-solid aso-border-black aso-bg-white aso-mr-4">

                                </div>

                                <div class="aso-text-xs aso-ml-4">
                                    Border
                                </div>
                        ...
                        <div class="aso-absolute aso-w-[35%] aso-right-72 aso-bg-white aso-h-16 aso-flex aso-rounded aso-shadow-lg aso-bottom-[265px]" v-if="isImageVisible && !isBorderVisible && !isTextVisible && !isProductVisible && !isMaterialVisible && !isSizeVisible && !isShapeVisible && !isFixingVisible && !isColorVisible" v-show="isImageVisible">
                            
                            <div class="aso-pl-4">

                                
                                <div class="aso-text-sm aso-font-bold aso-pt-3">
                                   Image
                                </div>
                            ...
                            <div class="aso-absolute triangle aso-right-[160px] -aso-bottom-2 aso-shadow-lg"></div>
