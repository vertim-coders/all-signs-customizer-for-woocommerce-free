      ...
      fabric.util.enlivenObjects([obj],async function (templateObject) {
        try{
          ...
          if (templateObject[0].name === "aso-SignText") {
            ...
            if(templateObject[0].fontFamily){
              var font = templateObject[0].fontFamily
              const myfont = new FontFaceObserver(templateObject[0].fontFamily);
              await myfont.load();

              templateObject[0].set('fontFamily', font)
            }
